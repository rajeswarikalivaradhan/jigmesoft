...
class Badminusermodel extends CI_Model {
    ...
    public function whereCond($VarDept = '', $VarUsername='',$VarDesgn='',$VarLoginid = '',$VarEmail_id='',$VarMobno='',$VarStatus='') {
        ...
        if ($VarStatus <> '') {
            ...
            $ArrWhere[] = "status in(1,2) AND usertype in(0,16)";
        }
    ...
    function fnList($VarDept = '', $VarUsername='',$VarDesgn='',$VarLoginid = '', $VarEmail_id='',$VarMobno='',$VarStatus='',$VarLimit = 10, $offset = 0, $VarSortBy, $VarSortOrder) {
        ...
        //$VarSortBy = (in_array($VarSortBy, $VarSortCols)) ? $VarSortBy : 'dateupdated';
         $VarSortBy = (in_array($VarSortBy, $VarSortCols)) ? $VarSortBy : 'log';
           //$VarSortBy1 = DATE_FORMAT($VarSortBy,"%d/%m/%Y %h:%i %p");
