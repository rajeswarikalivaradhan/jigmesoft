...
class Bommaterialmodel extends CI_Model {
    function saveInfo($ArrSaveData) {
        ...
        if ($VarId == "") {
            ...
            if (empty($ArrCheckExist)) {
                ...
                $ArrResult['errcode'] = -1;
                $ArrResult['msg'] = "This material already exists";
            }
        } else {
    ...
    function fnList($Vardescription = '', $VarStatus = '', $VarLimit = 10, $offset = 0, $VarSortBy, $VarSortOrder) {
        ...
        FROM " . KN_BOM_MASTER . " AS b INNER JOIN " . KN_USERS . " AS u ON b.updatedby = u.id " . $VarWhere . " order by " . $VarSortBy . " " . $VarSortOrder;
