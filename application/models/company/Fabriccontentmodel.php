...
class fabriccontentmodel extends CI_Model {
    ...
    function fnCount($Varmisc_name = '', $VarStatus = '', $VarAfilter = '') {
        ...
        $VarSqlLab = "SELECT count(1) as trec  FROM " . KN_MASTER_FABRIC_MISC . " $VarWhere ";
    ...
    function fnList($Varmisc_name = '', $VarStatus = '', $VarLimit = 10, $offset = 0, $VarSortBy, $VarSortOrder, $VarAfilter = '') {
        ...
        if ($VarAfilter <> '') {
            $ArrWhere[] = "b.misc_name LIKE '" . $VarAfilter . "%'";
        }
        if ($VarStatus <> '') {
