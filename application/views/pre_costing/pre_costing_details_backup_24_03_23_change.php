...
<div class="card-header pt-2 pb-3 pl-0 bgc-white border-0 " style="">
    ...
    <div class="card-toolbar no-border">
        <ol class="breadcrumb float-sm-right p-0 pb-1 mr-2">
            <!--<li class="breadcrumb-item f-13"><a href="#">Home</a></li>-->
            <?php if($accessPermission != false){  ?>
            <li class="breadcrumb-item f-13 active"><a class="btn btn-sm btn-royal-blue btn-text-slide-x" href="<?php echo base_url('components/componentCreation') . '/' . urlencode(base64_encode($VarEnqId)) ?>"><i class="fa fa-circle-o"></i>View Component Details</a></li>
            <?php } ?>
        </ol>
    </div><!-- /.card-toolbar -->
</div>
...
<ul class="pad-l-0-i pt-2 nav nav-tabs nav-tabs-simple nav-tabs-static nav-tabs-faded flex-nowrap radius-0 px-3 pt-2 nav-tabs-scroll is-scrollable pad-l-0-i" id="component" role="tablist">
    <?php
...
<div class="tab-content bgc-white p-0 border-0" id="componentContent">
    <?php
    foreach ($components as $key => $component)
    {
        ?>
        <div class="tab-pane fade <?= $key == 0 ? 'active show' : '' ?>" id="component_tab_content_<?= $component['component_id'] ?>"
            ...
            <ul class="nav nav-justified nav-tabs nav-tabs-static nav-tabs-faded radius-t-1 overflow-hidden" id="component_sub_tab_<?= $component['component_id'] ?>" role="tablist">
                <li class="nav-item nav-item-r-border">
                    <a class="btn btn-light-lightgrey btn-a-purple border-0 radius-0 btn-sm f-13 py-2 active" id="gar_pce_wgt_<?= $component['component_id'] ?>" data-toggle="pill"
                ...
                <li class="nav-item nav-item-r-border">
                    <a class="btn btn-light-lightgrey btn-a-purple border-0 radius-0 btn-sm f-13 py-2 " id="yarn_cost_<?= $component['component_id'] ?>" data-toggle="pill"
                ...
                <li class="nav-item nav-item-r-border">
                    <a class="btn btn-light-lightgrey btn-a-purple border-0 radius-0 btn-sm f-13 py-2" id="knitting_cost_<?= $component['component_id'] ?>" data-toggle="pill"
                ...
                <li class="nav-item nav-item-r-border">
                    <a class="btn btn-light-lightgrey btn-a-purple border-0 radius-0 btn-sm f-13 py-2 " id="dyeing_cost_<?= $component['component_id'] ?>" data-toggle="pill"
                ...
                <li class="nav-item nav-item-r-border">
                    <a class="btn btn-light-lightgrey btn-a-purple border-0 radius-0 btn-sm f-13 py-2" id="emb_cost_<?= $component['component_id'] ?>" data-toggle="pill"
                ...
                <li class="nav-item nav-item-r-border">
                    <a class="btn btn-light-lightgrey btn-a-purple border-0 radius-0 btn-sm f-13 py-2" id="Bom_art1_cost_<?= $component['component_id'] ?>" data-toggle="pill"
                ...
                <li class="nav-item">
                    <a class="btn btn-light-lightgrey btn-a-purple border-0 radius-0 btn-sm f-13 py-2" id="other_exp_<?= $component['component_id'] ?>" data-toggle="pill"
            ...
            <div class="tab-content p-0 border-0 brc-grey-l1" id="component_sub_tab_<?= $component['component_id'] ?>_content">
                <div class="tab-pane fade active show" id="gar_pce_wgt_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">Garment Piece Weight</div>
                ...
                <div class="tab-pane fade" id="yarn_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">Yarn Cost</div>
                ...
                <div class="tab-pane fade" id="knitting_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">Knitting Cost</div>
                ...
                <div class="tab-pane fade pr-0 pl-0" id="dyeing_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <!--<div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">DYEING COST</div>-->
                    <div id="dying_cost_grid_<?= $component['component_id'] ?>" class="p-0 w-100 dying_cost_grid_combo"></div>

                    <div class="card border-0">
                        <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">Dyeing & Processing Cost - <span style="color:grey"><?= $component['dying_type'] == 1 ? 'Solid Color' : 'Yarn Dyeing & Multi Color' ?></span></div>
                            <div class="col-12 px-0 py-2" style=""><div class="col-12" style="border-top: 1px solid #022b61;"></div></div>
                        <!--<div class="card-header p-3 border-0 bgc-white tbl-head mb-1">-->
                        <!--    <div class="card-title text-white f-14 text-500">AVERAGE DYEING & PROCESSING COST PER Kg (<?= $component['dying_type'] == 1 ? 'SOLID COLOR' : 'YARN DYE & MULTI COLOR' ?>)</div>-->
                ...
                <div class="tab-pane fade" id="emb_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">Embellishment Cost</div>
                ...
                <div class="tab-pane fade" id="Bom_art1_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">BOM (Article - 1) Cost</div>
                ...
                <div class="tab-pane fade" id="Bom_art2_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">BOM (Article - 2) Cost</div>
                ...
                <div class="tab-pane fade" id="cip_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">CMT & CIP Cost</div>
                ...
                <div class="tab-pane fade" id="other_exp_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14">Other Expenses</div>
...
//            });
        ...
        MakeAsynPostRequest(base_path + "preCosting/preCostingColumns", "enquiry_id=" + enquiry_id + '&component_id='+component_id + '&grid_unique_id=' + grid_unique_id, "json", function(data) {
                ...
                {  
                   ...
                   let options = {
                        ...
                        allowInsertRow: (grid_name == 'knitting_cost_grid' || grid_name === 'emp_cost_grid') ? false : true,
                    ...
                    $('#' + grid_name + '_btn_'+ component_id).click(function (){
                        ...
                        if(validate == 0)
                        {
                            ...
                            swalWithBootstrapButtons.fire(
                                ...
                                $('#'+ grid_name + '_' + component_id).html('');
                                   if(grid_name == 'garment_parts')
                                    {
                                    preCostingGrid(component_id,'garment_parts');
                                    }
                                    else if(grid_name == 'yarn_cost_grid') {
                                       ...
                                       preCostingGrid(component_id,'knitting_cost_grid');
                                        ...
                                        preCostingGrid(component_id,'emp_cost_grid');
                                    }
                                    else if(grid_name == 'bom_art_1') {
                                       preCostingGrid(component_id,'bom_art_1');
                                    }
                                    else if(grid_name == 'bom_art_2') {
                                      preCostingGrid(component_id,'bom_art_2');
                                    }
                                    else if(grid_name == 'cmt_cip_cost') {
                                      preCostingGrid(component_id,'cmt_cip_cost');
                                    }
                                    else if(grid_name == 'other_exp_grid') {
                                      preCostingGrid(component_id,'other_exp_grid');
                                    }
                                }
                            });
                            //k.submitData();
             ...
             gridData.forEach(function(value) { 
                ...
                if($('#'+combo_div_id).length===0){
                    ...
                    <div class="p-0 card border-0">\
                        <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-14 d-flex">Dyeing Cost <div class="page-info text-cyan-br text-nowrap pl-3">-&nbsp;&nbsp;<span style="color:grey"> '+ combo_name +'</span></div> </div>\
                        <div class="col-12 px-0 py-2" style=""><div class="col-12" style="border-top: 1px solid #022b61;"></div></div>\
    ...
    function actualCostGrid(enquiry_id)
    {
        ...
        let options = {
                ...
                footers: [['', '', '', '','','', '','','','', 'Total : ', '=SUMCOL(TABLE(), COLUMN())','','=SUMCOL(TABLE(), COLUMN())','', 'Total : ', '=SUMCOL(TABLE(), COLUMN())']],
                updateTable: function (instance, cell, col, row, val, label, cellName) { 
                    ...
                    if(col === 8)
                    {
                        avg_cost = (sum_cost * 5) / 100 + sum_cost;
                    ...
                    methods: {
                        submitData: function () {
                           ...
                           // console.log(data);
                            ...
                            swalWithBootstrapButtons.fire({title: 'Saved!',type: 'success',icon: 'success',customClass: {'confirmButton': 'btn btn-info px-5'}}).then(function(result){
                             <?php if($requestFor == 1) {  ?>
                                isrCostGrid(enquiry_id);
                                <?php } else { ?>
                                iorCostGrid(enquiry_id);
    ...
    function footer(grid_name, columnlength)
    {
        ...
        else if(grid_name === "emp_cost_grid")
        {
            ...
            return [['', '', '', '','', 'Total : ', '=SUMCOL_NOFORMAT(TABLE(), COLUMN())', '=SUMCOL(TABLE(), COLUMN())']];
        }
    }
 ...
 function validateFields(grid_name,componentid,comboid,data) {
    ...
    function validateFiled(grid_name,data) {
        ...
        if(grid_name == 'garment_parts') {
            ...
            validate_filed = [0,1,2,3,4,5,6,8];
        }
        else if(grid_name == 'knitting_cost_grid') {
            validate_filed = [4,5,6,7,8,9];
        }
        else if(grid_name == 'emp_cost_grid') {
