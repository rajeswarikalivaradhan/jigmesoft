                    ...
                    <div class="sidebar-section my-2">
                        ...
                        <div class="sidebar-section-item">
                            ...
                            <div class="fadeable d-inline-flex align-items-center ml-3 ml-lg-0">
                                ...
                                <input type="text" class="sidebar-search-input pl-4 pr-3 mr-n2" maxlength="60"
                                       placeholder="Search ..." aria-label="Search"/>
               ...
               <span>Cards</span>
                        ...
                        <li class="nav-item">
                            <a href="html/calendar.html" class="nav-link">
                                ...
                                <span class="nav-text fadeable">
               <span>Calendar</span>
               <span class="badge px-1 " title="2 Urgent Events"><i
                           class='fas fa-exclamation-triangle text-140 text-danger-m2'></i></span>
               </span>
                            </a>
                            <b class="sub-arrow"></b>
                        </li>
                                ...
                                <div class="row h-100 mx-n425">
                                    ...
                                    <div class="col-12 col-sm-4 p-0 pos-rel mt-3 mt-sm-0 pt-0 pt-sm-0 text-center">
                						...
                						<i class="fa fa-caret-up"></i>
                                            ...
                                            <button type='button'
                                                    class='btn btn-outline-blue radius-round btn-bold px-4 py-1 mt-3 mx-auto'>
                                                View Report
                                            </button>
                                        </div><!-- /.ccard -->
                                    </div><!-- /.col -->
                                ...
                                <span class="text-170 text-secondary-d4">
                						...
                						<i class="fa fa-caret-up"></i>
                                            ...
                                            <div class="align-self-center w-95">
                                                <canvas class="infobox-line-chart ml-n15 mt-n2"
                                                        style="height: 64px; width: 100%;"
                                                        data-values="[1000,800,1800,400,1500,1000,1050,1300,2100,1400,1500,1350]"></canvas>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-4 p-0 pos-rel mt-3 mt-sm-0 pt-0 pt-sm-0 text-center">
                                        <div class="ccard h-100 d-flex flex-column mx-2 px-2 py-3">
                                            ...
                                            <div class="align-self-center pos-rel text-blue">
                                                <canvas class="infobox-progress-chart" style="width: 180px;"
                                                        data-percent="58"></canvas>
                            ...
                            <div class="col-12 mt-35">
                              ...
                              <span class="text-200">
                                    ...
                                    <div class="col-12 col-md-4 px-0 mb-2 mb-md-0">
                                        <div class="ccard h-100 pt-2 pb-25 px-25 d-flex mx-2 overflow-hidden">
                                            <!-- the colored circles on bottom right -->
                                            <div class="position-br	mb-n5 mr-n5 radius-round bgc-orange-l3 opacity-3"
                                                 style="width: 5.25rem; height: 5.25rem;"></div>
                                            <div class="position-br	mb-n5 mr-n5 radius-round bgc-orange-l2 opacity-5"
                                                 style="width: 4.75rem; height: 4.75rem;"></div>
                                            <div class="position-br	mb-n5 mr-n5 radius-round bgc-orange-l1 opacity-5"
                                                 style="width: 4.25rem; height: 4.25rem;"></div>
                        ...
                        Last 7 days
                                ...
                                <div class="card-toolbar no-border align-self-start mt-15 mr-1">
                                    <div class="dropdown dd-backdrop dd-backdrop-none-md">
                                        <a class="btn btn-light-secondary border-0 btn-bold btn-xs dropdown-toggle"
                                           href="#" role="button" data-toggle="dropdown" data-display="static"
                          ...
                          <span>
                                total
                                        ...
                                        <canvas id="traffic-source-chart" class="mb-3"
                        ...
                        <div class="card border-0 h-100">
                            <div class="card-header border-0 bgc-transparent pl-1">
                                ...
                                <div class="card-toolbar no-border dd-backdrop dd-backdrop-none-md">
                                    <a href="#"
                                       class="btn btn-xs btn-light-secondary border-1 text-600 px-4 radius-round dropdown-toggle"
                                       role="button" data-toggle="dropdown" data-display="static" aria-haspopup="true"
                                       aria-expanded="false">
                                        2020
                                    </a>
                ...
                <div class="row mt-5 pt-lg-3">
                        ...
                        <div class="card ccard radius-t-0 h-100">
                            ...
                            <div class="card-header pb-3 brc-secondary-l3">
                                ...
                                <div class="card-toolbar no-border pl-0 pl-md-2">
                                    <a href="#"
                                       class="btn btn-sm btn-lighter-grey btn-bgc-white btn-h-light-orange btn-a-light-orange text-600 px-2 py-1 radius-round">
                    ...
                    <div class="col-12 col-lg-4 mt-4 mt-lg-0">
                        ...
                        (Sortable)
                                ...
                                <div class="card-toolbar no-border pl-0 pl-md-2">
                                    <a href="#"
                                       class="btn btn-sm btn-lighter-grey btn-bgc-white btn-h-light-orange btn-a-light-orange text-600 px-25 radius-round">
                                        View all
                                ...
                                <form autocomplete="off" id="tasks" class="mt-n1px">
                                    <div class="task-item d-flex align-items-center border-t-1 bgc-h-green-l3 brc-secondary-l3 px-2">
                                        <label class="checkbox">
                                            <input type="checkbox" class="align-middle input-sm ml-2 mr-25"
                                                   id="task-item-0"/>
                                        </label>
                                    ...
                                    <div class="px-3 conversation mt-425">
                                        <div class="d-flex align-items-start col px-0">
                                            <div class="mr-3 mt-2px">
                                                <div class="pos-rel">
                                                    <img alt="Max's avatar" src="assets/image/avatar/avatar1.jpg"
                                                         class="radius-round w-4 h-4"/>
                                                ...
                                                <div class="d-flex mb-15 pos-rel">
                                                    ...
                                                    <div class="py-2 px-3 radius-1 bgc-grey-l3 text-dark-m1 pos-rel">
                                                        <div class="text-90" style="max-width: 480px;">
                                                            Raw denim you probably haven't heard of actively? So lorem
                                                            ipsum indeed! <span class='fa-stack w-auto'> <i
                                                                        class='fas fa-circle text-dark fa-stack-1x text-100'></i> <i
                                                                        class='fas fa-smile-beam text-warning-m3 text-125 fa-stack-1x pos-rel'></i> </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="px-3 conversation text-right mt-425">
                                        <div class="d-flex flex-row-reverse align-items-start col px-0">
                                            <div class="ml-3 mt-2px">
                                                <div class="pos-rel">
                                                    <img alt="Mia's avatar" src="assets/image/avatar/avatar7.jpg"
                                                         class="radius-round w-4 h-4"/>
                                            ...
                                            <div class="col px-0">
                                                ...
                                                <div class="d-flex flex-row-reverse mb-15 pos-rel">
                                                    ...
                                                    <div class="py-2 px-3 radius-1 bgc-primary-l3 text-dark-m1 pos-rel">
                                                        <div class="text-90" style="max-width: 480px;">
                                                            So count me in! <i
                                                                    class='fa fa-thumbs-up text-orange-m1 text-125 ml-1'></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="d-flex align-items-start col px-0">
                                            ...
                                            <div class="col px-0">
                                                <div class="d-flex mb-15 pos-rel">
                                                    ...
                                                    <div class="py-2 px-3 radius-1 bgc-grey-l3 text-dark-m1 pos-rel">
                                                        <div class="text-90" style="max-width: 480px;">
                                                            Heard of them jean shorts Austin! Fusce dapibus, tellus ac
                                                ...
                                                <div class="d-flex mb-15 pos-rel">
                                                    ...
                                                    <div class="mt-2px pos-rel">
                                                        <div class='d-flex'>
                                                            <div class='border-1 radius-2 mx-1 brc-primary-l1 shadow-sm d-style overflow-hidden'>
                                                                <img alt='Heedphones'
                                                                     src='assets/image/product/wireless-headphone.jpg'
                                                                     width='64' class='d-zoom-2'/></div>
                                                            <div class='border-1 radius-2 mx-1 brc-primary-l1 shadow-sm d-style overflow-hidden'>
                                                                <img alt='Speakers'
                                                                     src='assets/image/product/smart-speaker.jpg'
                                                                     class='d-zoom-2' width='64'/></div>
                                                            <div class='border-1 radius-2 mx-1 brc-primary-l1 shadow-sm d-style overflow-hidden'>
                                                                <img alt='Shoes'
                                                                     src='assets/image/product/running-shoes.jpg'
                                                                     class='d-zoom-2' width='64'/></div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-flex flex-row-reverse align-items-start col px-0">
                                            ...
                                            <div class="col px-0">
                                                <div class="d-flex flex-row-reverse mb-15 pos-rel">
                                                    ...
                                                    <div class="py-2 px-3 radius-1 bgc-primary-l3 text-dark-m1 pos-rel">
                                                        <div class="text-90" style="max-width: 480px;">
                                                            Are you sure fusce dapibus tellus ac cursus commodo??? <span
                                                                    class='fa-stack w-auto'> <i
                                                                        class='fas fa-circle text-dark fa-stack-1x text-100'></i> <i
                                                                        class='fas fa-grin-alt text-warning-m3 text-125 fa-stack-1x pos-rel'></i> </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex flex-row-reverse mb-15 pos-rel">
                                                    ...
                                                    <div class="py-2 px-3 radius-1 bgc-primary-l3 text-dark-m1 pos-rel">
                                                        <div class="text-90" style="max-width: 480px;">
                                                            Considering donec id elit non mi porta gravida at eget metus
                                                            is undermined
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-footer px-25 pt-1px bgc-white border-1 border-t-0 brc-primary-l1 radius-b-2">
                                <div class="mb-0 p-3 dcard brc-grey-l1">
                                    <div class="input-group input-group-fade">
                                        <input id="id-reply" type="text"
                                               class="form-control pl-2 border-0 radius-0 shadow-none"
                                               placeholder="Write your message ..."/>

                                        <!-- smiley dropdown -->
                                        <div class="btn-group mx-2 dropup">
                                            <button type="button"
                                                    class="btn btn-xs px-1 border-0 btn-lighter-warning btn-bgc-tp dropdown-toggle"
