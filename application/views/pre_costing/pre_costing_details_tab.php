                ...
                <div class="tab-pane fade pr-0 pl-0" id="dyeing_cost_content_<?= $component['component_id'] ?>" role="tabpanel"
                    ...
                    <div class="card border-0">
                        <div class="mt-3 mb-2 pl-0 ml-2 text-royal-blue f-16">Dyeing & Processing Cost - <span style="color:grey"><?= $component['dying_type'] == 1 ? 'Solid Color' : 'Yarn Dye / Multi Color' ?></span></div>
                            <!--commented by me on 12/06/23 <div class="col-12 px-0 py-2" style=""><div class="col-12" style="border-top: 1px solid #022b61;"></div></div>-->
...
//            });
                   ...
                   let options = {
                    ...
                    if(grid_name == "garment_parts"){
                         validate = validateFiled('garment_parts', data);
                          ...
                          console.log(data.length);console.log(empvalidate);
                        let precheck=[];
                       ...
                       swalWithBootstrapButtons.fire({
                                title: 'Warning',
                                html: "please save garment parts details.",
                                icon: 'warning',
                                width:460,
                     ...
                     $('#' + 'knitting_cost_'+ component_id).click(function (){
                     //alert("rrrrr");
                    let validate = 0;
                    let data = k.getData();
                    if(grid_name == "yarn_cost_grid"){
                        let precheck=[];
                       ...
                       swalWithBootstrapButtons.fire({
                                title: 'Warning',
                                html: "please save yarn cost details.",
                                icon: 'warning',
                                width:460,
                                confirmButtonText: 'OK',
                                customClass: {
                        ...
                        $('#' + 'dyeing_cost_'+ component_id).click(function (){
                           // alert("yarn_cost_content");
                              test(component_id);
                     
                    let validate = 0;
                    let data = k.getData();
                    if(grid_name == "knitting_cost_grid"){
                        let precheck=[];
                       ...
                       swalWithBootstrapButtons.fire({
                                title: 'Warning',
                                html: "please save knitting_cost_grid details.",
                                icon: 'warning',
                                width:460,
                                confirmButtonText: 'OK',
                                customClass: {
                        ...
                        $('#' + 'emb_cost_'+ component_id).click(function (){
                           // alert("yarn_cost_content");
                              test(component_id);
                     
                    let validate = 0;
                    let data = k.getData();
                    if(grid_name == "dying_cost_grid"){
                        let precheck=[];
                       ...
                       swalWithBootstrapButtons.fire({
                                title: 'Warning',
                                html: "please save dying_cost_grid details.",
                                icon: 'warning',
                                width:460,
                                confirmButtonText: 'OK',
                                customClass: {
                    ...
                    swalWithBootstrapButtons.fire(
                        ...
                        if (result.value) {
                            ...
                            swalWithBootstrapButtons.fire({
                               ...
                               text:(
                                        (fabric_validate == 1)
                                            ? "Please fill all the fields of Yarn Cost in component details."
                                            : (
                                                (fabric_validate == 2)
                                                    ? "Please fill all the fields of Knitting Cost in component details."
                                                    : (
                                                        (fabric_validate == 3)
                                                            ? "Please fill all the fields of Dyeing and Processing Cost in component details."
                ...
                if(validate == 0 && actual_cost_validate==''){
                    swalWithBootstrapButtons.fire(
                        ...
                        // commented by me on 20/03/23
                            ...
                            swalWithBootstrapButtons.fire({
                                title: 'Warning',
                                text: (actual_cost_validate==2)?"Please fill all the fields of Fabric Cost in component details.":"Please fill all the fields to continue.",
                                icon: 'warning',
                                width:460,
                                confirmButtonText: 'OK',
                                customClass: {
    ...
    let spreadsheetInstances = {}; // global map to track grid instances

function test2(component_id) {
    //let grid_id = 'yarn_cost_grid_' + component_id;
      let grid_id = 'yarn_cost_grid';
    let spreadsheet = window.spreadsheets?.[grid_id];

    if (!spreadsheet) {
        console.warn('Spreadsheet not found or not initialized');
        return;
    }

    let data = spreadsheet.getData();
    let isEmpty = data.every(row => row.every(cell => cell === null || cell === ''));

    if (isEmpty) {
        alert('Grid is empty!');
    } else {
        console.log('Grid has data:', data);
    }
}
