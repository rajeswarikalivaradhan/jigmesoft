...
<div class="tab-content p-t20" >
    <div id="sampling_approval_details" class="tab-pane fade in active">
        ...
        <div class="card-body border-0 p-0 collapse show">
            <div class="table-responsive cus-ovrflw pad-b-20">
                <div id="samplingApprovalDetails" class=""></div>
            </div>
        </div>
    ...
    <div id="requirement" class="tab-pane fade in">
   
       <div class="mb-3 pl-0 ml-2 text-royal-blue f-14 txt-upcs">REQUIREMENT.</div>   
        <div class="card-body border-0 p-0 collapse show">
            <div class="table-responsive cus-ovrflw pad-b-5 jexcel-ht">

            
                
                <div id="BOM1requirementDetails" class="jexcel-container"></div>
            </div>
        </div>
    ...
    <div id="requirement_qty_consolidated" class="tab-pane fade ">
    <!-- <div class="mb-3 pl-0 ml-2 text-royal-blue f-14" style="display: flex; justify-content: space-between; align-items: center;">REQUIREMENT QTY. CONSOLIDATED</div> -->
        <div class="mb-3 pl-0 ml-2 text-royal-blue f-14" style="display: flex; justify-content: space-between; align-items: center;">
        <span>REQUIREMENT QTY. CONSOLIDATED</span>
    ...
    <div class="card-body border-0 p-0 collapse show">
            <div class="table-responsive cus-ovrflw pad-b-20">
                <div id="bom1requirementQtyConsolidated" class=""></div>
            </div>
        </div>
    ...
    <div class="mb-3 pl-0 ml-2 text-royal-blue f-14">BOM (Art - 1) SOURCING DETAILS</div>
        <div class="card-body border-0 p-0 collapse show">
            <div class="table-responsive pad-b-20">
                <div id="bom1_sourcingDetails" class=""></div>
            </div>
        </div>
...
<!-- <div class="card border-0">
    ...
    <div id="bom1samplingdespatch" class="col-12 p-0"></div>
    
    <div class="card-footer clearfix bgc-white border-0 p-3">
        <button class="btn btn-info btn-sm mar-l-5rem pull-right" ID="bom1sampling_despatch-btn">SAVE</button>
    </div>
</div> -->
