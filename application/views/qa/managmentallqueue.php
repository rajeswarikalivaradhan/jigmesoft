...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
      <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 120px;">
...
<script src="<?php echo base_url();?>assets/custom/request/managmentallqueue.js"></script>
