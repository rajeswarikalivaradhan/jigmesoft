...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px; padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">SAMPLE QA QUEUE LIST</b></span>
        ...
        <section class="content-header p-0">
            <div class="col-sm-12 p-0" >
                ...
                <div class="search_area col-sm-12 px-5 hide">
                                     ...
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Brand</th>
                                         ...
                                         <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">Queue No.</th>
                                        <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Request For</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;" >Item Description</th>
                                         <th width="11%" class="theadstyle" style=" padding: 0px 12px!important;">CutOff Date & Time</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 12px!important;">CutOff Date & Time</th>
                                        
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">Q.A. Request By</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="queue_no"  id="queue_no" placeholder="Free Text">
                                            </td>
                                             
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="RequestFor"  id="RequestFor" placeholder="Free Text">
                                            </td>
                                            <td>
                                             ...
                                             <td>
                                              ...
                                              <td>
                                                <input class="input-sm form-control  mt-2" name="QARequestby"  id="QARequestby" placeholder="Free Text">
                                            </td>
                    ...
                    </div><div class="col-sm-12 " style="padding:13px 0">
                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <table id="QaQueueListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                <tr>
                                    <th></th>
                                    ...
                                    <th id="8">Request User Name</th>
                                    <th id="10">Current <br />Status</th>
...
<script src="<?php echo base_url();?>assets/custom/request/sampleqaqueue.js"></script>
