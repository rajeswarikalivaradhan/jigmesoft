...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial;padding-left: 10px">SAMPLE QUEUE LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" id="Queue_no" name="Queue_no" placeholder="Free Text">
                                            </td>
                                            <td>
...
<script src="<?php echo base_url();?>assets/custom/request/sample/merchantsamplequeue.js"></script>
