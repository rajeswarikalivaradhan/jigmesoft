                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <table id="merchantBomQueueTbl" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
...
<script src="<?php echo base_url();?>assets/custom/request/bom2/merchantbom2queue.js"></script>
