...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px; padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">PRODUCTION QA QUEUE LIST</b></span>
...
<script src="<?php echo base_url();?>assets/custom/request/productionqaqueue.js"></script>
