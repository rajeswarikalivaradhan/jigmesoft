...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    <div class="col-12 text-right pr-3 py-3">                
                        <a class="btn btn-info btn-sm mr-4" href="<?php echo base_url('request/myarnstore/generalstocklist'); ?>">YARN GENERAL STOCK LIST</a>
                        <a class="btn btn-info btn-sm mr-4" href="<?php echo base_url('request/myarnstore/orderstocklist'); ?>">YARN ORDER STOCK LIST</a>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/yarnstore/edit_pi_details.js">
