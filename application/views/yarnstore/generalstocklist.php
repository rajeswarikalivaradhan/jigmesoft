...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="col-md-6">
                <h1 style="margin: 0; font-size: 20px; font-weight: 600">YARN GENERAL STOCK LIST</h1>
            </div>
                        ...
                        <div class="box-body no-padding">
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th id="0">GSL Ref. No.</th>
                                        <th id="1">Item</th>
                                        <th id="2">Vendor</th>
                                        <th id="3">Product Code<br> (Vendor's)</th>
                                        <th id="5">Blend (%) / Content</th>
                                        <th id="6">Count</th>
                                        <th id="7">Special<br> Request.</th>
                                        <th id="8">Colour</th>
...
<script src="<?php echo base_url();?>assets/custom/request/yarnstore/generalstocklist.js"></script>
<script>
