...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="pi_req_status" name="pi_req_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="1" <?php if($requestData['pi_req_status']=="1") echo "selected=\"selected\""; ?>>REQ. ACCEPTED</option>
                                    <option value="2" <?php if($requestData['pi_req_status']=="2") echo "selected=\"selected\""; ?>>REQ. DECLINED</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control h-200 mgmt" id="mgmt_appl_remarks" placeholder="Free Text"><?php echo $requestData['mgmt_appl_remarks']; ?></textarea>
                            </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/yarnstore/pi_details.js"></script>
