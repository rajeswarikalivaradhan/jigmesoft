    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">CAD User List
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url(CNFCOMPANY . "mcaduser/addedit") ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="tablecaduserList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY?>mcadusers.js"></script>
<script>
