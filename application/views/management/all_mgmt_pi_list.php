...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">PURCHASE INDENT LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">P.I. Date & Time</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">P.I. Date & Time</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="vedornames"  id="vedornames" placeholder="Free Text">
                                            </td>
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="piref_no"  id="piref_no" placeholder="Free Text">
                                            </td>
                            ...
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="0">WIP Ref. No. </th>
                                        <th id="1">Brand</th>
                                        <th id="2" style="width: 9%">Request For</th>
                                        <th id="2">Requirement</th>
                                        <th id="3">Vendor Name</th>
                                        ...
                                        <th style="width: 95px;" id="11">Current <br>Status</th>
                                        <th id="9">Recent <br />Update </th>
                                        <th id="10">Status</th>
                                    </tr>
                                </thead>
...
<script src="<?php echo base_url();?>assets/custom/mgmt/all_mgmt_pi_list.js"></script>
