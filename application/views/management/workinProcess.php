                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            ...
                            <table id="workInProgressTbl" class="table table-bordered table-hover" style="padding: 0px 2px;border-bottom: 1px solid rgb(2, 43, 97) !important;">
                                <thead>
                                <tr>
                                    <!-- <th style=""></th>
                                    ...
                                    <th style="">Order / Enq.<br>Ref. No.</th>
                                    <th style="">Style Ref. No. /<br> Name</th>
                                    <th style="">Brand</th>
                                    <th style="">P.O./Sample <br/>Ref. No.</th>
                                    <th style="">P.O./Sample <br> Qty.</th>
                                    <th style="">Pcs. /<br> Set</th>
                                    <th style="">Shipment /<br>Submission Date</th>
                                    <th style="">Current <br>Status</th>
                                    <th style="">Recent Update </th>
                                    <th style="">Status</th>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/mgmt-work-in-process.js"></script>
