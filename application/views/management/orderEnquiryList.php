...
<<<<<<< HEAD
        <div class="col-sm-12" style="display: block  padding: 10px 25px;padding-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial"> Enquiry Authorization List1111</b></span>
=======
        <div class="col-sm-12" style="display: block  padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial"> Enquiry Authorization List</b></span>
>>>>>>> 0c2ef3227544abb8304b6df52926a972932bd6df
...
<script src="<?php echo base_url();?>assets/custom/management-list.js"></script>
<style>
    .tables > thead > tr > th{
