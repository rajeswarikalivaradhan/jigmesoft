...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        ...
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 111px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial"> Enquiry Authorization List - ISR</b></span>
...
<script src="<?php echo base_url();?>assets/custom/management-isr-list.js"></script>
