    ...
    <div class="content-wrapper bgn-white">
        <!-- <section class="content-header">
            <div class="col-md-6" style="padding-left: 20px">
                <h1 style="margin: 0; font-size: 20px; font-weight: 600">ENQUIRY AUTHORIZATION LIST
                </h1>
            </div>
        ...
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 111px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial"> Enquiry Authorization List - IOR</b></span>
            <div class="btn-toolbar pull-right " style="padding-top: 4px;padding-bottom: 10px" role="toolbar" aria-label="Toolbar with button groups">
            ...
            <div class="btn-group mr-2v  text-right" role="group" aria-label="Second group" style="padding-left: 5px" >
                ...
                <!-- <div class="btn-group mr-2 text-right" role="group" aria-label="Third group">&nbsp;</div> -->
            </div>
        </div>
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="order_enq_ref_no" placeholder="Free Text">
                                            </td>
                                            <td width="15%">
                                                <select class="input-sm form-control  mt-2 js-example-basic-single nrml-slt-inp" name="brandId">
                                                    <option value="">Select</option>
                                                    <?php
                                            ...
                                            <td>
                                             <p id="enquirySearch" class="input-group search-div">
                                                <input type="text" style="width:100%!important" placeholder="From" id="datecreatedfrom" name="datecreatedfrom" class="date input-sm form-control  mt-2 start search-date" />
                                                <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                             </p>
                                            </td>
                                            <td>
                                                <p id="enquirySearch" class="input-group search-div">
                                                <input type="text" style="width:100%!important" placeholder="To" id="datecreatedto" name="datecreatedto" class="date input-sm form-control  mt-2 end search-date" />
                                                <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                                </p>
                                            </td>
                                            <td width="15%">
                                                 <!--<input class="input-sm form-control  mt-2" name="enquirytype" placeholder="Free Text">-->
                                                 <select class="input-sm form-control  mt-2 js-example-basic-single nrml-slt-inp" name="enquirytype">
                                                    <option value="">Select</option>
                                                    <?php
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="totalcomponents" placeholder="Free Text">
                                            </td>
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="totalcombo" placeholder="Free Text">
                                            </td>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="orderEnquiryListTbl" class="table table-bordered table-hover" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                <thead>
                                <tr>
                                    <th></th>
                                    <!-- <th id="1">Order / Enquiry Ref. No.</th>
                                    <th id="1">Request <br />Date & Time</th>
                                    <th id="2">Brand / Buyer</th>
                                    <th id="3">Request <br />Type</th>
                                    <th id="4">Enquiry Type</th>
                                    <th id="5">Style Ref. No. /<br /> Name</th>
                                    <th id="6">Confirmed Price</th>
                                    <th id="7">Currency</th>
                                    <th>Merchant</th>
...
<script src="<?php echo base_url();?>assets/custom/management-ior-list.js"></script>
