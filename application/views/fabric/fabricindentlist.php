    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="col-md-6" style="padding-left: 20px">
                <h1 style="margin: 0; font-size: 20px; font-weight: 700">FABRIC INDENT RECEIVED LIST</h1>
            </div>
                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <table id="mFabIndentList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th>WIP Ref. No.</th>
...
var dataTbl = '';
    $(document).ready(function() {
        dataTbl = $('#mFabIndentList').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url(CNFCOMPANY.'mfabricuser/indentlist')?>",
                "type": "POST",
                "data": {"rfrom":1}
            },
            //"order": [0,"desc"]
            ...
            if (checkBoxLength >= 1) {
                ...
                if (confirm('Do you want to ' + GlbStatusForMaster[dropdownOpt] + ' this records?')) {
                    MakeAsynPostRequest(base_path + 'dashboard/cmnChangeStatus', 'idField=requestid&ckId=' + idJson + '&cs=' + dropdownOpt +
                        '&tblName=kn_merchant_sample_fab_indent', 'json', function (data) {
                        console.log(data, 'data');
                        dataTbl.ajax.url("<?php echo base_url(CNFCOMPANY.'mfabricuser/indentlist') ?>").load();
