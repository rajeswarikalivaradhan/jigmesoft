        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Garment Sample Requirement
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url() . CNFCOMPANY ?>mgarmentsampling/addedit">
                ...
                <div class="col-md-12">
                            ...
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Garment Sample
                                            Requirement</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchName" class="form-control" id="frmSrchName"
                                                   placeholder="Garment Sample Requirement">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="GarSamplingList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Garment Sample Requirement<i class="fa fa-fw fa-sort"></i></th>
