...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New User Details':'View User Details' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url('/dashboard') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="department_id" id="department_id" class="form-control">
											...
											<?php  $ArrUserTypes = ($ArrBasicInfo['usertype']!=0 && $ArrBasicInfo['usertype']!=16)?unserialize(ARRUSERTYPE):unserialize(BARRUSERTYPE);
