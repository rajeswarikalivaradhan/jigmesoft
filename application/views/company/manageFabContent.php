...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Fabric Content List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>fabriccontent/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Fabric Content</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10%">
                                                <input type="text" name="frmSrchContent" class="form-control" id="frmSrchContent" placeholder="Free Text">
            ...
            <section class="content-header">
                <h1 class="firstHeading">
                    ...
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url() . CNFCOMPANY ?>fabriccontent/addedit">
                            ...
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="frmSrchContent" class="col-sm-4 control-label">Content</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchContent" class="form-control"
                                                   id="frmSrchContent" placeholder="Content">
                                            <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12" style="padding: 10px 0 20px 0">
                                ...
                                <div class="col-sm-3 col-xs-12 pull-right no-padding">
                                    <div class="col-sm-8 col-xs-8">
                                        <select name="frmItemStatus" id="frmItemStatus" title="change active/inactive"
                                                class="form-control ">
                                            <option value="">Select</option>
                                            <?php
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>fabricContent.js"></script>
