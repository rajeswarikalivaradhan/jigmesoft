    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">Consignee <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
                        ...
                        <div class="box box-info">
                            ...
                            <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 control-label">Consignee Name</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicContactname" class="form-control"
                                                           id="frmBasicContactname" placeholder="Consignee Name"
                                                           value="<?php echo @$ArrBasicInfo['name']; ?>">
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 text-right">Consignee Name</label>
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['name']; ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="box-footer boxFooter_pd1025">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'mconsignee/manageconsignee') ?>"
