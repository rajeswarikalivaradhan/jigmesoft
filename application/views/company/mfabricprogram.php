...
-->
                        <div class="box-body">
                                ...
                                <div id="fabricCalcCC"></div>
                            <div id="fabConsumptionCalc_0"></div>

                            <!--<div id="fabricConsumptionCalc_0"></div>-->


                            <!--<button class="btn btn-info pull-right" type="button" id="cccalc" onclick="fnConsCalc()">Consumption Calculation</button>-->

<!--                                <div id="consumptionheading"></div>

                                <table class="table table-bordered table-responsive">
                                    <tr class="mainheading"><td><strong>FABRIC CONSUMPTION CALCULATION : </strong></td></tr>
                                    <tr><td>
                                            <select id="frmFabricCCType" class="form-control">
                            ...
                            <div class="mainheading" style="padding: 5px; font-size: 16px">
                                <strong>ITEMIZED FABRIC REQUIREMENT DETAILS</strong>
                            </div>
                            <div id="frmRequirementDetails"></div>-->
...
<script src="<?php echo base_url()."assets/js/".CNFCOMPANY."mfabricprogram.js"?>"></script>
<script>
    //fnConsCalc();
    //consumptionData();
    consumptionData();
