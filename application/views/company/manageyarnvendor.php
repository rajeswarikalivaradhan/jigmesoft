            ...
            <section class="content-header">
                <h1 class="firstHeading">
                    ...
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url() . CNFCOMPANY ?>myarnvendor/addedit">
                ...
                <div class="col-md-12">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Yarn Vendor</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-control" id="frmSrchYarnName"
                                                   placeholder="Yarn Vendor">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchYarnStatus" id="frmSrchYarnStatus"
                                                    class="form-control">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="mYarnvendorList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Yarn Vendor<i class="fa fa-fw fa-sort"></i></th>
