        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Dyeing Vendor<a class="btn btn-default addBtnDetails"
                                              href="<?php echo base_url() . CNFCOMPANY ?>mdyeingvendor/addedit">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="mdyeingvendorList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mdyeingvendor.js"></script>
