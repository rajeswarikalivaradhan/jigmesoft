    ...
    <div class="content-wrapper">
        <section class="content">
			<section class="invoice form-horizontal">
                <div class="row"> 
					<div class="col-xs-12">
						<h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Dyeing Special Request':'View / Edit Dyeing Special Request' ?>
						  <div class="pull-right">
											<div class="ml-auto pr-3">
											<a href="<?php echo base_url(CNFCOMPANY . 'mdsr/managedsr') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
											<?php 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-4 control-label">
                                     Dyeing Special Request <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicDSR" value="<?php echo @$ArrBasicInfo['dsrname']; ?>" placeholder="Free Text">
				...
				<div class="row">
					...
					<button class="btn btn-info pull-right mx-2" id="enqsvbtn" onclick="return fnSaveDSRInfo();">Save</button>
					</div>
				</div>
			</section>     
		</section>
