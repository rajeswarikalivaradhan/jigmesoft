...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Add/Edit Yarn Purchase Type</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>myarn/manageyarnpurchasetype/">Yarn Purchase Type List</a></li>
                <li class="active">Add/Edit Yarn Purchase Type</li>
            </ol>
        </section>
                                    ...
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-4 control-label">Yarn Purchase Type</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="" class="form-control" id="frmBasicYarnPurchaseType" placeholder="Yarn Purchase Type" value="<?php echo @$ArrBasicInfo['yarnpurchasetype'];?>">
                                                    <div class="herr" id="ErrfrmBasicYarnPurchaseType"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveYarnPurchaseTypeInfo();">Save Changes</button>
                                        </div>
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNew==1) {?>hide<?php }?>">
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 text-right">Yarn Purchase Type</label>
                                                <div class="col-sm-10" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['yarnpurchasetype'];?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>myarnpurchasetype.js"></script>
