        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Consignee<a class="btn btn-default addBtnDetails"
                                              href="<?php echo base_url() . CNFCOMPANY ?>mconsignee/addedit">
                ...
                <div class="col-md-12">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Consignee
                                            name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchConsigneeName" class="form-control"
                                                   id="frmSrchConsigneeName" placeholder="Consignee name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Mobile No.</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchMobileNo" class="form-control"
                                                   id="frmSrchMobileNo" placeholder="Mobile Number">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="mconsigneeList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="1">Consignee Name<i class="fa fa-fw fa-sort"></i>
                                    </th>
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mconsignee.js"></script>
