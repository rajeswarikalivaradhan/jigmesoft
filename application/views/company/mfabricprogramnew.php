...
-->
                        <div class="box-body">
                                ...
                                <div id="fabricCalcCCFull"></div>

                            <!--<button class="btn btn-info pull-right" type="button" id="cccalc" onclick="fnListData()">Consumption Calculation</button>-->
...
<script src="<?php echo base_url()."assets/js/".CNFCOMPANY."mfabricprogramnew.js"?>"></script>
<script>
    fnListData();
</script>
<style>
