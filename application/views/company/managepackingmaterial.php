            ...
            <section class="content-header">
                <h1 class="firstHeading">
                    ...
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url() . CNFCOMPANY ?>mpackingmaterial/addedit">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchPackingMaterial"
                              id="frmNameSearchPackingMaterial">
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Packing Material</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchPackingMaterialName" class="form-control"
                                                   id="frmSrchPackingMaterialName" placeholder="Packing Material">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchPackingMaterialStatus"
                                                    id="frmSrchPackingMaterialStatus" class="form-control">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <button type="button" class="btn btn-default"
                                        onclick="refreshPage('frmNameSearchPackingMaterial');">Reset
                                </button>
                                <button type="button" class="btn btn-info pull-right"
                                        onclick="fnSearchPackingMaterial();">Search
                                </button>
                            </div>
                        </form>
                    </div>
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="packingmaterialtableList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Packing Material<i class="fa fa-fw fa-sort"></i>
                                    </th>
