            ...
            <section class="content-header">
                <h1 class="firstHeading">
                    ...
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url(CNFCOMPANY . 'mbommaterial/addedit'); ?>">
                            ...
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="frmSrchYarn" class="col-sm-4 control-label">BOM Material</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchYarn" class="form-control"
                                                   id="frmSrchYarn" placeholder="Material">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="tableId" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">BOM Material<i class="fa fa-fw fa-sort"></i></th>
