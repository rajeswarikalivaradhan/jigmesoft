                    ...
                    <div class="col-md-12">
                        <div class="col-sm-3">
                            <div class="form-group">
                                    ...
                                    Enquiry Authorization List
                                    </label>
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="Enquiry Authorization List" <?php if(count($ArrRoleInfo)>0 && in_array('Enquiry Authorization List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="WIP List" <?php if(count($ArrRoleInfo)>0 && in_array('WIP List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="Work Authorization List" <?php if(count($ArrRoleInfo)>0 && in_array('Work Authorization List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="P.I. Approval List" <?php if(count($ArrRoleInfo)>0 && in_array('P.I. Approval List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="P.I. List" <?php if(count($ArrRoleInfo)>0 && in_array('P.I. List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="Bill Paid List" <?php if(count($ArrRoleInfo)>0 && in_array('Bill Paid List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                    </div>
