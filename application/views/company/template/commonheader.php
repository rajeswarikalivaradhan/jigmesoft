...
if($usertype==0 || $usertype==16){
    $companyname='AZIBO INFOTECH PRIVATE LIMITED';
}else{
    $companyname=$ArrCompanyRes[0]['companyname'];
}
$VarDesignation = '-';
...
<header class="main-header">
    ...
    <nav class="main-header navbar navbar-expand navbar-light navbar-blue-royal" role="navigation">
        ...
        <span style="padding: 20px; float: left;font-size:14px; display: inline-flex" class="badge-royal-blue">|<span class="pl-4 pr-4"><?php echo @$companyname; ?></span>|</span>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle text-white profile_how" data-toggle="dropdown">
                        ...
                        if (isset($ArrProfileInfo['usertype'])) {
                            $ArrUt = ($ArrProfileInfo['usertype']!=0 && $ArrProfileInfo['usertype']!=16)?unserialize(ARRUSERTYPE):unserialize(BARRUSERTYPE);
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-body hide">
                            ...
                            <div class="text-center"><a  style="color: #022B61!important;" class="font-12" href="<?php echo base_url('profile/view') ?>">User
                                    Profile</a></div>
                        </li>
