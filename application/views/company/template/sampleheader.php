                ...
                <ul class="menu-nav nav navbar-nav pull-right">
                    ...
                    <?php if($userType != '2' && (count($ArrRoleInfo)>0 && in_array('Enquiry List',$ArrRoleInfo))) { ?>
                     ...
                     <?php } else if($userType == '2' && (count($ArrRoleInfo)>0 && in_array('Enquiry Authorization List',$ArrRoleInfo))) { ?>
                        ...
                        <ul class="dropdown-menu">
                            <li class="allenquiry1 dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'orderEnquiryList' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                                <a tabindex="-1" href="<?= base_url('management/orderEnquiryList') ?>">All Enquiry List <span class="carets"></span></a>
                                <ul class="dropdown-menu">
                                    <li class="<?php if($this->router->fetch_method() == 'orderEnquiryList') echo "active";?>"><a href="<?= base_url('management/orderEnquiryList') ?>">All</a></li>
                                    <li><a href="#" id="active">Active</a></li>
                                    <li><a href="#" id="inactive">Inactive</a></li>
                                </ul>
                            </li>
                            <li class="allenquiry2 dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'orderEnquiryList' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                                <a tabindex="-1" href="<?= base_url('management/iorenquirylist') ?>">IOR LIST <span class="carets"></span></a>
                                
                            </li>
                            <li class="allenquiry3 dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'orderEnquiryList' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                                <a tabindex="-1" href="<?= base_url('management/isrenquirylist') ?>">ISR LIST <span class="carets"></span></a>
                    ...
                    <li class="nav-item dropdown <?php if($this->router->fetch_method() == 'manageWip'||$this->router->fetch_method() == 'manageIOR'
                        ...
                        <ul class="dropdown-menu">
                        <li class="allwiplist dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'manageWip' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                        
                        <a tabindex="-1" href="<?= base_url('merchant/manageWip') ?>">WIP List <span class="carets"></span></a>
                               <ul class="dropdown-menu">
                                    <li class="<?php if($this->router->fetch_method() == 'manageWip') echo "active";?>"><a href="<?= base_url('merchant/manageWip') ?>">All</a></li>
                                    <li><a href="#" id="active">Active</a></li>
                                    <li><a href="#" id="inactive">Inactive</a></li>
                                </ul>
                               
                            </li>
                            <li class="allwiplist dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'manageIOR' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                           
                            <a href="<?= base_url('merchant/manageIOR') ?>">IOR LIST <span class="carets"></span></a>
                                <ul class="dropdown-menu">
                                    <li class="<?php if($this->router->fetch_method() == 'manageIOR') echo "active";?>"><a href="<?= base_url('merchant/manageIOR') ?>">All</a></li>
                                    <li><a href="#" id="ioractive">Active</a></li>
                                    <li><a href="#" id="iorinactive">Inactive</a></li>
                                </ul>
                               
                            </li>
                            <li class="allwiplist dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'manageISR' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                           
                            <a href="<?= base_url('merchant/manageISR') ?>">ISR LIST <span class="carets"></span></a>
                                <ul class="dropdown-menu">
                                    <li class="<?php if($this->router->fetch_method() == 'manageISR') echo "active";?>"><a href="<?= base_url('merchant/manageISR') ?>">All</a></li>
                                    <li><a href="#" id="isractive">Active</a></li>
                                    <li><a href="#" id="isrinactive">Inactive</a></li>
                                </ul>
                    ...
                    <?php } else if($userType == '2' && (count($ArrRoleInfo)>0 && in_array('WIP List',$ArrRoleInfo))) { ?>
                        <li class="nav-item dropdown <?php if($this->router->fetch_method() == 'manageWip'||$this->router->fetch_method() == 'manageIOR'
                            ||$this->router->fetch_method() == 'manageISR'|| $this->uri->segment(1) == 'wipPrecosting' || ($this->router->fetch_method()=='componentCreation' && $this->uri->segment(4)=='wiplist') ||
                            ($this->uri->segment(1) == 'WorkInProcess'&&($this->router->fetch_method()=='index'||$this->router->fetch_method()=='fabric_program'))
                        ) echo "active";?>">
                        <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="#">Wip.Auth. List <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="allenquiry1 dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'manageWip' || $this->router->fetch_method() == 'manageIOR'
                            ||$this->router->fetch_method() == 'manageISR'|| $this->uri->segment(1) == 'wipPrecosting' || ($this->router->fetch_method()=='componentCreation' && $this->uri->segment(4)=='wiplist') ||
                            ($this->uri->segment(1) == 'WorkInProcess'&&($this->router->fetch_method()=='index'||$this->router->fetch_method()=='fabric_program'))
                        ) echo "active";?>">
                                 <a tabindex="-1" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">WIP List <span class="caret"></span></a>
                               <ul class="dropdown-menu">
                                    <li class="<?php if($this->router->fetch_method() == 'manageWip') echo "active";?>"><a href="<?= base_url('management/manageWip') ?>">All</a></li>
                                    <li><a href="#" id="active">Active</a></li>
                                    <li><a href="#" id="inactive">Inactive</a></li>
                                </ul>
                            </li>
                            <li class="allenquiry2 dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'manageIOR' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                                <a  href="<?= base_url('management/manageIOR') ?>">IOR LIST <span class="carets"></span></a>
                                
                            </li>
                            <li class="allenquiry3 dropdown-submenu nav-item <?php if($this->router->fetch_method() == 'manageISR' || $this->router->fetch_method() == 'addenquiry') echo "active";?>">
                                <a  href="<?= base_url('management/manageISR') ?>">ISR LIST <span class="carets"></span></a>
