...
<header class="main-header">
    ...
    <nav class="main-header navbar navbar-expand navbar-light navbar-blue-royal" role="navigation">
        ...
        <span style="padding: 20px; float: left;font-size:14px; display: inline-flex" class="badge-royal-blue">|<span class="pl-4 pr-4">AZIBO INFOTECH PRIVATE LIMITED</span>|</span>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle text-white profile_how" data-toggle="dropdown">
                        ...
                        if (isset($ArrProfileInfo['usertype'])) {
                            $ArrUt = unserialize(BARRUSERTYPE);
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="menu-nav nav navbar-nav pull-right">
                     <?php if(count($ArrRoleInfo)>0 && in_array('Manage Master Data',$ArrRoleInfo)) {?>
                      <li class="nav-item dropdown <?php echo ($this->uri->segment(2)=='mpackage' || $this->uri->segment(2)=='mdescp' || $this->uri->segment(2)=='mdetail' || $this->uri->segment(2)=='munitrate')?'active':''?>">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item <?php echo ($this->uri->segment(2)=='mpackage')?'active':'';?>"><a class="nav-link" href="<?php echo base_url( CNFBADMIN.'mpackage/manage') ?>">Package Details</a></li>
                            <li class="nav-item  <?php echo ($this->uri->segment(2)=='mdescp')?'active':'';?>"><a class="nav-link" href="<?php echo base_url( CNFBADMIN.'mdescp/manage') ?>">Description</a></li>
                            <li class="nav-item <?php echo ($this->uri->segment(2)=='mdetail')?'active':'';?>"><a class="nav-link" href="<?php echo base_url( CNFBADMIN.'mdetail/manage') ?>">Details</a></li>
                            <li class="nav-item <?php echo ($this->uri->segment(2)=='munitrate')?'active':'';?>"><a class="nav-link" href="<?php echo base_url( CNFBADMIN.'munitrate/manage') ?>">Unit Rate (Rs)</a></li>
                        </ul>
                      </li>
                     <?php } ?>
                     ...
                     <li class="nav-item dropdown <?php echo ($this->uri->segment(2)=='muser')?'active':''?>">
                        <a  href="<?php echo base_url(CNFBADMIN.'muser/manage') ?>">Manage Department & User</a>
                        
                     </li>
                     <?php } ?>
                     <?php if(count($ArrRoleInfo)>0 && in_array('Request Received List',$ArrRoleInfo)) {?>
                     <li class="nav-item dropdown <?php echo ($this->uri->segment(2)=='mreqrcved')?'active':''?>">
                        <a  href="<?php echo base_url(CNFBADMIN.'mreqrcved/manage') ?>">Request Received List</a>
                     </li>
                      <?php } ?>
                     <?php if(count($ArrRoleInfo)>0 && in_array('Proforma Invoice List',$ArrRoleInfo)) {?>
                     <li class="nav-item dropdown <?php echo ($this->uri->segment(1)=='invoice')?'active':''?>">
                        <a href="<?php echo base_url('invoice/manage') ?>">Proforma Invoice List</a>
                     </li>
                     <?php } ?>
                     <?php if(count($ArrRoleInfo)>0 && in_array('Subscriber List',$ArrRoleInfo)) {?>
                     <li class="nav-item dropdown <?php echo ($this->uri->segment(2)=='msubscription')?'active':''?>" id="sublistbtns">
                        <a href="<?php echo base_url( CNFBADMIN.'msubscription/manage') ?>">Subscriber List</a>
                     </li>
                      <?php } ?>
                </ul>
        <?php } else if($userType == '16') { ?> 
                     <ul class="menu-nav nav navbar-nav pull-right">
                     <?php if(count($ArrRoleInfo)>0 && in_array('Subscriber Enquiry List',$ArrRoleInfo)) {?>
                     <li class="nav-item dropdown <?php echo ($this->uri->segment(2)=='msubscriber')?'active':''?>"><a  href="<?php echo base_url( CNFBADMIN.'msubscriber/manage') ?>">Subscriber Enquiry List</a></li>
                     <?php } ?>
                     <?php if(count($ArrRoleInfo)>0 && in_array('Proforma Invoice List',$ArrRoleInfo)) {?>
                     <li class="nav-item dropdown <?php echo ($this->uri->segment(1)=='invoice')?'active':''?>"><a  href="<?php echo base_url('invoice/manage') ?>">Proforma Invoice List</a></li>
                     <?php } ?>
                     </ul>
        <?php } ?>
        </div><!-- /.navbar-collapse -->
