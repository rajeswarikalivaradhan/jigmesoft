        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Buyer <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
                        ...
                        <div class="box box-info">
                            ...
                            <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 control-label">Buyer Name</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicBuyer" class="form-control"
                                                           id="frmBasicBuyer" placeholder="Buyer Name"
                                                           value="<?php echo @$buyer[0]->buyername; ?>">
                                                    <div class="herr" id="ErrfrmBasicBuyer"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="frmBasicStatus" id="frmBasicStatus"
                                                        ...
                                                        foreach ($ArrStatus as $VarKey => $VarStatus) { ?>
                                                            <option
                                                                value="<?php echo $VarKey ?>" <?php if (@$buyer[0]->status == $VarKey) {
                                                                echo "selected";
                                ...
                                <div class="box-footer boxFooter_pd1025">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'mbuyer/manage') ?>"
                                       class="btn btn-default">Back</a>
                                    <button type="button"
                                            class="btn btn-info pull-right <?php if ($Edit != 'edit' && !empty($VarId)) echo 'hide' ?>"
                                            onclick="return fnSaveInfo();">
                                        Save Changes
                                    </button>
                                </div>
                            </form>
