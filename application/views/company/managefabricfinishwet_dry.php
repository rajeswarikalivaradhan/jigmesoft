...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Fabric  Processing Description List </b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>mfabricfinishwet_dry/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Fabric Finishing Process</th>
										<th class="theadstyle">Process Type</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10%">
                                                <input type="text" name="frmSrchFf" class="form-control" id="frmSrchFf" placeholder="Free Text">
                                                <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                            </td>
											<td width="10%">
                                                <select name="frmSrchptype" id="frmSrchptype" class="form-control">
                                                <option value="">Select</option>
                    ...
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="tableId" class="table table-bordered table-hover" data-page-length="50" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                ...
                                <tr>
                                    <th  class="no-sort"></th>
                                    <th id="0">Process Description</th>
									<th id="1">Process Type</th>
                                    <th id="2">Status</th>
                                    <th id="3">Updated By</th>
                                    <th id="4">Recent Update</th>
									<th>Action</th>
                                </tr>
                                </thead>
                            </table>
        ...
        <section class="content-header">
            <div class="col-md-12">
                <h1 class="firstHeading">
                    Fabric Finish Wet / Dry<a class="btn btn-default addBtnDetails"
                                              href="<?php echo base_url() . CNFCOMPANY ?>mfabricfinishwet_dry/addedit">
                        ...
                        <form class="form-horizontal" name="frmNameSearch" id="frmNameSearch">
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group myFormGroupMb0">
                                        <label for="" class="col-sm-4 control-label">Fabric Finish</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchFf" class="form-control" id="frmSrchFf"
                                                   placeholder="Fabric Finish">
                                            <div id="ErrfrmSrchFf" class="herr"></div>
                                            <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="frmSrchptype" class="col-sm-4 control-label">Processing Type</label>
                                        <div class="col-sm-8">
                                            <select name="frmSrchptype" id="frmSrchptype" class="form-control">
                                                <option value="">Select</option>
                                                <option value="Wet">Wet</option>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="tableList" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Fabric Finish<i class="fa fa-fw fa-sort"></i></th>
                                    <th class="sortable asc" id="1">Processing Type<i class="fa fa-fw fa-sort"></i></th>
