    ...
    <div class="content-wrapper">
        <section class="content">
			<section class="invoice form-horizontal">
                <div class="row"> 
					<div class="col-xs-12">
						<h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Embellishment Medium / Material':'View / Edit Embellishment Medium / Material' ?>
						  <div class="pull-right">
											<div class="ml-auto pr-3">
											<a href="<?php echo base_url(CNFCOMPANY . 'membellishment/manageMediumMaterial') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
											<?php 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-4 control-label">
                                     Embellishment Medium / Material <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicMm" value="<?php echo @$ArrBasicInfo['medium_material']; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrfrmBasicMm"></div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="content-wrapper hide">
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">Medium / Material
                     <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
        <section class="content">
            <div class="row">
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-4 control-label">Medium / Material</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="" class="form-control" id="frmBasicMm"
                                                           placeholder="Medium / Material"
                                                           value="<?php echo @$ArrBasicInfo['medium_material']; ?>">
                                                    <div class="herr" id="ErrfrmBasicMm"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-4 text-right">Medium / Material</label>
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['medium_material']; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'membellishment/manageMediumMaterial') ?>"
                                   class="btn btn-default"><i class="fa fa-arrow-left" style="margin-right: 10px"></i>Back</a>
                                <button type="button"
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mmediummaterial.js"></script>
