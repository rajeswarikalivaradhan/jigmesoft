    ...
    <div class="content-wrapper">
        <section class="content">
			<section class="invoice form-horizontal">
                <div class="row"> 
					<div class="col-xs-12">
						<h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Fabric Name':'View / Edit Fabric Name' ?>
						  <div class="pull-right">
											<div class="ml-auto pr-3">
											<a href="<?php echo base_url(CNFCOMPANY . 'fabricname/manage') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
											<?php 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-4 control-label">
                                     Fabric Name <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicFabric" value="<?php echo @$BasicInfo->misc_name; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrfrmBasicFabric"></div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Fabric <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
        <section class="content">
            <div class="row">
                        ...
                        <div class="box box-info">
                            ...
                            <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                ...
                                <div class="box-body pdt20_pdb0">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="frmBasicFabric"
                                                       class="col-sm-4 control-label">Fabric</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicFabric" class="form-control"
                                                           id="frmBasicFabric" placeholder="Fabric"
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 control-label">Fabric</label>
                                                <div class="col-sm-8">
                                ...
                                <div class="box-footer boxFooter_pd1025">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'fabricname/manage'); ?>"
...
<script src="<?php echo base_url() ?>assets/js/<?php echo CNFCOMPANY ?>fabricName.js"></script>
