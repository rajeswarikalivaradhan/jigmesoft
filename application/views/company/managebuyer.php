        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Buyer
                    <a class="btn btn-default addBtnDetails" href="<?php echo base_url() . CNFCOMPANY ?>mbuyer/addedit">
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right"><button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                </button>
                            </div>
                        </div>
                        <?php
                        ...
                        ?>
                        <form class="form-horizontal" name="frmNameSearchBuyer" id="frmNameSearchBuyer">
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Buyer Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchBuyer" class="form-control"
                                                   id="frmSrchBuyer" placeholder="Buyer Name">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="frmSrchBuyerStatus" class="col-sm-4 control-label">Status</label>
                                        <div class="col-sm-8">
                                            <select name="frmSrchBuyerStatus" id="frmSrchBuyerStatus" class="form-control">
                            ...
                            <div class="box-footer">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-default"
                                            onclick="refreshPage('frmNameSearchBuyer');">Reset
                                    </button>
                                    <button type="button" class="btn btn-info pull-right" onclick="fnSearchBuyer();">
                                        Search
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="buyerTblList" class="table table-bordered table-hover"><thead>
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Buyer Name<i class="fa fa-fw fa-sort"></i></th>
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>buyer.js"></script>
