                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Enquiry List" <?php if(count($ArrRoleInfo)>0 && in_array('Enquiry List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Stationery List" <?php if(count($ArrRoleInfo)>0 && in_array('Stationery List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Sample Received List" <?php if(count($ArrRoleInfo)>0 && in_array('Sample Received List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                    </div>
