...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Embellishment Job Work Details':'View / Edit Embellishment Job Work Details' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'mjobwrk/membelish') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    <?php 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                   ...
                                   Embellishment Job Work Name   <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="jobwrkname" value="<?php echo @$ArrBasicInfo['jobwrkname']; ?>" placeholder="Free Text">
                                    <div class="herr" id="Errjobwrkname"></div>
                                </div>
                            </div>
                        </div>
						<div class="col-md-12">
                        ...
                        <div class="col-md-12">
								<div class="form-group">
										<label for="id-form-field-focus-1" class="col-sm-4 control-label">
										Job Work Category <span class="mandatory">*</span>
										</label>
									<div class="col-sm-8">
									    <select name="wrk_categoryid" id="wrk_categoryid" class="form-control">
											<option value="">Select</option>
											<?php  $ArrVendorCategory = unserialize(ARRVENDORCATEGORY);
											foreach ($ArrVendorCategory as $VarKey => $VarStatus) { ?>
												<option
													value="<?php echo $VarKey ?>" <?php if (@$ArrBasicInfo['wrk_categoryid'] == $VarKey) {
													echo "selected";
												} ?>><?php echo $VarStatus ?></option>
											<?php } ?>
										</select>
										<div class="herr" id="Errwrk_categoryid"></div>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
										<label for="id-form-field-focus-1" class="col-sm-4 control-label">
										Primary Job Work Line <span class="mandatory">*</span>
										</label>
									<div class="col-sm-8">
										<input type="text" class="form-control"  id="primaryjob_wrkline" value="<?php echo @$ArrBasicInfo['primaryjob_wrkline']; ?>" placeholder="Free Text">
									<div class="herr" id="Errprimary_jobline"></div>
									</div>
								</div>
							</div>
                    </div>
                    <div class="col-md-6">
							<div class="col-md-12">
								<div class="form-group">
										...
										Secondary Job Work Line 
										</label>
									<div class="col-sm-8">
										<input type="text" class="form-control"  id="secondaryjob_wrkline" value="<?php echo @$ArrBasicInfo['secondaryjob_wrkline']; ?>" placeholder="Free Text">
									</div>
								</div>
							</div>
								<div class="col-md-12">
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>membelljobwrk.js"></script>
