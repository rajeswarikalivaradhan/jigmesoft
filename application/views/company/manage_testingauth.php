...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Fabric / Garment Lab Testing Authority List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>mtestauth/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Testing Authority Name</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="text" name="frmSrchvendorname" class="form-control" id="frmSrchvendorname" placeholder="Free Text">
											...
											<td>
                                                <select name="frmSrchvendor_category" id="frmSrchvendor_category" class="form-control">
                                                <option value="">Select</option>
											...
											<td>
                                               <input type="text" name="frmSrch_primarypdtline" class="form-control" id="frmSrch_primarypdtline" placeholder="Free Text">
                                            </td>
											<td>
                    ...
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="tableId" class="table table-bordered table-hover" data-page-length="50" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                ...
                                <tr>
                                    <th  class="no-sort"></th>
                                    <th id="0">Testing Authority Name</th> 
