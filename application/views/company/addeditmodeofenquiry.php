...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Mode of Enquiry Details':'View / Edit Mode of Enquiry Details' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'mastersetup/managemodeofenquiry') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    <?php 
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicModeofEnq" value="<?php echo @$ArrRes['modeofenquiry']; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrfrmBasicModeofEnq"></div>
                                </div>
                            </div>
                        </div>
						<div class="col-md-6">
