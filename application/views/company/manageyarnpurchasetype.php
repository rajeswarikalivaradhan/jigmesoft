...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Yarn Purchase Type<a class="btn btn-default addBtnDetails" href="<?php echo base_url().CNFCOMPANY?>myarn/addedityarnpurchasetype"><i class="fa fa-plus" style="margin-right: 10px"></i> ADD Yarn Purchase Type</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Yarn Purchase Type</li>
                <li class="active">Yarn Purchase Type List(s)</li>
            </ol>
        </section>
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-control" id="frmSrchYarnPurchaseType" placeholder="Yarn Purchase Type">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Yarn Purchase Type List</h3>
                        </div>
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="mYarnPurchaseTypeList" class="table table-bordered table-hover"><thead><tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Yarn Purchase Type<i class="fa fa-fw fa-sort"></i></th>
