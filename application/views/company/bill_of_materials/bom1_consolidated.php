                            ...
                            <div class="box-body" style="padding: 0">
                                <form class="form-horizontal" name="frmBasicInfo" id="frmOrderProcess" method="post">
                                    ...
                                    <div class="col-sm-12" style="padding: 5px !important">
                                        <strong>BOM CONSOLIDATED: Article - 1</strong>
                                    <!--<div id="bomconslidatedtwelfthtbl"></div>-->
                                        <div id="bom1_consolidated"></div>
                                    </div>
...
<script type="text/javascript">
    ...
    MakeAsynPostRequest(base_path+'billofmaterials/consolidated_1',GlbParam+"&enqId="+enquiryid,'json',function (data) {
    ...
    function fnSaveTable() {
        let data = $("#bom1_consolidated").jexcel('getData');
