                            ...
                            <div class="box-body" style="padding: 0">
                                <form class="form-horizontal" name="frmBasicInfo" id="frmOrderProcess" method="post">
                                    ...
                                    <div class="col-sm-12" style="padding: 5px !important">
                                        <strong>BOM SOURCING DETAILS: Article - 2</strong>
                                        <div id="bomSourcingDetailArticle2"></div>
                                    </div>
...
<script>
    ...
    MakeAsynPostRequest(base_path + 'billofmaterials/sourcingDetailsArticle_2', GlbParam + "&enqId=" + enquiryId, 'json', function (data) {
        ...
        console.log(data.bomSourcingDetailArticle2,'data.bomSourcingDetailArticle2');
        if(data.bomSourcingDetailArticle2 != '') {
            GlbBomSourcingDetailArticle2 = JSON.parse(data.bomSourcingDetailArticle2);
            console.log(GlbBomSourcingDetailArticle2,'GlbBomSourcingDetailArticle1');
        }
        else if(data.ArrBomConsolidated != '') {
            GlbBomSourcingDetailArticle2 = [data.ArrBomConsolidated];
            console.log(GlbBomSourcingDetailArticle2,'GlbBomSourcingDetailArticle2');
        }
        else {
            GlbBomSourcingDetailArticle2 = [[]];
        }
        console.log(GlbBomVendor,'GlbBomVendor');
        console.log(GlbBomVendorGst,'GlbBomVendorGst');
        jexcel(document.getElementById("bomSourcingDetailArticle2"), {
            ...
            data: GlbBomSourcingDetailArticle2,
            onchange: function () {
                unsaved = true;
            },
    ...
    function fnSaveTable() {
        let bomSourcingData = $("#bomSourcingDetailArticle2").jexcel('getData');
