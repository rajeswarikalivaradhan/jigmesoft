                            ...
                            <div class="box-body" style="padding: 0">
                                <form class="form-horizontal" name="frmBasicInfo" id="frmOrderProcess" method="post">
                                    ...
                                    <div class="col-sm-12" style="padding: 5px !important">
                                        <strong>BOM SAMPLING & APPROVAL DETAILS: Article - 1</strong>
                                        <div id="bomSamplingAndApprovalDetailsArticle1"></div>
                                    </div>
...
<script type="text/javascript">
    ...
    MakePostRequest(base_path + 'billofmaterials/samplingAndApprovalDetails_1', GlbParam + "&enqId=" + enquiryId, 'json', fnRes);
    ...
    function fnRes(data) {
        ...
        jexcel(document.getElementById("bomSamplingAndApprovalDetailsArticle1"), {
    ...
    function fnSaveTable() {
        let d = $("#bomSamplingAndApprovalDetailsArticle1").jexcel('getData');
        let remarks = $("#frmBasicRemarks").val();
        MakeAsynPostRequest(base_path + 'billofmaterials/saveSamplingAndApprovalDetails', GlbParam+
            "&d=" + JSON.stringify(d) +"&enqId=" +enquiryId + "&aid=1&e="+encodeURIComponent(remarks), 'json', fnSaveTableRes);
    }
