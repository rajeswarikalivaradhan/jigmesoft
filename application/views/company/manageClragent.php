            ...
            <section class="content-header">
                <h1 class="firstHeading">
                    ...
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url() . CNFCOMPANY ?>mlogistics/addEditClragent">
                            ...
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Clearing Agent</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="frmSrchCAgent"
                                                   name="frmSrchCAgent"
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="mTableId" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Clearing Agent<i class="fa fa-fw fa-sort"></i>
                                    </th>
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mClragent.js"></script>
