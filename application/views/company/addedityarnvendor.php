        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Yarn Vendor <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                        ...
                                        if ($Edit == 'edit' || empty($VarId)) {
                                            ...
                                            <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="" class="col-sm-4 control-label">Yarn Vendor</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="frmBasicYarnVendor" class="form-control" id="frmBasicYarnVendor" placeholder="Yarn Vendor"
                                                               value="<?php echo @$ArrBasicInfo['yarnvendor']; ?>">
                                                        <div class="herr" id="ErrfrmBasicYarnVendor"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="frmBasicStatus" class="col-sm-2 control-label">Status</label>
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="" class="col-sm-4 text-right">Yarn Vendor</label>
                                                    <div class="col-sm-8" id="divDispBasicName">
                                                        <?php echo @$ArrBasicInfo['yarnvendor'];?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'myarnvendor/manage') ?>" class="btn btn-default">Back</a>
                                <button type="submit" class="btn btn-info pull-right <?php if ($Edit != 'edit' && !empty($VarId)) echo 'hide' ?>"
                                        onclick="return fnSaveYarnVendor();">Save Changes</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>myarnvendor.js"></script>
