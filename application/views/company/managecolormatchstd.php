        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Colour Matching Standard
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url() . CNFCOMPANY ?>mcolormatchstd/addedit">
                ...
                <div class="col-md-12">
                        ...
                        <form class="form-horizontal" name="frmNameSearchFabricType" id="frmNameSearchFabricType">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Colour Matching
                                            Standard</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-control" id="frmSrchCms"
                                                   placeholder="Colour Matching Standard">
                                            <div id="ErrfrmSrchCms" class="herr"></div>
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                ...
                                <button type="button" class="btn btn-info pull-right"
                                        onclick="fnSearchColormatchstd();">Search
                                </button>
                            </div>
                        </form>
                    </div>
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="mColormatchstdTbl" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Colour Matching Standard<i
