...
<div class="wrapper">
    ...
    <div class="content-wrapper" style="background-color: #bffff9">
        <section class="content-header">
            <h1>
               CAD Requirement LIST <a class="btn btn-default addBtnDetails" href="<?php echo base_url().CNFCOMPANY?>mcadrequirement/addeditcadrequirement"><i class="fa fa-plus" style="margin-right: 10px"></i> ADD CAD REQUIREMENT</a>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box" style="border-top-color: #4747d1">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="mCadRequirementList" class="table table-bordered table-hover"><thead><tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">CAD Requirement<i class="fa fa-fw fa-sort"></i></th>
