...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New BOM (Art-1) - Material':'View / Edit BOM (Art-1) - Material' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'bom1/Bommaterial/manage') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    <?php 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                    ...
                                    BOM (Art-1) - Material <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicBlend" value="<?php if (!empty($BasicInfo->description)) echo $BasicInfo->description; ?>" placeholder="Free Text">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="frmBasicStatus" id="frmBasicStatus"
                                                        ...
                                                        foreach ($ArrStatus as $VarKey => $VarStatus) { ?>
                                                            <option
                                                                value="<?php echo $VarKey ?>" <?php if (@$BasicInfo->status == $VarKey) {
                                                                echo "selected";
        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo 'Add / Edit -' ?>
                    BOM Material
                </h1>
            </section>
        </div>
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                ...
                                <div class="box-body pdt20_pdb0">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="frmBasicBlend" class="col-sm-4 control-label">Material</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicBlend" class="form-control"
                                                           id="frmBasicBlend" placeholder="Material"
                                                           value="<?php if (!empty($BasicInfo->description)) echo $BasicInfo->description; ?>">
                                                    <div class="herr" id="ErrfrmBasicBlend"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 control-label">Item Description</label>
                                                <?php if (!empty($BasicInfo->description)) echo $BasicInfo->description; ?>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'bom1/Bommaterial/manage') ?>"
...
<script src="<?php echo base_url() ?>assets/js/<?php echo CNFCOMPANY ?>bom1/material.js"></script>
