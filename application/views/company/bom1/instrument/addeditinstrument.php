    ...
    <aside class="main-sidebar hide">
     ...
     <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New BOM (Art-1) - Item Description':'View / Edit BOM (Art-1) - Item Description' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'bom1/Bominstrumenttype/manage') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    <?php 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                    ...
                                    BOM (Art-1) - Item Description <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-7">
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                ...
                                <div class="box-body pdt20_pdb0">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="frmBasicBlend" class="col-sm-4 control-label">Item Description</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicBlend" class="form-control"
                                                           id="frmBasicBlend" placeholder="item"
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'bom1/Bominstrumenttype/manage') ?>"
...
<script src="<?php echo base_url() ?>assets/js/<?php echo CNFCOMPANY ?>bom1/instrumenttype.js"></script>
