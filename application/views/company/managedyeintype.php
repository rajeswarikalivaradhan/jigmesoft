...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Dyeing Type
                <a class="btn btn-default addBtnDetails" href="<?php echo base_url().CNFCOMPANY?>mdyeintype/addeditdyeintype"><i class="fa fa-plus" style="margin-right: 10px"></i> ADD DYEING Type</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Dyeing Type</li>
                <li class="active">Dyeing Type List(s)</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchDyeingType" id="frmNameSearchDyeingType">
                            <div class="box-body">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchDyeingName" class="form-control" id="frmSrchDyeingName" placeholder="Type Name">
                                            <input type="hidden" name="hiddenColid" id="hiddenColid">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default"
                                        onclick="refreshPage('frmNameSearchDyeingType');">Reset
                                </button>
                                <button type="button" class="btn btn-info pull-right" onclick="fnSearchDyeingType();">Search</button>
                            </div>
                        </form>
                    </div>
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Dyeing Type List</h3>
                        </div>
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="dyeingTypeTblList" class="table table-bordered table-hover">
                                <thead><tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Type Name<i class="fa fa-fw fa-sort"></i></th>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>mdyeingtype.js"></script>
