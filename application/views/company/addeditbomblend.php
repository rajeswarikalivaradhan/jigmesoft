    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">BOM Blend
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'mbomblend/manage') ?>"
...
<script src="<?php echo base_url() ?>assets/js/<?php echo CNFCOMPANY ?>mbomblend.js"></script>
