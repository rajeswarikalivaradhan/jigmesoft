...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Lab Testing Authority Details':'View / Edit Lab Testing Authority Details' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'mtestauth/manage') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    <?php 
                ...
                <div class="row no-rad-form add-form-mar" id="custom_form">
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-4 control-label">
                                     Testing Authority Name   <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="vendor_name" value="<?php echo @$ArrBasicInfo['vendor_name']; ?>" placeholder="Free Text">
                                    <div class="herr" id="Errvendor_name"></div>
                                </div>
                            </div>
                        </div>
						<div class="col-md-12">
                        ...
                        <div class="col-md-12">
								<div class="form-group">
										<label for="id-form-field-focus-1" class="col-sm-4 control-label">
										Lab Category <span class="mandatory">*</span>
										</label>
									<div class="col-sm-8">
									    <select name="vendor_categoryid" id="vendor_categoryid" class="form-control">
											<option value="">Select</option>
											<?php  $ArrVendorCategory = unserialize(ARRVENDORCATEGORY);
											foreach ($ArrVendorCategory as $VarKey => $VarStatus) { ?>
												<option
													value="<?php echo $VarKey ?>" <?php if (@$ArrBasicInfo['vendor_categoryid'] == $VarKey) {
													echo "selected";
												} ?>><?php echo $VarStatus ?></option>
											<?php } ?>
										</select>
										<div class="herr" id="Errvendor_categoryid"></div>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
										<label for="id-form-field-focus-1" class="col-sm-4 control-label">
										Primary Service Line <span class="mandatory">*</span>
										</label>
									<div class="col-sm-8">
										<input type="text" class="form-control"  id="primary_pdtline" value="<?php echo @$ArrBasicInfo['primary_pdtline']; ?>" placeholder="Free Text">
									<div class="herr" id="Errprimary_pdtline"></div>
									</div>
								</div>
							</div>
                    </div>
                    <div class="col-md-6">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control"  id="secondary_pdtline" value="<?php echo @$ArrBasicInfo['secondary_pdtline']; ?>" placeholder="Free Text">
									</div>
								</div>
							</div>
								<div class="col-md-12">
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>Mtestingauthority.js"></script>
