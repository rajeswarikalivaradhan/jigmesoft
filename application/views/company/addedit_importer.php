...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Importer Details':'View / Edit Importer Details' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'Magent/importer') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    <?php 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                   ...
                                   Importer Name  <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                    ...
                    <div class="col-md-6">
							...
							<div class="col-md-12">
								<div class="form-group">
										...
										Importer Category  <span class="mandatory">*</span>
										</label>
									<div class="col-sm-8">
