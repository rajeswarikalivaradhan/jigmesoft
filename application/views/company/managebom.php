...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Bill of Material</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>mbom/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Item Description</th>
										<th class="theadstyle">Blend (%)</th>
										<th class="theadstyle">Content</th>
										<th class="theadstyle">Material</th>
										<th class="theadstyle">Special Request</th>
										<th class="theadstyle">Article Type</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10%">
                                                <input type="text" name="frmSrchBomName" class="form-control" id="frmSrchBomName" placeholder="Free Text">
                                                <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                            </td>
											<td width="10%">
                                                <input type="text" name="frmSrchBomBlend" class="form-control" id="frmSrchBomBlend" placeholder="Free Text">
                                            </td>
											<td width="10%">
                                                <input type="text" name="frmSrchBomContent" class="form-control" id="frmSrchBomContent" placeholder="Free Text">
                                            </td>
											<td width="10%">
                                                <input type="text" name="frmSrchBomMaterial" class="form-control" id="frmSrchBomMaterial" placeholder="Free Text">
                                            </td>
											<td width="10%">
                                                <input type="text" name="frmSrchBomSplReq" class="form-control" id="frmSrchBomSplReq" placeholder="Free Text">
                                            </td>
											<td width="10%">
                                                <select id="frmSrchBomArtType" class="form-control">
													<option value="">Select</option>
                    ...
                    <div class="col-sm-12 " style="padding:13px 0">
                        <div class="btn-toolbar pull-right py-0" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group mr-2 px-4 text-right" role="group" aria-label="First group">
                                <button class="btn btn-sm btn-royal-blue" id="searchButton"  onclick="fnSearchBom();">
                    ...
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="tableId" class="table table-bordered table-hover" data-page-length="50" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                ...
                                <tr>
                                    <th  class="no-sort"></th>
                                    <th id="0">Item Description</th>
									<th id="1">Blend (%)</th>
									<th id="2">Content</th>
									<th id="3">Material</th>
									<th id="4">Special Request</th>
									<th id="5">Article Type</th>
									<th id="6">Updated By</th>
