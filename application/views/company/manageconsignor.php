        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Consignor<a class="btn btn-default addBtnDetails"
                                              href="<?php echo base_url() . CNFCOMPANY ?>mconsignor/addedit">
                ...
                <div class="col-md-12">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Consignor
                                            name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchConsignorName" class="form-control"
                                                   id="frmSrchConsignorName" placeholder="Consignor name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="mconsignorList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="1">Consignor Name<i class="fa fa-fw fa-sort"></i>
                                    </th>
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mconsignor.js"></script>
