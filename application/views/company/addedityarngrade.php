...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add/Edit Yarn Grade</h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url().CNFCOMPANY?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="<?php echo base_url().CNFCOMPANY?>myarn/manageyarngrade/">Yarn Grade List</a></li>
                <li class="active">Add/Edit Yarn Grade</li>
            </ol>
        </section>
                                    ...
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="" class="form-control" id="frmBasicYarnGrade" placeholder="Yarn Grade" value="<?php echo @$ArrBasicInfo['yarngrade'];?>">
                                                    <div class="herr" id="ErrfrmBasicYarnGrade"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveYarnGrade();">Save Changes</button>
                                        </div>
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNew==1) {?>hide<?php }?>">
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 text-right">Yarn Grade</label>
                                                <div class="col-sm-10" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['yarngrade'];?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
