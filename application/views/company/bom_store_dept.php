                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Purchase Indent List" <?php if(count($ArrRoleInfo)>0 && in_array('Purchase Indent List',$ArrRoleInfo)) { echo 'checked';}?> >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Supply Closure List" <?php if(count($ArrRoleInfo)>0 && in_array('Supply Closure List',$ArrRoleInfo)) { echo 'checked';}?> >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="M.I. List" <?php if(count($ArrRoleInfo)>0 && in_array('M.I. List',$ArrRoleInfo)) { echo 'checked';}?> >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Order Stock List" <?php if(count($ArrRoleInfo)>0 && in_array('Order Stock List',$ArrRoleInfo)) { echo 'checked';}?> >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Order Closure List" <?php if(count($ArrRoleInfo)>0 && in_array('Order Closure List',$ArrRoleInfo)) { echo 'checked';}?> >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Surplus Stock List" <?php if(count($ArrRoleInfo)>0 && in_array('Surplus Stock List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Stock Transfer Memo List" <?php if(count($ArrRoleInfo)>0 && in_array('Stock Transfer Memo List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                    </div>
