    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add/Edit Dyeing Type</li>
            </ol>
        </section>
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    <div id="divEditBasicInfo" class="<?php if($VarNew==1) {?>show<?php } else {?>hide<?php }?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="frmBasicTypeName" class="form-control" id="frmBasicTypeName" placeholder="Type Name" value="<?php echo @$ArrBasicInfo['dyeingname'];?>">
                                                <div class="herr" id="ErrBasicTypeName"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="box-footer nopadding">
                                            ...
                                            <button type="submit" class="btn btn-info pull-right  addrights" onclick="return fnSaveDyeingTypeInfo();">Save Changes</button>
                                        </div>
                                    </div>
                                    <div id="divShowBasicInfo" class="<?php if($VarNew==1) {?>hide<?php }?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" id="divDispBasicName">
                                                <?php echo @$ArrBasicInfo['dyeingname'];?>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script language="javascript">
    var GlbArrProfileContList   = ["DivContBasicInfo","DivContPwdInfo","DivContUsernameInfo"];
    var GlbNewUser		        = "<?php echo @$VarNew;?>";
    var GlbId          	        = "<?php echo @$VarId;?>";
</script>
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>mdyeingtype.js?r=<?php echo CNFJSCSSRANDNO?>"></script>
