    ...
    <div class="content-wrapper">
        <section class="content">
			<section class="invoice form-horizontal">
                <div class="row"> 
					<div class="col-xs-12">
						<h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Embellishment Type':'View / Edit Embellishment Type' ?>
						  <div class="pull-right">
											<div class="ml-auto pr-3">
											<a href="<?php echo base_url(CNFCOMPANY . 'membellishment/manageType') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
											<?php 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-4 control-label">
                                     Embellishment Type <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicEmbellType" value="<?php echo @$ArrBasicInfo['embellname']; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrfrmBasicEmbellType"></div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="content-wrapper hide">
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">Embellishment Type
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-4 control-label">Embellishment Type</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicEmbellType" class="form-control" id="frmBasicEmbellType"
                                                           placeholder="Embellishment Type"
                                                           value="<?php echo @$ArrBasicInfo['embellname']; ?>">
                                                    <div class="herr" id="ErrfrmBasicEmbellType"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-4 text-right">Embellishment Type</label>
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['embellname']; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'membellishment/manageType') ?>"
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>membelltype.js"></script>
