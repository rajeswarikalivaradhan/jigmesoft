    ...
    <div class="content-wrapper">
        <section class="content">
			<section class="invoice form-horizontal">
                <div class="row"> 
					<div class="col-xs-12">
						<h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Garment Process Flow':'View / Edit Garment Process Flow' ?>
						  <div class="pull-right">
											<div class="ml-auto pr-3">
											<a href="<?php echo base_url(CNFCOMPANY . 'mprocessflow/manageprocessflow') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
											<?php 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                    ...
                                    Garment Process Flow <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicProcessFlowName" value="<?php echo @$ArrBasicInfo['processflowname']; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrBasicProcessFlowName"></div>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div class="row">
					...
					<button class="btn btn-info pull-right mx-2" id="enqsvbtn" onclick="return fnSaveProcessFlowInfo();">Save</button>
					</div>
				</div>
			</section>     
		</section>
    ...
    <div class="content-wrapper hide">
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">Process
                    Flow <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
        <section class="content">
            <div class="row">
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 control-label">Process Flow</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicProcessFlowName"
                                                           class="form-control"
                                                           id="frmBasicProcessFlowName" placeholder="Process Flow"
                                                           value="<?php echo @$ArrBasicInfo['processflowname']; ?>">
                                                    <div class="herr" id="ErrBasicProcessFlowName"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 text-right">Process Flow</label>
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['processflowname']; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'mprocessflow/manageprocessflow') ?>"
                                   class="btn btn-default">Back</a>
                                <button type="submit" class="btn btn-info pull-right"
                                        onclick="return fnSaveProcessFlowInfo();">Save Changes
                                </button>
                            </div>
                        </div>
                    </div>
...
<script
    src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mprocessflow.js?r=<?php echo CNFJSCSSRANDNO ?>"></script>
