    ...
    <div class="content-wrapper">
        <section class="content">
			<section class="invoice form-horizontal">
                <div class="row"> 
					<div class="col-xs-12">
						<h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Packing Code':'View / Edit Packing Code' ?>
						  <div class="pull-right">
											<div class="ml-auto pr-3">
											<a href="<?php echo base_url(CNFCOMPANY . 'mpackingcode/managepackingcode') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
											<?php 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                    ...
                                    Packing Code <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicPackingCode" value="<?php echo @$ArrBasicInfo['packingname']; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrBasicPackingCode"></div>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div class="row">
					...
					<button class="btn btn-info pull-right mx-2" id="enqsvbtn" onclick="return fnSavePackingCodeInfo();">Save</button>
					</div>
				</div>
			</section>     
		</section>
        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">Packing
                    Code <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
        <section class="content">
            <div class="row">
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicPackingCode" class="form-control"
                                                           id="frmBasicPackingCode" placeholder="Packing Code"
                                                           value="<?php echo @$ArrBasicInfo['packingname']; ?>">
                                                    <div class="herr" id="ErrBasicPackingCode"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 text-right">Packing Code</label>
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['packingname']; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'mpackingcode/managepackingcode') ?>"
                                   class="btn btn-default">Back</a>
                                <button type="submit" class="btn btn-info pull-right "
                                        onclick="return fnSavePackingCodeInfo();">Save Changes
                                </button>
                            </div>
                        </div>
                    </div>
...
<script
    src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mpackingcode.js?r=<?php echo CNFJSCSSRANDNO ?>"></script>
