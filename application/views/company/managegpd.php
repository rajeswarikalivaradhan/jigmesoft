...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Garment Parts List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>mgpd/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Garment Parts</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10%">
                                                <input type="text" name="frmSrchGPDName" class="form-control" id="frmSrchGPDName" placeholder="Free Text">
                                                <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                            </td>
											<td width="10%">
                                                <select name="frmSrchGPDStatus" id="frmSrchGPDStatus" class="form-control">
                                                <option value="">Select</option>
                    ...
                    <div class="col-sm-12 " style="padding:13px 0">
                        <div class="btn-toolbar pull-right py-0" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group mr-2 px-4 text-right" role="group" aria-label="First group">
                                <button class="btn btn-sm btn-royal-blue" id="searchButton"  onclick="fnSearchGPD();">
        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Garment Parts
                    <a class="btn btn-default addBtnDetails" href="<?php echo base_url() . CNFCOMPANY ?>mgpd/addedit">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchGPDType" id="frmNameSearchGPDType">
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Garment Part</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchGPDName" class="form-control"
                                                   id="frmSrchGPDName" placeholder="Garment Part">
                                            <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default"
                                        onclick="refreshPage('frmNameSearchGPDType');">Reset
                                </button>
                                <button type="button" class="btn btn-info pull-right" onclick="fnSearchGPD();">Search
                                </button>
                            </div>
                        </form>
                    </div>
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="tableList" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Garment Part<i class="fa fa-fw fa-sort"></i></th>
...
<script
src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mgpd.js?r=<?php echo CNFJSCSSRANDNO ?>"></script>
