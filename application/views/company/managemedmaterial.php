...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Embellishment Medium / Material List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>membellishment/addeditmediummaterial">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Embellishment Medium / Material</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10%">
                                                <input type="text" name="frmSrchMm" class="form-control" id="frmSrchMm" placeholder="Free Text">
                    ...
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="tableId" class="table table-bordered table-hover" data-page-length="50" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                ...
                                <tr>
                                    <th  class="no-sort"></th>
                                    <th id="0">Embellishment Medium / Material</th>
                                    <th id="1">Status</th>
            ...
            <div class="col-md-12">
                <h1 class="firstHeading">
                    ...
                    <a class="btn btn-default addBtnDetails"
                       href="<?php echo base_url() . CNFCOMPANY ?>membellishment/addeditmediummaterial">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" name="frmNameSearchEmbellType" id="frmNameSearchEmbellType">
                            <div class="box-body pdt20_pdb0">
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="frmSrchMm" class="col-sm-4 control-label">Medium / Material</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="frmSrchMm" class="form-control"
                                                   id="frmSrchMm" placeholder="Medium / Material">
                                            <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="frmSrchStatus" id="frmSrchStatus"
                                                    class="form-control">
                                                <option value="">Select</option>
                                                <?php
                                                foreach ($ArrStatus as $VarKey => $VarStatus) { ?>
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <button type="button" class="btn btn-default"
                                        onclick="refreshPage();">Reset
                                </button>
                                <button type="button" class="btn btn-info pull-right" onclick="fnSearch();">
                                    Search
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="tableId" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="0">Medium / Material<i class="fa fa-fw fa-sort"></i></th>
