    ...
    <div class="content-wrapper" style="background-color: #bffff9">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">CAD REQUEST LIST</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info" style="border-top-color: #4747d1">
                        ...
                        <form class="form-horizontal" name="frmNameSearchCadReq" id="frmNameSearchCadReq">
                            <div class="box-body">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <?php
                                            $ArrCStatus = unserialize(ORDERENQUIRYSTATUS); unset($ArrCStatus[1]); unset($ArrCStatus[4]);
                                            ?>
                            ...
                            <div class="box-footer">
                                ...
                                <button type="button" class="btn btn-info pull-right" style="color: #000000" onclick="fnSearchCadIndent();">Search</button>
                            </div>
                        </form>
                    </div>
                    <div class="box" style="border-top-color: #4747d1">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="mCadIndentList" class="table table-bordered table-hover"><thead><tr>
                                    <th></th>
                                    ...
                                    <th class="sortable asc" id="3">CAD Ref. No.<i class="fa fa-fw fa-sort"></i></th>
...
<script src="<?php echo base_url();?>assets/js/<?php echo CNFCOMPANY?>manageindent.js"></script>
