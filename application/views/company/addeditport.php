    ...
    <div class="content-wrapper">
        <section class="content">
			<section class="invoice form-horizontal">
                <div class="row"> 
					<div class="col-xs-12">
						<h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Port':'View / Edit Port' ?>
						  <div class="pull-right">
											<div class="ml-auto pr-3">
											<a href="<?php echo base_url(CNFCOMPANY . 'mport/manageport') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
											<?php 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                    ...
                                    Port Name <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicPortName" value="<?php echo @$ArrBasicInfo['portname']; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrBasicPortName"></div>
                                </div>
                            </div>
                        </div>
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select name="frmBasicPortCountry" id="frmBasicPortCountry" class="form-control">
										<option value="">Select</option>
										<?php  foreach ($ArrCountryList as $VarCountryId => $VarCountryName) { ?>
											<option value="<?php echo $VarCountryId ?>" 
											<?php echo (@$ArrBasicInfo['portcountry'] == $VarCountryId) ? 'selected' : '' ?>><?php echo $VarCountryName ?>
											</option>
										<?php } ?>
									</select>
									<div class="herr" id="ErrBasicPortCountry"></div>
								</div>
							</div>
						</div>
                    </div>
                    <div class="col-md-6">
						<div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="frmBasicPortCity" value="<?php echo @$ArrBasicInfo['portcity']; ?>" placeholder="Free Text">
                                    <div class="herr" id="ErrfrmBasicPortCity"></div>
                                </div>
                            </div>
                        </div>
						<div class="col-md-12">
				...
				<div class="row">
					...
					<button class="btn btn-info pull-right mx-2" id="enqsvbtn" onclick="return fnSavePortInfo();">Save</button>
					</div>
				</div>
			</section>     
		</section>
        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    Port <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
        <section class="content">
            <div class="row">
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 control-label">Port Name</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicPortName" class="form-control"
                                                           id="frmBasicPortName" placeholder="Port Name"
                                                           value="<?php echo @$ArrBasicInfo['portname']; ?>">
                                                    <div class="herr" id="ErrBasicPortName"></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicPortCity" class="form-control"
                                                           id="frmBasicPortCity" placeholder="Port City"
                                                           value="<?php echo @$ArrBasicInfo['portcity']; ?>">
                                                    <div class="herr" id="ErrfrmBasicPortCity"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="frmBasicPortCountry" id="frmBasicPortCountry"
                                                            class="form-control">
                                                        <option value="">Choose the Country</option>
                                                        <?php
                                                        foreach ($ArrCountryList as $VarCountryId => $VarCountryName) { ?>
                                                            <option
                                                                value="<?php echo $VarCountryId ?>" <?php echo (@$ArrBasicInfo['portcountry'] == $VarCountryId) ? 'selected' : '' ?>>
                                                                <?php echo $VarCountryName ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                    <div class="herr" id="ErrBasicPortCountry"></div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 text-right">Port</label>
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['portname']; ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 text-right">Country</label>
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['countryname']; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8" id="divDispBasicName">
                                                    <?php echo @$ArrBasicInfo['portcity']; ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'mport/manageport') ?>"
                                   class="btn btn-default">Back</a>
                                <button type="submit"
                                        class="btn btn-info pull-right <?php if ($Edit != 'edit' && !empty($VarId)) echo 'hide' ?>"
                                        onclick="return fnSavePortInfo();">Save Changes
                                </button>
                            </div>
                        </div>
                    </div>
...
<script
    src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>mport.js?r=<?php echo CNFJSCSSRANDNO ?>"></script>
