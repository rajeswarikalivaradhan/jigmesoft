...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">User List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>muser/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Department11</th>
                                        <th class="theadstyle">User Name</th>
										<th class="theadstyle">Designation</th>
										<th class="theadstyle">Log-in ID</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <!--<input type="text" name="frmSrchDept" class="form-control" id="frmSrchDept" placeholder="Free Text">-->
                                                <select name="frmSrchDept" id="frmSrchDept" class="form-control">
                                                <option value="">Select</option>
                                                <?php  $ArrUserTypes = unserialize(ARRUSERTYPE);
                                                foreach($ArrUserTypes as $VarKey=>$VarStatus) {?>
											...
											<td>
                                                <input type="text" name="frmSrchUserName" class="form-control" id="frmSrchUserName" placeholder="Free Text">
                                            </td>
											<td>
                                                <input type="text" name="frmSrchDesignation" class="form-control" id="frmSrchDesignation" placeholder="Free Text">
                                            </td>
                                            <td>
                                                <input type="text" name="frmSrchLoginid" class="form-control" id="frmSrchLoginid" placeholder="Free Text">
                                            </td>
                                            <td>
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFCOMPANY ?>muser.js"></script>
