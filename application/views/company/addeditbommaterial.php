        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">
                    BOM Material <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
                            ...
                            <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                ...
                                <div class="box-body pdt20_pdb0">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="frmBasicYarn"
                                                       class="col-sm-4 control-label">BOM Material</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicYarn" class="form-control"
                                                           id="frmBasicYarn" placeholder="BOM Material"
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="col-sm-4 control-label">BOM Material</label>
                                                <div class="col-sm-8">
                                ...
                                <div class="box-footer boxFooter_pd1025">
                                    <a href="<?php echo base_url(CNFCOMPANY . 'mbommaterial/manage'); ?>"
...
<script src="<?php echo base_url() ?>assets/js/<?php echo CNFCOMPANY ?>mbommaterial.js"></script>
