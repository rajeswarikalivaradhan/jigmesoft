                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            ...
                            <table id="workInProgressTbl" class="table table-bordered table-hover" data-page-length="50" style="padding: 0px 2px;border-bottom: 1px solid rgb(2, 43, 97) !important;">
                                <thead>
                                <tr>
                                    <!-- <th style=""></th>
