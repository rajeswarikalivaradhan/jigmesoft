                ...
                <div class="col-md-12">
                    <div class="box" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <table id="merchantQueueList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
...
<script>
    ...
    $(document).ready(function () {
        dataTbl = $('#merchantQueueList').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('merchant/queueList') ?>",
                "type": "POST",
                "data": {"rFrom": 1}
            },
            'columnDefs': [ {
            ...
            if (checkBoxLength >= 1) {
                ...
                if(confirm('Do you want to '+StatusText+' this records?')) {
                    MakeAsynPostRequest(base_path+'dashboard/changeAllListActiveStatus','id='+idJson+'&cs='+dropdownOpt+
                        ...
                        dataTbl.ajax.url("<?php echo base_url('merchant/queueList') ?>").load();
