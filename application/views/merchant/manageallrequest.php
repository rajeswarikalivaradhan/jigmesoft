...
<div class="wrapper bgn-white">
    ...
    <div class="content-wrapper" style="background-color: white;">
        <div class="col-sm-12" style="display: block ruby; padding: 10px 25px;padding-top: 100px;">
            <span class="header-title bgn-white"><b style="font-size: 20px !important; font-family: Arial">REQUEST SENT LIST</b></span>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="MerAllReqSentList" class="table table-bordered table-hover"><thead><tr>
                                    <th></th>
                                    <th class="" id="0">WIP Ref. No.</th>
                                    <th class="" id="1">Brand</th>
                                    <th class="" id="3">Request</th>
                                    ...
                                    <!--<th class="" id="8">Management Status</th>
                                    <th class="" id="8">Cad Status</th>-->
...
<script>
    ...
    $(document).ready(function() {
        dataTbl = $('#MerAllReqSentList').DataTable({
            "processing": true,
            "searching": false,
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('merchant/manageAllRequest')?>",
                "type": "POST",
                "data":{"rFrom":1}
            },
            "order": [11,"desc"],
            ...
            if (checkBoxLength >= 1) {
                ...
                if (confirm('Do you want to ' + StatusText + ' this records?')) {
                    MakeAsynPostRequest(base_path + 'dashboard/changeAllListActiveStatus', 'id=' + idJson + '&cs=' + dropdownOpt +
                        ...
                        dataTbl.ajax.url("<?php echo base_url('merchant/manageAllRequest') ?>").load();
