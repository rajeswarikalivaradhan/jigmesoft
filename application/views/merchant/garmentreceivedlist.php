...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">SAMPLE RECEIVED LIST</b></span>
            <div class="btn-toolbar pull-right " style="padding-top: 4px" role="toolbar" aria-label="Toolbar with button groups">
                ...
                <div class="btn-group px-3" role="group" aria-label="Third group">
                  ...
                  <div class="btn-group mr-2v text-right" role="group" aria-label="Second group" style="padding-left: 5px;padding-right: 5px" >
                    <button name="btnChangeStatus" id="btnChangeStatus1" class="btn btn-sm btn-royal-blue">
                        Update  
                    </button>
                    </div>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">G.D.C. Date & Time</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >Sample Ref. No.</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="gdc_ref_no"  id="gdc_ref_no" placeholder="Free Text">
                                            </td>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="samp_ref_no"  id="samp_ref_no" placeholder="Free Text">
                                            </td>
                        ...
                        <div class="box-body no-padding">
                            <table id="sampleQueueListTbl" class="table table-bordered table-hover" data-page-length="50">
                                ...
                                <tr>
                                    ...
                                    <th class="" id="8">G.D.C. No.</th>
                                    <th class="" id="8">G.D.C. Date & Time</th>
                                    <th class="" id="8">Sample Ref. No.</th>
                                    <th>Material <br /> Issued To</th>
                                    <th class="" id="9">Material<br />Received Status</th>
...
<script src="<?php echo base_url();?>assets/custom/request/sample/garmentreceivedlist.js"></script>
