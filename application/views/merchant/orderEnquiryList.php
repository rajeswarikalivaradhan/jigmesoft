...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Enquiry List</b></span>
            <?php 
           // var draftstatus=<?php echo ($checkDraftorNot>0)?1:2
         
            if(isset($checkDraftorNot) && !empty($checkDraftorNot>0))
             {  //echo base64_encode($checkDraftorNot->id); ?>
