...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">CAD MATERIAL INDENT LIST</b></span>
                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <table id="mCadQueueList" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                <tr>
                                    <!-- <th></th>
...
<script src="<?php echo base_url();?>assets/custom/mi/cad.js"></script>
