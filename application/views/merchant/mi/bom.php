...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM (A1) MATERIAL INDENT LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="miref_no"  id="miref_no" placeholder="Free Text">
                                            </td>
                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <!-- <table id="merchantSampleQueueTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                <tr>
                                    <th></th>
...
<script src="<?php echo base_url();?>assets/custom/mi/bom.js"></script>
