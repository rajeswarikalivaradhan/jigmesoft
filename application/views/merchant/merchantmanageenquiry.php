...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>MERCHANT DEPT. - ENQUIRY<a class="btn btn-default addBtnDetails" href="<?php echo base_url()?>merchant/addenquiry"><i class="fa fa-plus" style="margin-right: 10px"></i> ADD ENQUIRY</a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url('merchant') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                <li>Merchant Enquiry</li><li class="active">Enquiry List(s)
                </li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border"><h3 class="box-title">Search</h3></div><!-- /.box-header -->
                        <!-- form start -->
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table id="enListTbl" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <th></th>
                                    <th class="sortable asc" id="1">Order / Enquiry Ref. No.<i class="fa fa-fw fa-sort"></i></th>
                                    <th class="sortable asc" id="1">Request Date & Time<i class="fa fa-fw fa-sort"></i></th>
                                    <th class="sortable asc" id="2">Brand / Buyer<i class="fa fa-fw fa-sort"></i></th>
                                    <th class="sortable asc" id="3">Request Type<i class="fa fa-fw fa-sort"></i></th>
                                    <th class="sortable asc" id="4">Enquiry Type<i class="fa fa-fw fa-sort"></i></th>
                                    <th class="sortable asc" id="5">Style Ref. No. / Name<i class="fa fa-fw fa-sort"></i></th>
                                    ...
                                    <th class="sortable asc" id="10">Active / Not Active<i class="fa fa-fw fa-sort"></i></th>
                                </tr>
                                </thead>
                            </table>
                            <div>
...
<script src="<?php echo base_url();?>assets/js/merchant/menquiry.js"></script>
