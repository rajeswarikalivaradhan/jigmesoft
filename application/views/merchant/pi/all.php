                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="vedorname"  id="vedorname" placeholder="Free Text">
                                            </td>
                                            <td>
                            ...
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="5">P.I. Approval Cutoff<br> Date & Time</th>
                                        ...
                                        <th id="0">WIP Ref. No. </th>
                                        <th id="1">Brand</th>
                                        <th id="1">Request For</th>
                                        <th id="2">Requirement</th>
                                        <th id="3">Vendor Name</th>
                                        <th id="5">P.I. Ref. No.</th>
                                        <th id="4">P.I. Date & Time</th>
...
<script src="<?php echo base_url();?>assets/custom/pi/all.js"></script>
