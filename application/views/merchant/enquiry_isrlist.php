...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Enquiry List - ISR</b></span>
...
<script src="<?php echo base_url();?>assets/custom/enquiry_isrlist.js"></script>
<style>
    .tables > thead > tr > th{
