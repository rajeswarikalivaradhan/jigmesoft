...
<div class="wrapper">
    ...
    <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">D.C. LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Req. Date & Time</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">D.C. No. </th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 12px!important;">D.C. Date & Time</th>
                                         <th width="10%" class="theadstyle"  style=" padding: 0px 12px!important;">D.C. Date & Time</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="dc_no"  id="dc_no" placeholder="Free Text">
                                            </td>
                                            <td>
                        ...
                        <div class="box-body no-padding">
                            <table id="mCadQueueList" class="table table-bordered" data-page-length="50">
                                ...
                                <tr>
                                    ...
                                    <th>Issued to <br /> Dept. / Vendor </th>
                                    <!-- <th>Material Issued By </th> -->
                                    <!-- <th>Authorization <br />Type</th>
                                    <th>Authorized By </th> -->
                                    <th>Received <br /> Status </th>
...
<script src="<?php echo base_url();?>assets/js/caddclist.js"></script>
