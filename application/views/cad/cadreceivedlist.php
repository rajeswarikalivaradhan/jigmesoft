                                     ...
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Brand</th>
                                         <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Request Type</th>
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 12px!important;">Cutoff Date & Time</th>
                                         <th width="10%" class="theadstyle"  style=" padding: 0px 12px!important;">Cutoff Date & Time</th>
                                         <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >Merchant Name</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="requesttype"  id="requesttype" placeholder="Free Text">
                                            </td>
                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <table id="mCadReceivedList" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                <tr>
                                    <th></th>
...
$(document).ready(function() {
 ...
 if (sessionStorage.getItem('keepSearchOpen') === 'true') {
        ...
        {
            return $.ajax({
                url: base_path+'company/mcaduser/getcadreceivedlist',
                type:'POST',
        ...
        function dispDetails(reqRequestJSON)
        {
            ...
            if ( $.fn.DataTable.isDataTable('#mCadReceivedList') ) {
            $('#mCadReceivedList').DataTable().destroy();
            }

            var i = 1;

            $('#mCadReceivedList tbody').empty();	
            $("#mCadReceivedList").dataTable({
                ...
                "aoColumns": [		
                    ...
                    { 
                        "mDataProp": function ( data, type, full, meta) {
                            return '<a class="bold" href="' + base_path +'request/Cadrequest/cadDeptDetails/'+ encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id)) + '">' + data.isriorcode + '</a>';
                        }
                    },
                    { "mDataProp": "brandname" },	
...
$('#refreshBtn').on('click', function () {
  ...
  if(cutfromDate!=='' && cuttoDate!==''){
    ...
    var table = $('#mCadReceivedList').DataTable();

    var wip_ref_no = $('#wip_ref_no').val().toLowerCase();
    var brandId    = $('#brandId').val().toLowerCase();
	var requesttype = $('#requesttype').val().toLowerCase();
    ...
    table
      ...
      .column(4).search(requesttype)
      .column(9).search(merchantname)
