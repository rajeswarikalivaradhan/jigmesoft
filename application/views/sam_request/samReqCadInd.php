...
<a href="<?php echo base_url('msamplerequest/fab_ind/48') ?>" class="btn btn-info">Next</a>
                </div>
            </div>
        </section>
    </div><!-- /.content-wrapper -->
...
<script type="text/javascript">
    ...
    MakeAsynPostRequest(base_path+"msamplerequest/cad_ind","rFrom=1&enqId="+GlbOrderId,"json",function (data) {
        GlbCadRefNoWithFilter = data.ArrCadRefNoWithFilter;
        GlbCadRefNoWithoutFilter = data.jsonSamReqGrid;
        GlbCadRequirement = data.ArrCadRequirement;
        GlbOeSize = data.ArrFinalSizes;
        jexcel(document.getElementById('cadIndentJxl'), {
            columns: [
                {type: 'dropdown', title: 'CAD Ref. No.', width: 450, source: GlbCadRefNoWithoutFilter, wordWrap: true, filter: cadRefNoFilter },
                {type: 'dropdown', title: 'Requirement', width: 250, source: GlbCadRequirement, wordWrap: true},
                {type: 'dropdown', title: 'Required Size(s)', width: 80, source: GlbOeSize, wordWrap: true},
                {type: 'text', title: 'No. of Sizes Issued', width: 120, readOnly: true, wordWrap: true},
                {type: 'text', title: 'Total No. of Parts Issued', width: 120, readOnly: true, wordWrap: true},
                {type: 'text', title: 'Total No. of Parts Returned', width: 120, readOnly: true, wordWrap: true},
                {type: 'text', title: 'Parts Returned Status', width: 215, readOnly: true, wordWrap: true},
            ],
            data: [[]]
        });
    ...
    cadRefNoFilter = function(instance, cell, c, r, source) {
        ...
        let ssc = varSampleReq.getColumnData(4);
        console.log(GlbCadRefNoWithFilter,'GlbCadRefNoWithFilter');
        let ArrCadRefNoMix = GlbCadRefNoWithFilter[com+"|#|"+ssc];
