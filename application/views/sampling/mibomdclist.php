...
<div class="wrapper">
    ...
    <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM D.C. LIST</b></span>
                        ...
                        <div class="box-body no-padding">
                            <table id="sampleQueueListTbl" class="table table-bordered table-hover" data-page-length="50">
                                ...
                                <tr>
                                    ...
                                    <th>Material Recived <br /> From Dept. </th>
...
<script src="<?php echo base_url();?>assets/js/sampling/mibomdclist.js"></script>
