...
button#btn-active.btn-selected,
button#btn-inactive.btn-selected {
...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">GARMENT ISSUED LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >G.D.C. No</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">G.D.C. Date & Time</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">G.D.C. Date & Time</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 12px!important;">Sample Ref. No.</th>
                                         <th width="10%" class="theadstyle"  style=" padding: 0px 12px!important;">Mate. Issued To</th>
                                         <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Mate. recd. status</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="gdc_no"  id="gdc_no" placeholder="Free Text">
                                            </td>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="sample_ref_no"  id="sample_ref_no" placeholder="Free Text">
                                            </td>
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="material_issue"  id="material_issue" placeholder="Free Text">
                                            </td>
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="material_recived"  id="material_recived" placeholder="Free Text">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="border-top-color: #4747d1">
                        <div class="box-body no-padding">
                            <table id="sampleQueueListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th class="" width="11%" id="0">WIP Ref. No.</th>
                                    <th class="" width="8%"  id="1">Brand</th>
                                    <th class="" width="11%"  id="5">Cutoff <br />Date & Time</th>
                                    <th class="" width="11%"  id="8">G.D.C. No.</th>
                                    <th class="" width="11%"  id="8">G.D.C. Date & Time</th>
                                    <th class="" width="11%"  id="8">Sample Ref. No.</th>
                                    <th width="10%"  >Material <br /> Issued To</th>
                                    <th class="" width="10%"  id="9">Material<br />Received Status</th>
                                    <th class="" width="11%"  id="9">Recent <br />Update </th>
                                    <th class="" width="6%"  id="10">Status</th>
                                </tr>
                                </thead>
                            </table>
                        </div><!-- /.box-body -->
...
<script src="<?php echo base_url();?>assets/js/sampling/garmentissuedlist.js"></script>
