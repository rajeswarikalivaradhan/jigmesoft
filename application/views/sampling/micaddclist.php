...
<div class="wrapper">
    ...
    <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">CAD D.C. LIST</b></span>
...
<script src="<?php echo base_url();?>assets/js/sampling/micaddclist.js"></script>
