                        ...
                        <div class="box-body no-padding">
                            <table id="sampleQueueListTbl" class="table table-bordered table-hover" data-page-length="50">
                                ...
                                <tr>
                                    ...
                                    <th class="" id="1" width="7%">Brand</th>
                                    <th class="" id="3">Queue No.</th>
                                    <th class="" id="2"  width="11%" >Requirement</th>
                                    ...
                                    <th class="" id="9" width="11%">Recent <br />Update </th>
...
<script src="<?php echo base_url();?>assets/js/sampling/samplequeuelist.js"></script>
