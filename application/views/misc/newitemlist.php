                ...
                <div class="col-md-12">
                    <div class="box" style="border-top-color: #4747d1">
                        ...
                        <div class="box-body no-padding">
                            ...
                            <table id="StoresNewItemList" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th>WIP Ref. No.</th>
                                    ...
                                    <th>Size or Dim (L * W * H)</th>
                                    <th>Unit of Measure</th>
                                    <th class=" " id="">Current <br />Status</th>
                                    <th class=" " id="">Recent <br />Update </th>
                                    <th class=" " id="">Active / Inactive Status</th>
                                </tr>
                                </thead>
                            </table>
                        </div><!-- /.box-body -->
...
<script>
    ...
    $(document).ready(function() {
        dataTbl = $('#StoresNewItemList').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('storesuser/newitemlist')?>",
                "type": "POST",
                "data":{"rfrom":1}
            },
            "order": [0,"desc"]
