            ...
            <div class="box-body">
                                    ...
                                    <td>
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <input type='text' class="form-control"
                                                               value="<?php echo $ArrBasicInfo->agreedsupplydate ?>" id="agreedsupplydate"/>
                                            ...
                                            <tr>
                                                <td>PAYMENT TERMS:</td>
                                                <td>
                                                    <input type="text" class="form-control" id="frmBasicPaymentTerms" value="<?php echo $ArrBasicInfo->paymentterms ?>">
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="box-body">
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="frmAmountInWords" class="form-control" value="<?php echo $ArrBasicInfo->amountinwords ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php
                                    //echo '<pre>'; print_r($paymentpaidinfotoprint); die('die');
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="frmRemarks" class="form-control"><?php echo $ArrBasicInfo->purdeptremarks ?></textarea>
                                </div>
                            </div>
                        </form>
                        <div class="row">
                        ...
                        <?php
                        //Remove Save Button for Finance Department
                        if($this->session->userdata('UI')['usertype'] != 13) {
                        ?>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body" id="bomPiAdvancePaymentDiv">
                        ...
                        <form class="form-horizontal" id="frmBomPIAdvPaymentAppr">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php
                                        //echo '<pre>'; print_r($ArrBasicInfo->approvedstatus); die('die');
                                        ?>
                                        <select id="bomPIAdvPaymentApprStatus" class="form-control" disabled>
                                            <option value="">Choose</option>
                                            <option value="1" <?php echo $ArrBasicInfo->approvedstatus == 1 ? 'selected' : '' ?>>PENDING</option>
                                            <option value="2" <?php echo $ArrBasicInfo->approvedstatus == 2 ? 'selected' : '' ?>>AUTHORIZE</option>
                                            <option value="3"  <?php echo $ArrBasicInfo->approvedstatus == 3 ? 'selected' : '' ?>>REJECT</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Approval By name / Code</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="bomPIAdvPaymentApprBy" readonly
                                               value="<?php if(!empty($ApprovedMgmtInfo[0]->contactname)) echo $ApprovedMgmtInfo[0]->contactname ?>">
                                    </div>
                                </div>
                            </div>
                        </form>
                        <div class="box-footer">
                            <button class="btn btn-info pull-right" type="button"
                                    onclick="return fnSaveBomAdvancePaymentLocalStorage()">Save
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5"
                                ...
                                <ul style="list-style: none;">
                                    <?php
                                    $VarFdr = FCPATH . "uploads/bompurchaserequest/" . $BomPurReqId;
...
<script type="text/javascript">
    ...
    var GlbForSavingIssuePIDynamicTbl = 0; var GlbBomPurchaseGrid = 0; var GlbPurchaseToId = 0;
    var GlbValidateVendorSelection = ''; var GlbReadOnlyInfo = ''; var GlbAdvPayableAmount = 0;
    var GlbFinDeptAdvPaymentPaidGrid = '<?php echo $jsonPaymentPaidGrid ?>';
    var AdvPaymentId = '<?php echo $ArrBasicAdvPaymentId ?>';
    var userType = '<?php echo $loggedInUserType ?>';
    console.log(userType,'userType');
    if(userType == 8) {
        GlbReadOnlyInfo = true;
    }
    else if(userType == 3 || userType == 15) { // included this condition || userType ==15 for planning dept.
        GlbReadOnlyInfo = true;
    }
    else if(userType == 13) {
        GlbReadOnlyInfo = false;
    }
    GlbBomPurchaseGrid = '<?php echo $purchaseIndSavedGrid ?>';
    var bomPIJxl = 0; var GlbFinanceDeptPayPaidJxl = 0; var GlbPaymentTotal = 0;
    ...
    function fnSavePIinLocalStorage() {
        if (typeof(Storage) !== "undefined") {
            var BasicObj = {
                vendorId: GlbPurchaseToId,
                ...
                VendorConName: $("#frmBasicVendorName").val(),
                VendorConMob: $("#frmBasicVendorMobile").val(),
                VendorConEmail: $("#frmBasicVendorEmail").val()
            };
            //localStorage.setItem("lsBasicData", JSON.stringify(BasicObj));
            //localStorage.setItem("lsBomPIJxl", JSON.stringify(bomPIJxl.getData()));
        }
        else {
    ...
    function fnSavePurchaseIndent() {
        try {
            ...
            var VendorName = $("#frmBasicVendorName").val();
            var VendorMobile = $("#frmBasicVendorMobile").val();
            var VendorEmail = $("#frmBasicVendorEmail").val();

            var PiNo = $("#PurchaseIndentNo").text();
            $('.herr').text('');
            ...
            var bomPIJxlData = JSON.stringify($("#bomPurchaseIndentJxl").jexcel('getData'));
            console.log(bomPIJxlData, 'bomPIJxlData');
            if(userType == 3 || userType == 15) { // for Mgmt // included this condition || userType ==15 for planning dept.
            ...
            else if(userType == 13) { //For Finance Dept
                var paymentStatus = 0;
                var finPayPaidJxl = $("#financeDeptPayPaidJxl").jexcel('getData');
                //if(GlbTotal == GlbAdvPayableAmount) {
                    paymentStatus = 1;
                //}
                MakePostRequest(base_path + 'mfinance/updateBomPIPayAdvDetails',"rfrom=1&bomPurIndentId="+GlbBomPurIndentId+
                    "&bompurrequestid="+GlbRequestId+"&paymentstatus="+paymentStatus+"&AdvPaymentId="+AdvPaymentId+"&financeDeptPayPaidJxl="+JSON.stringify(finPayPaidJxl),
                    "json",fnSavePurchaseIndentRes);
            }
            else { // Purchase Dept
                MakePostRequest(base_path + 'purchaseuser/updatePurchaseIndent', "rfrom=1&bomPurIndentId=" + GlbBomPurIndentId + "&bomPurReqId=" +
                    GlbRequestId + "&oid="+GlbOrderId+"&purchaseto=" +
                    GlbPurchaseToId + "&supplydate=" + agreedsupplydate + "&paymentterms=" + paymentterms + "&amountinwords=" +
                    AmountInWords + "&remarks=" + Remarks + "&pname=" +
                    PurchaserName + "&pmobile=" + PurchaserMobile + "&pemail=" + PurchaserEmail + "&vname=" + VendorName + "&vmobile=" +
                    VendorMobile + "&vemail=" + VendorEmail + "&proDate=" + proformaDate + "&proNo=" + proformaNo + "&advPayCurrency=" + advPayCurr +
                    "&proValue=" + proValue + "&advPayAmount=" + advPayableAmount + "&reqMop=" + ReqdModeOfPayment + "&payBydate=" + payByDate +
                    "&PiNo=" + PiNo + "&TaxTypeId=" + GlbTaxTypeId + "&bompurindinvoicegrid=" + bomPIJxlData, 'json', fnSavePurchaseIndentRes);
            }
            return false;
        } catch (e) {
    ...
    function fnSaveBomAdvancePaymentLocalStorage() {
        $("#BomPiMgmtApprovalModal").show();
        if (typeof(Storage) !== "undefined") {
            var BasicAdvPayReqObj = {
                ProformaDate: $("#proformaDate").val(),
                ProformaNo: $("#proformaNo").val(),
                Currecny: $("#frmCurrencyCode").val(),
                ProformaValue: $("#proformaValue").val(),
                AdvancePayAmount: $("#bomPIAdvancePayableAmount").val(),
                ReqModeofPay: $("#ReqdModeOfPayment").val(),
                PaybyDate: $("#payByDate").val()
            };
            //localStorage.setItem("lsBasicAdvPayReqObj", JSON.stringify(BasicAdvPayReqObj));
        }
        else {
            alert('Sorry! No Web Storage support..');
        }
    ...
    if(GlbFinDeptAdvPaymentPaidGrid != "") {
        GlbFinDeptAdvPaymentPaidGrid = JSON.parse(GlbFinDeptAdvPaymentPaidGrid);
    }
    else {
        GlbFinDeptAdvPaymentPaidGrid = [[]];
    }

    var GlbAdvPayModeOfPayment = ["Cheque","DD","RTGS","SWIFT"];
    var PAYMENTTBLSUMCOL = function (instance, columnId) {
        var GlbTotal = 0; GlbPaymentTotal = 0;
        for (var j = 0; j < instance.options.data.length; j++) {
            if (Number(instance.records[j][columnId - 1].innerHTML)) {
                GlbTotal += Number(instance.records[j][columnId - 1].innerHTML);
            }
        }
        GlbPaymentTotal = GlbTotal;
        return GlbTotal;
    }

    GlbFinanceDeptPayPaidJxl = jexcel(document.getElementById('financeDeptPayPaidJxl'), {
        columns:[
            { type:'text',title:'Paid in Favour of', width:300, readOnly: GlbReadOnlyInfo },
            { type:'dropdown',title:'Mode of Payment', width:150, source: GlbAdvPayModeOfPayment, readOnly: GlbReadOnlyInfo },
            { type:'text',title:'Transaction ID / Code', width:150, readOnly: GlbReadOnlyInfo },
            { type:'text',title:'Cheque No.', width:150, readOnly: GlbReadOnlyInfo },
            { type:'calendar', title:'Transaction / Cheque Date', width:150, readOnly: GlbReadOnlyInfo },
            { type:'dropdown',title:'Currency', width:150, source: JSON.parse(GlbCurrencynCode), readOnly: GlbReadOnlyInfo },
            { type:'text',title:'Advance Paid Amount', width:150, readOnly: GlbReadOnlyInfo },
            { type:'dropdown',title:'Advance Paid in Full / Part', width:100, source : ["Full","Part"], readOnly: GlbReadOnlyInfo },
        ],
        onchange :function(instance, cell, c, r, value) {
            /*var GlbAdvPayableAmount = $("#bomPIAdvancePayableAmount").val();
            var ArrAdvPaidTotal = $("#financeDeptPayPaidJxl").jexcel('getColumnData',6);*/
            // Getting sum of numbers
            /*var ArrAdvPaidSum = ArrAdvPaidTotal.reduce(function(a, b) {
                return Number(a) + Number(b);
            }, 0);*/

            //if(ArrAdvPaidSum > GlbAdvPayableAmount) {
                //console.log('exceeds');
                //alert('Amount Exceeds');
                //$(cell).text(0);
                //instance.jexcel.options.data[r][c] = 0;
            //}
            //else {

            //}
        },
        footers: [['','','','','','Total','=PAYMENTTBLSUMCOL(TABLE(), COLUMN())']],
        data: GlbFinDeptAdvPaymentPaidGrid
    });
    ...
    jexcel(document.getElementById('advPaymentRequestJxl'), {
        columns: [
            ...
            {type: 'text', title: 'Requested Mode of Payment', width: 120},
    ...
    jexcel(document.getElementById('vendorBankDetailsJxl'), {
        columns: [
            ...
            {type: 'calendar', title: 'IBAN', width: 120}
        ],
        data: [
            []
        ]
