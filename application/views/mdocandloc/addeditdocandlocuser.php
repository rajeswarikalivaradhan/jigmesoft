    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            ...
            <section class="content-header">
                <h1 class="firstHeading">Documentation and Logistics
                    Dept. <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
        <!-- Main content -->
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                                ...
                                <form class="form-horizontal" name="frmBasicInfo" id="frmBasicInfo" method="post">
                                    ...
                                    if ($Edit == 'edit' || empty($VarId)) {
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label for="frmBasicDesgn" class="col-sm-4 control-label">Designation</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="frmBasicEmailid" class="form-control"
                                                           ...
                                                           value="<?php echo @$ArrBasicInfo['username']; ?>">
                                        ...
                                        <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label for="frmBasicStatus" class="col-sm-4 control-label">Status</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'mdocandlocuser/manage') ?>" class="btn btn-default">Back</a>
    ...
    function fnSaveUserInfo() {
        try {
            ...
            if (window.FormData) {
                ...
                $.ajax({
                    url: base_path + GlbCompanyFdr + 'mdocandlocuser/updateUser',
    ...
    function fnSaveRes(data) {
        if (data != '') {
            if (data.errcode == '404') {
                ...
                fnRedirectPageTimeOut(base_path + GlbCompanyFdr + 'mdocandlocuser/addedit/' + data.eid);
            }
        }
    }
</script>
