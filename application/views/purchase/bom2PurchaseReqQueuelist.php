...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM (A2) QUEUE LIST</b></span>
                                     ...
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Brand</th>
                                         <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Queue No</th>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="mBomPurReqQList" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                <tr>
                                    <th></th>
                                    <th id="0" width="10%">WIP Ref. No. </th>
                                    <th id="1" width="6%">Brand</th>
                                    <th id="8" width="6%"> Queue No.</th>
                                    ...
                                    <th id="9" width="9%">Current <br /> Status </th>
                                    <th id="10" width="11%">Recent <br /> Update </th>
                                    <th id="11">Status</th>
                                </tr>
                                </thead>
                            </table>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom2/bom2purchase_queue_list.js"></script>
