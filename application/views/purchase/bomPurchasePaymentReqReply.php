...
<div class="wrapper">
    ...
    <aside class="main-sidebar"> <?php $this->load->view(CNFCOMPANY.'template/templateleftmenu');?></aside>
    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-12 paymentReqTab" id="bomPaymentRequest">
                    ...
                    <div class="box box-info">
                        ...
                        <?php
                        echo $ArrBasicPaymentInfo['billpayment'] != 1 ? '<button type="button" id="showBillPayment" onclick="fnDisplayBillPayment(\'billPaymentDiv\')">Bill Payment</button>' : '';
                        ...
                        ?>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td><?php echo $ArrBasicInfo->isriorcode; ?></td>
                                    <td><input type="text" id="invoiceNo" name="invoiceNo" style="width: 110px" value="<?php if(!empty($ArrBasicPaymentInfo['invoiceno'])) echo $ArrBasicPaymentInfo['invoiceno']; ?>"> </td>
                                    ...
                                    <td><?php echo $VarCurrency ?></td>
                                    <td><input type="text" id="invoiceValue" name="invoiceValue" style="width: 110px" value="<?php if(!empty($ArrBasicPaymentInfo['invoicevalue'])) echo $ArrBasicPaymentInfo['invoicevalue'] ?>"></td>
                                    <td>
                                        <div id="BillPaymentAdvPaid"><?php
                                            $vartotaladv = 0;
                                            foreach ($ArrBasicFinanceDeptInfo as $finDeptChild) {
                                                //echo $finDeptChild['advpaid'];
                                                $vartotaladv += $finDeptChild['advpaid'];
                                            }
                                            echo $vartotaladv;
                                            //echo @$ArrBasicFinanceDeptInfo[0]['advpaid']; ?></div>
                                         <?php //foreach ($ArrBasicFinanceDeptInfo as $advpaidvalue) echo $advpaidvalue['advpaid'].'<br/>'; ?>
                                    </td>
                                    <td><input type="text" id="debitValue" name="debitValue" style="width: 110px" value="<?php if(!empty($ArrBasicPaymentInfo['debitvalue'])) echo $ArrBasicPaymentInfo['debitvalue'] ?>"> </td>
                                    <td><?php
                                        //echo  $ArrBasicInfo->subtotal_total.'<br/>';
                                        //echo  $ArrBasicPaymentInfo['advpayable'];
                                        $VarRes = $ArrBasicPaymentInfo['invoicevalue'] - $ArrBasicPaymentInfo['advpayable'] - $ArrBasicPaymentInfo['debitvalue']; ?>
                                        <input type="text" id="amountPayable" name="amountPayable" style="width: 110px" value="<?php echo $VarRes ?>"> </td>
                                    <td>
                                        <?php
                                        ?>
                                        <select id="ReqdModeOfPayment" name="ReqdModeOfPayment">
                                    ...
                                    <td id="ApprdBy"><?php if(!empty($apprbyname)) echo $apprbyname ?></td>
                                </tr>
                            </table>
                                </form>
                        </div>
                            ...
                            <div class="box-body" id="advPaymentDiv">
                                ...
                                <form name="frmAdvPaymentFinance" id="frmAdvPaymentFinance" class="">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php foreach ($ArrBasicFinanceDeptInfo as $item) {
                                            if($item['advancepayment']) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="" name="" style="width: 80px" value="<?php echo empty($item['chequedate']) ? '' : date('d-m-Y',strtotime($item['chequedate'])) ?>">
                                                    </td>
                                                    ...
                                                    <td><?php echo $VarCurrency ?></td>
                                                    <td><input type="text" id="" name="" style="width: 130px" value="<?php echo $item['advpaid'] ?>"></td>
                                                    <td>
                                                        <select id="" name="">
                                                    ...
                                                    <td><input type="text" id="AdvPaymentBaltoPayItemLoop" name="" style="width: 140px" value="<?php echo $item['baltopay'] ?>"></td>
                                                    <td><?php echo $VarVerifiedBy ?></td>
                                                    <td><?php echo $apprbyname ?></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
                                        ...
                                        foreach ($ArrBasicFinanceDeptInfo as $item) {
                                            if($item['billpayment']) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="frmCheqNo" name="frmCheqNo"
                                                               style="width: 110px" value="<?php echo $item['chequeno'] ?>">
                                                    </td>
                                                    <td>
                                                        <input type="text" id="frmCheqDate" name="frmCheqDate"
                                                               style="width: 82px"
                                                               value="<?php echo empty($item['chequedate']) ? '' : date('d-m-Y', strtotime($item['chequedate'])) ?>">
                                                    </td>
                                                    <td><input type="text" id="frmTransId" name="frmTransId"
                                                               value="<?php echo $item['transid'] ?>"></td>
                                                    <td>
                                                        <input type="text" id="frmTransDate" name="frmTransDate"
                                                               style="width: 82px"
                                                               value="<?php echo empty($item['transdate']) ? '' : date('d-m-Y', strtotime($item['transdate'])) ?>">
                                                    </td>
                                                    <td> <?php echo $VarCurrency ?></td>
                                                    <td><input type="text" id="frmAmountPaid" name="frmAmountPaid"
                                                               style="width: 110px"
                                                    ...
                                                    <td><input type="text" id="frmBaltoPay" name="frmBaltoPay"
                                                               style="width: 110px" value="<?php echo $item['baltopay'] ?>">
                                                    </td>
                                                    <td><?php echo $VarVerifiedBy ?></td>
                                                    <td><?php echo $apprbyname ?></td>
                                                </tr>
                    ...
                    <div class="box-footer nopadding">
                        ...
                        <?php //if($Varpayment_completed_status == 0)
                            echo '<button class="btn btn-info pull-right" type="submit" onclick="return fnSavePurDeptReplySave()">Save Cahnges</button>';
                        ?>

                    </div>
                </div>
                <?php //$this->load->view('purchase/bomPurchasePaymentReqReplyBomPIPTrack') ?>
            </div>
        </section>
    </div><!-- /.content-wrapper -->
...
<script src="<?php echo base_url();?>assets/js/purchase/bp_paymentformwizard.js"></script>
<script>
    var GlbPaymentType = '<?php echo @$ArrBasicPaymentInfo['advancepayment'] ?>'; var GlbBomPurchaseInvoiceId = '<?php echo $VarBomPurchaseInvoiceId ?>';
    var GlbBomPurIndReqId = '<?php echo $VarBomPurIndReqId ?>';
    var SavedInvoiceGrid = '<?php echo @$ArrBasicInfo->invoicegrid ?>'; var GlbTaxType = '<?php echo @$ArrBasicInfo->taxtype ?>';
    var GlbId = '<?php echo $VarId ?>';
    function fnDisplayBillPayment(divid) {
        GlbPaymentType = 2;
    ...
    function fnSavePurDeptReplySave() {
    ...
    //var GlbAdvancePaid = $("#AdvPaymentBaltoPayItemLoop").val();
    //console.log(GlbAdvancePaid,'GlbAdvancePaid');
    //$("#amountPayable").val(GlbAdvancePaid);
    var GlbPIValue = '<?php echo @$ArrBasicInfo->subtotal_total ?>';
    $("#debitValue").keyup(function () {
        var invoiceValue = $("#invoiceValue").val();
        var AdvPaid = $("#BillPaymentAdvPaid").text();
        var Debit = $(this).val();

        var sumalldebit = Number(AdvPaid) + Number(Debit);
        var finalvalue = Number(invoiceValue) - Number(sumalldebit);
        $("#amountPayable").val(finalvalue.toFixed(2));
    });
</script>
