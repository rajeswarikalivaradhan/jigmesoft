    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            ...
            <section class="content-header">
                <h1 class="firstHeading">Purchase
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'mpurchaseuser/manage') ?>"
...
<script type="text/javascript">
    ...
    function fnSaveUserInfo() {
        try {
            ...
            $.ajax({
                url: base_path + GlbCompanyFdr + 'mpurchaseuser/updateUser',
    ...
    function fnSaveRes(data) {
        if (data != '') {
            if (data.errcode == '404') {
                ...
                fnRedirectPageTimeOut(base_path + GlbCompanyFdr + 'mpurchaseuser/addedit/' + data.eid);
            }
        }
    }
</script>
