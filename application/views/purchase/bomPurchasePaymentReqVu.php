        ...
        <section class="content">
            <div class="row">
                        ...
                        <div class="box-header with-border">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="invoiceDate" name="invoiceDate" style="width: 66px" placeholder="Choose" value="<?php ?>"></td>
                                    <td>INR</td>
                                    <td><input type="text" id="invoiceValue" name="invoiceValue" style="width: 110px"></td>
                                    <td><?php echo '' ?></td>
                                    <td><input type="text" id="debitValue" name="debitValue"> </td>
                                    <td><input type="text" id="amountPayable" name="amountPayable"> </td>
                                    <td>
                                        <select id="ReqdModeOfPayment" name="ReqdModeOfPayment">
                                    ...
                                    <td>
                                        <select id="ApprStatus" name="ApprStatus">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>PAYMENT PAID REQUEST</b></h3>
                            <div class="box-tools pull-right">
                                ...
                                <table class="table">
                                    ...
                                    foreach ($ArrBasicFinanceDeptInfo as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="" name="" style="width: 80px" value="<?php echo date('d-m-Y',strtotime($item['transdate'])) ?>">
                                            </td>
                                            <td><?php echo $VarCurrency ?></td>
                        ...
                        <div class="box-body <?php if(!empty($VarId)) { if($ArrBasicPaymentInfo['paymenttype'] == 1) echo 'hide'; } else echo 'hide' ?>" id="">
                            <h5 class="box-title"><b>Bill Payment</b></h5>
...
<script>
    ...
    function fnSavePurDeptRequest() {
        if(GlbPaymentType == 1) {
            ...
            var Param = "bompurchaseinvoiceid="+GlbBomPurchaseInvoiceId+"&bompurchaseindreqid="+GlbBomPurIndReqId+"&paymenttype="+GlbPaymentType+"&"+advformdatas;
            ...
            var Param = "bompurchaseinvoiceid="+GlbBomPurchaseInvoiceId+"&bompurchaseindreqid="+GlbBomPurIndReqId+"&paymenttype="+GlbPaymentType+"&"+billformdatas;
            MakeAsynPostRequest(base_path+'purchaseuser/updateBomPaymentReq',Param,'json',fnSavePurDeptRequestRes);
