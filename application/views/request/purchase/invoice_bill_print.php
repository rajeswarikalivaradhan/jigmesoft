...
<?php 
 ...
 <table width="100%" border="0"  height="30" align="center" style="border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;padding-bottom: 20px;">
        <tr >
  <td width="76%"  align="right" style="border-bottom: 1px dotted black;"><strong> Total:</strong> </td>
          
          
          <td  width="8%" align="right" style="border-bottom: 1px dotted black;padding-right: 4px;"><strong><?php echo number_format($tot_amt,2); ?></strong></td>
         

          <td  width="7%" style="border-bottom: 1px dotted black;padding-left:15px"></td>
          
          <td  width="8%" align="right" style="border-bottom: 1px dotted black;padding-right:4px;"><strong><?php echo number_format($all_tot,2); ?></strong></td>
  ...
  <tr>
    <td width="12%" height="20" style="padding-top: 15px;  ">
      <b>&nbsp;&nbsp;Amount In Words:</b>
    </td>
    <td width="50%" height="20" style=" padding-top: 15px; ">
      <?php echo $pi_datas['pi_req_name']; ?>
    </td>
  </tr>
  <tr>
    ...
    <td width="30%" height="30" style=" padding-top: 1px; padding-bottom: 10px;">
      <?php echo $pi_datas['payment_terms'];?>
    </td>
