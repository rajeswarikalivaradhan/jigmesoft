...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top:110px">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">STOCK TRANSFER MEMO LIST </b></span>
          ...
          <div class=" px-4 w-90" style="margin-left: 2px; width: 99.6%;">
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 12px!important;">S.T. Ref. No.</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">S.T.M. Date & Time</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">S.T.M. Date & Time</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="stm_ref_no"  id="stm_ref_no" placeholder="Free Text">
                                            </td>
                                             <td>
                                                <p id="calenderSearch" class="input-group search-div">
