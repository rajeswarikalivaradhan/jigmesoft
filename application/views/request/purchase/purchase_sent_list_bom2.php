...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM(A2) REQUEST SENT LIST</b></span>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="request_type"  id="request_type" placeholder="Free Text">
                                            </td>
...
<script src="<?php echo base_url();?>assets/custom/request/bom2/purchasesentlistbom2.js"></script>
