...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4">
            ...
            <div class="row">
                <p><span style="padding-left:30px; width: 500px;">Select any one:</span> <span style="padding-left:445px;text-align: right;">Select any one:</span> </p>
...
<?php //print_r($piData); exit; ?>
            ...
            <section class="content-header" style="padding-top: 0">
                ...
                <div class="card-header pb-3 bgc-white border-0 " style="padding-top: 35px;">
                    <div class="card-title f-20">
                        <b style="font-size: 20px !important; padding-left: 5px; margin-left: 3px;color: #333">BOM (Art - 1) PURCHASE INDENT</b>
                    </div>
                </div>
                                ...
                                <td class="ord-procs-cell">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="process-value pad-0">
                                                 <input class="inp-full-wd date" id="exp_dod" type="text" placeholder="Free Text" />
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">REQUEST & PAYMENT LOG1</div>
                </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/purchase/editdraftpi.js"></script>
