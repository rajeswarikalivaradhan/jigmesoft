                        ...
                        <div class="box-body no-padding">
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                ...
                                <tr>
                                    ...
                                    <th class="" style="width: 9%" id="3">Request For</th>
                                    <th class="" id="3">Requirement</th>
                                    <th class="" id="3">Vendor Name</th>
                                    <th class=""  id="3">P.I. Ref. No.</th>
                                    <th class="" id="3">P.I. Date & Time</th>
                                    <th class="" id="7">Cutoff <br />Date & Time</th>
                                    <th class="" id="8">Expected <br />Date Of Delivery</th>
...
<script src="<?php echo base_url();?>assets/custom/request/purchase/purchaseindentlist.js"></script>
