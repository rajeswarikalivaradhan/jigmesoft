                ...
                <tbody>
                    <tr>
                        <td class="ord-procs-cell">
                            ...
                            <tbody>
                                <tr>
                                    <td class="process-main-head text-left" style="text-align: left;">
                        ...
                        <td class="ord-procs-cell">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="process-value" colspan="3">
                                    <?php
                                        echo isset($ArrCommonHeaderData['ArrEnquiryDetails']['formattedDateUpdated']) ? date('d-m-Y h:i A', strtotime($ArrCommonHeaderData['ArrEnquiryDetails']['wipdatecreated'])) : date('d-m-Y h:i A');
                                    ?>
                                    </td>
                                </tr>
                                <tr>
