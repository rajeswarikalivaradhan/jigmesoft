...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="req_status" name="req_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="1" <?php if($requestData['req_status']=="0" || $requestData['req_status']=="") echo "selected=\"selected\""; ?>>PENDING</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="queue_no" name="queue_no" placeholder="Auto Update" value="<?php echo $requestData['sam_queue_no']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="que_assign_date" name="que_assign_date" placeholder="Auto Update" value="<?php echo $requestData['sam_no_a_dt']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="5" id="dep_remarks" name="dep_remarks" class="form-control h-90" placeholder="Auto Update" readonly><?php echo $requestData['dep_remarks']; ?></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-right pr-3 py-3">   
                        <?php if(sizeof($dcStatus) > 0) { ?>
                            <a class="btn btn-info btn-sm ml-3" href="<?php echo base_url();?>request/Samplerequest/dclist/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>">DRAFT D.C.</a>
                        <?php } ?>
                        <?php if(sizeof($qaStatus) > 0) { ?>
                             <a id="qaRequestLink" class="btn btn-info btn-sm ml-3"   >SAM. Q.A. Request</a>
                            <!-- <a id="qaRequestLink" class="btn btn-info btn-sm ml-3" href="<?php echo base_url();?>request/Samplerequest/qarequest/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>">SAM. Q.A. Request</a>              -->
                        <?php } else { ?>
                            <a id="qaRequestLink" class="btn btn-info btn-sm ml-3" disabled>SAM. Q.A. Request</a>
                        <?php } ?>

                         <!-- <a id="qaRequestLink" class="btn btn-info btn-sm ml-3" href="<?php echo base_url();?>request/Samplerequest/qarequest/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>">SAM. Q.A. Request</a>              -->
                        
                        <?php if(sizeof($qaCompStatus) > 0) { ?>
                            <!-- <a class="btn btn-info btn-sm mar-l-5rem" id="qaCompleted">ISSUE GENERATED</a> -->
                            <a id="qaRequestLink" class="btn btn-info btn-sm ml-3" href="<?php echo base_url();?>request/Samplerequest/qarequest_garment/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>">ISSUE GARMENT</a>             
                        
                        <?php } else { ?>
                            <a class="btn btn-info btn-sm mar-l-5rem" disabled>ISSUE GARMENT</a>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/sample/qasample.js"></script>
