  ...
  <tbody >
    ...
    <?php foreach ($sample_data['data'] as $row): ?>
        <tr>
            ...
            <td style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px" ><?php echo htmlspecialchars($row[1]); ?></td>
            <td style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px" ><?php echo htmlspecialchars($row[2]); ?></td>
            ...
            <td style="text-align:right;padding-right: 4px;padding-bottom: 5px;padding-top: 5px"><?php echo htmlspecialchars($row[9]); ?></td>
        </tr>
    <?php endforeach; ?>
<?php else: ?>
...
<table width="100%" height="50"  style="border-collapse:collapse;border-bottom:1px solid; solid black;border-right:1px solid black;border-left:1px solid black;">
 <tr>
          ...
          <!-- <td width="170" height="10" align="right"><?php echo @$ArrProfileInfo['name']; ?></td> -->
        
        </tr>

        <tr>
          <td width="100" height="10" align="left" style="padding-left: 15px"><b>Request Raised By</td>
          <td width="100" height="10" align="left" ><b>Request Authorized By</b></td>
          <td width="100" height="10" align="left" ><b>P.I. Approved By</b></td>
          <td width="170" height="10" align="right" style="padding-right: 5px ">Authorized Signatory</td>
        </tr>
        </table>
