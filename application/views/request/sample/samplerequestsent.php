...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="req_status" name="req_status">
                                    ...
                                    <option value="0" <?php if($requestData['sam_qa_status']=="0" || $requestData['sam_qa_status']=="") echo "selected=\"selected\""; ?>>PENDING</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="5" id="dep_remarks" name="dep_remarks" class="form-control h-90 mgmt" placeholder="Auto Update"><?php echo $requestData['qa_dept_remarks']; ?></textarea>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/sample/samplerequestsent.js"></script>
