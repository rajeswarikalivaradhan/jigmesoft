...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="req_status" name="req_status">
                                    ...
                                    <option value="0" <?php if($requestData['qa_req_status']=="0") echo "selected=\"selected\""; ?>>PENDING</option>
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-right pr-3 py-3">
                        <!-- <a class="btn btn-info btn-sm mar-l-5rem" id="qa_req" href="<?php echo base_url(); ?>request/Samplerequest/qarequestSample/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>/samId/<?php echo urlencode(base64_encode($samId)) ?>">Q.A STATUS</a>                 -->
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/sample/queuelist.js"></script>
