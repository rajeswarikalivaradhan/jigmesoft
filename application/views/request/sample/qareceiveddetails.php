...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control date mgmt" id="qa_req_date" name="qa_req_date" autocomplete="off" value="" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control date mgmt" id="qa_cutoff_date" name="qa_cutoff_date" autocomplete="off" value="" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">                                
                                <textarea id="sam_dept_note" name="sam_dept_note" class="form-control h-145 mgmt" placeholder="Free Text"></textarea>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single" id="qa_status" name="qa_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="0" selected>PENDING</option>
                                    <option value="1">ACCEPTED</option> 
                                </select>
                                <div class="herr" id="err_qa_status"></div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-4 col-form-label text-sm-right pr-0">
                ...
                <div class="row">
                   ...
                   <div class="col-12 pr-3 py-3">
                    ...
                    <div class="col-12 text-right pr-3 py-3">                
                        <a class="btn btn-info btn-sm ml-5" id="getValues">SAVE</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/sample/qareceiveddetails.js"></script>
