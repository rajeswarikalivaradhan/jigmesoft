...
<body class="hold-transition layout-top-nav">
        ...
        <div class="content px-4">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control  mgmt" id="qa_req_date" name="qa_req_date" autocomplete="off" value="" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control date" id="qa_cutoff_date" name="qa_cutoff_date" autocomplete="off" value="" placeholder="Select">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">                                
                                <textarea id="sam_dept_note" name="sam_dept_note" class="form-control h-145" placeholder="Free Text"></textarea>
                ...
                <div class="row">
                     ...
                     <div class="row">
                        <div id="sampleReqImageUpload" class="pdt10"></div>
                    </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/sample/qarequest.js"></script>
