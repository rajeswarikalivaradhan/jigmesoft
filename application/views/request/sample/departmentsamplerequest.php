...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="cutoff_date" name="cutoff_date" class="form-control mgmt" readonly value="<?php echo $requestData["r_cutoff_date"]?>" placeholder="Free Select">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/sample/departmentsample.js">
