...
<body class="hold-transition layout-top-nav">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <select class="cus-sel form-control js-example-basic-single mgmt" id="cad_dept" name="cad_dept">
                                        <option value="" disabled hidden>Select</option>
                                        <?php foreach($vendorDetails as $r) { ?>
                                        <option value="<?php echo $r['id'];?>"  ><?php echo $r['name'];?></option>
                                        <?php } ?>
                                    </select>
                                    <script>document.cad_mi_form.cad_dept.value='<?php echo $miDetails['type'];?>'</script>
                                    <div class="herr" id="err_cad_dept"></div>
                                </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <script>document.fab_mi_form.cad_dept.value='<?php echo $miDetails['type'];?>'</script>
                                    <div class="herr" id="err_cad_dept"></div>
                                </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <script>document.bom_mi_form.cad_dept.value='<?php echo $miDetails['type'];?>'</script>
                                    <div class="herr" id="err_cad_dept"></div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="cutoff_date" name="cutoff_date" class="form-control date" placeholder="Free Select" value="<?php echo $requestData["r_cutoff_date"]?>" readonly>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <?php if($requestData['auth_status'] == 1 || $requestData['auth_status'] == '1' || $requestData['auth_status'] == 2 || $requestData['auth_status'] == '2') { ?>
                                    <select class="cus-sel form-control js-example-basic-single mgmt" id="auth_status" name="auth_status" readonly disabled>
                                        <option value="" disabled hidden>Select</option>
                             ...
                             <div class="col-sm-8">
                                <?php if($requestData['auth_status']=="1" && $requestData['mgmt_approval'] == 1 )  { ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php if($requestData['auth_status'] == 1 || $requestData['auth_status'] == '1' || $requestData['auth_status'] == 2 || $requestData['auth_status'] == '2') { ?>
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="auth_type" name="auth_type" disabled>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="req_status" name="req_status" autocomplete="off" placeholder="Auto Update" readOnly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="queue_no" name="queue_no" placeholder="Auto Update">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/sample/managementsample.js"></script>
