...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM (A2) PURCHASE INDENT APPROVAL LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Request  Date & Time</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Request Date & Time</th>
                            ...
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="" id="8">Approval <br />Type</th>
                                        <th class="" id="8">Approval By</th>
...
<script src="<?php echo base_url();?>assets/custom/request/bom2/mgmt_pi_appl_list.js"></script>
