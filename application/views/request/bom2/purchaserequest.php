...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4">
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">BOM (Article - 2): SOURCING DETAILS</div>
                </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom2/purchaserequest.js"></script>
