...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-right pr-3 py-3">                
                        <a class="btn btn-info btn-sm mar-l-5rem">PRINT</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/fabric/dept/yarn_payment_paid_details.js"></script>
