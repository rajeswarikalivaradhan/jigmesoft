    ...
    <div class="content-wrapper" style="background-color: #bffff9">
        <section class="content-header">
            <div class="col-md-6" style="padding-left: 20px">
                <h1 style="margin: 0; font-size: 20px; font-weight: 600">REQUEST RECEIVED LIST</h1>
            </div>
...
<script src="<?php echo base_url();?>assets/custom/request/fabric/dept/reqreceivedlist.js"></script>
