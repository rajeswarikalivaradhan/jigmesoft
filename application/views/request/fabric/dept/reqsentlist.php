...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="col-md-6">
                <h1 style="margin: 0; font-size: 20px; font-weight: 600">PURCHASE DEPT. -  REQUEST SENT LIST</h1>
            </div>
                        ...
                        <div class="box-body no-padding">
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th id="1">Brand</th>
                                    <th id="2">Request <br>For </th>
                                    <th id="2">Requirement </th>
                                    <th id="4">Supply Lead<br>Time </th>
                                    <th id="5">P.I. Appl. Request <br>Date & Time</th>
                                    <th id="6">P.I. Appl. Cutoff <br>Date & Time</th>
                                    <th id="7">Authorization <br>Type </th>
                                    <th id="8">Approved <br>By </th>
...
<script src="<?php echo base_url();?>assets/custom/request/fabric/dept/reqsentlist.js"></script>
<script>
