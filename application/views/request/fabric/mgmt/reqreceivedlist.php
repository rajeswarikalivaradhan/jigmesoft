...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mgmt_remark" name="mgmt_remark" autocomplete="off" value="<?php echo $requestData["mgmt_remark"]?>" placeholder="Free Text">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request//fabric/mgmt/reqreceivedlist.js">
