...
<body class="hold-transition layout-top-nav">
        ...
        <div class="content px-4">
            ...
            <section class="content-header" style="padding-top: 0">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">YARN PURCHASE INDENT -</div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single" id="pi_appl_status" name="pi_appl_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="0" selected>REQ. PENDING</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control h-200" id="mgmt_appl_remarks" name="mgmt_appl_remarks" placeholder="Auto Update"><?php echo $requestData["mgmt_appl_remarks"]?></textarea>
                            </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/fabric/mgmt/yarnmgmtpiapprovaldetails.js"></script>
