...
<body class="hold-transition layout-top-nav">
        ...
        <div class="content px-4">
            ...
            <div class="row px-4 mb-4 mt-5">
                <div class="col-sm-2">
                    <div class="form-group row">
                        <div class="col-sm-12 dis-flx-cen">
                            <input type="radio" id="sample" name="purchase_req_type" value="sample" class="cus-radio-btn">
                ...
                <div class="col-sm-2">
                    <div class="form-group row">
                        <div class="col-sm-12 dis-flx-cen">
                            <input type="radio" id="bulk" name="purchase_req_type" value="bulk" class="cus-radio-btn">
                ...
                <div class="col-sm-2">
                    <div class="form-group row">
                        <div class="col-sm-12 dis-flx-cen">
                            <input type="radio" id="revised" name="purchase_req_type" value="revised" class="cus-radio-btn">
                            <label for="revised" class="mb-0 f-14"> Revised Qty. </label>
                        </div>
                    </div>
                </div>                
                <div class="col-sm-2">
                    <div class="form-group row">
                        <div class="col-sm-12 dis-flx-cen">
                            <input type="radio" id="shortage" name="purchase_req_type" value="shortage" class="cus-radio-btn">
            ...
            <div class="card border-0">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">YARN PROGRAMME REQUIREMENT DETAILS (CONSOLIDATED) <span id="qty_type"></span></div>
                </div>
                <div id="yarnRequest"></div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="cutoff_date" name="cutoff_date" class="form-control mgmt" placeholder="Free Select" value="<?php echo $requestData["cutoff_date"]?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea id="merchant_note" name="merchant_note" class="form-control h-90 mgmt" placeholder="Free Text"><?php echo $requestData["merchant_note"]?></textarea>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single" id="auth_status" readonly> 
                                    <option value="" disabled hidden>Select</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single" id="auth_type">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="REGULAR" <?php if($requestData['req_type']=="REGULAR") echo "selected=\"selected\""; ?> >REGULAR</option>
                                    <option value="PRIORITY" <?php if($requestData['req_type']=="PRIORITY") echo "selected=\"selected\""; ?> >PRIORITY</option>
                                    <option value="HIGH PRIORITY" <?php if($requestData['req_type']=="HIGH PRIORITY") echo "selected=\"selected\""; ?> >HIGH PRIORITY</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="mgmt_remark" name="mgmt_remark" autocomplete="off" value="" placeholder="Free Text">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-form-label text-sm-right pr-0">
                                <label for="id-form-field-focus-1" class="mb-0">
                                    <span class="mandatory">*</span>Assigned FABRIC Queue No.
                                </label>
                            </div>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-form-label text-sm-right pr-0">
                                <label for="id-form-field-focus-1" class="mb-0">
                                    <span class="mandatory">*</span>FABRIC Dept. Remarks
                                </label>
                            </div>
                            <div class="col-sm-8">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/yarn/merchant/requestSentList.js"></script>
    ...
    <script>
        ...
        function updateFunction() {
            ...
            let request = $.ajax({
                type: "POST",
                url: base_path + 'request/Fabricrequest/updateMgmtAuthorization',
                data: dataform,
                processData: false,
                contentType: false,
                cache: false,
