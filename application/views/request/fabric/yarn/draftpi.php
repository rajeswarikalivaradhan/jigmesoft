...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  class="form-control date mgmt" readonly placeholder="Free Select" value="<?php echo $requestData["contactname"]?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-4 col-form-label text-sm-right pr-0">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control cutoff-date" id="pi_cutoff_dt" name="pi_cutoff_dt">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-4 col-form-label text-sm-right pr-0">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control h-200 mgmt" placeholder="Auto Update"></textarea>
                            </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/fabric/yarn/draftpi.js"></script>
