...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4">
            ...
            <ul class="nav nav-pills main-head pt-2 px-3">
                <li class="active upper-case"><a data-toggle="tab" href="#yarn">Yarn</a></li>
                <li class="upper-case"><a data-toggle="tab" href="#1knitting">Knitting</a></li>
                <li class="upper-case"><a data-toggle="tab" href="#1dyeing">Dyeing</a></li>
                <li class="upper-case"><a data-toggle="tab" href="#1compacting">Compacting</a></li>
                <li class="upper-case"><a data-toggle="tab" href="#1lab">Lab</a></li>
            </ul>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">YARN P.I. DETAILS</div>
                </div>
                <div id="yarnpidetails"></div>
            </div>

            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">YARN IN-HOUSE DETAILS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">YARN ITEM ACCEPTANCE STATUS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">YARN IN-HOUSE CONSOLIDATED QTY.</div>
                </div>
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="5" id="dep_remarks" name="dep_remarks" class="form-control h-90" placeholder="Auto Update"><?php echo $requestData['dep_remarks'] ?></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-right pr-3 py-3">                
                        ...
                        <a class="btn btn-info btn-sm mr-4" href="<?php echo base_url(); ?>request/Fabricrequest/draftpi/<?php echo $enqEncode; ?>/reqId/<?php echo $reqEncode;?>">DRAFT P.I.</a>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/fabric/yarn/yarnrequest.js"></script>
