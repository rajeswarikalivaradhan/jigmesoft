...
<body class="hold-transition layout-top-nav">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <?php if($requestData['auth_status'] == 2 || $requestData['auth_status'] == '2' ) {
            ...
            <div class="card border-0 mar-t-3" id="fabDiv">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php if($requestData['auth_status'] == 2 || $requestData['auth_status'] == '2' ) { ?>
                                ...
                                <div class="col-sm-12">
                                    <select class="cus-sel form-control js-example-basic-single " id="fab_dept" name="fab_dept">
                                        <option value="" disabled hidden>Select</option>
                                        <option value="OUTSIDE VENDOR" <?php if($miDetails['fab_dept']=="OUTSIDE VENDOR") echo "selected=\"selected\""; ?> >OUTSIDE VENDOR</option>
                ...
                ?>
                    <div class="mb-3 pl-0 ml-2 text-royal-blue f-14 mb-1">
                        <span class="text-bold text-royal-blue">Sample Ref. No: <?php echo $key+1; ?> / P.O. No: </span><?php echo $value['po_enq_ref_id']; ?> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <select class="cus-sel form-control js-example-basic-single " id="bom_dept" name="bom_dept">
                                        <option value="" disabled hidden>Select</option>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single" id="req_type" name="req_type" <?php echo $disabled; ?> >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="cutoff_date" name="cutoff_date" class="form-control" readonly  value="<?php echo $requestData["cutoff_date"]?>" placeholder="Auto Update" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea id="merchant_note" name="merchant_note" class="form-control h-90" placeholder="Auto Update" <?php echo $readonly; ?>><?php echo $requestData["merchant_note"]?></textarea>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" id="auth_status" name="auth_status" value="3" />
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="auth_status1" name="auth_status1">
                                        <option value="" disabled hidden>Select</option>
                                    ...
                                    <input type="hidden" id="issued_type"  value="<?php echo $miDetails['issued_type'];?>" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="auth_by" name="auth_by" autocomplete="off" placeholder="Auto Update" value="<?php if(isset($requestData['auth_name'])) echo $requestData['auth_name'];  ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="mgmt_remark" name="mgmt_remark" autocomplete="off"  placeholder="Auto Update" value="<?php echo $requestData['mgmt_remark']; ?>">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/requestsent/samplelist.js"></script>
