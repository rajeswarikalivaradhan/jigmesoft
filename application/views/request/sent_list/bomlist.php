...
<body class="hold-transition layout-top-nav">
        ...
        <div class="content px-4">
            ...
            <div class="card border-0">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">BOM <?php echo $requesttypedata; ?> PURCHASE REQUEST <span id="qty_type"></span></div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">BOM <?php echo $requesttypedata; ?> P SOURCING DETAILS</div>
                </div>
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    ...
                    <?php // commented myself to include planning dept. condition if($_SESSION['UI']['usertype'] == 3 && $requestData[0]['mgmt_approval'] =="2") { ?>
                     <?php if(($_SESSION['UI']['usertype'] == 3 || $_SESSION['UI']['usertype'] == 15) && $requestData[0]['mgmt_approval'] =="2") { ?>
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="req_date" name="req_date" class="form-control mgmt" readonly value="" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea id="merchant_note" name="merchant_note" class="form-control h-90 " placeholder="Auto Update"></textarea>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="cutoff_date" name="cutoff_date" class="form-control date mgmt" placeholder="Select" value="">
                                <div class="herr" id="err_cutoff_date"></div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea id="merchant_note" name="merchant_note" class="form-control h-90 mgmt" placeholder="Auto Update"></textarea>
                                <div class="herr" id="err_merchant_note"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <?php if($_SESSION['UI']['usertype'] == 2 && $requestData[0]['auth_status']!="1") { ?>
                            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <?php if(($_SESSION['UI']['usertype'] == 2 && $requestData[0]['auth_status'] !="1") || (($_SESSION['UI']['usertype'] == 3 || $_SESSION['UI']['usertype'] == 15) && $requestData[0]['mgmt_approval'] =="2")) { ?>
    ...
    <script>
        ...
        var mgmt_approval = <?php echo $requestData[0]['mgmt_approval']; ?>;
       // var auth_status1 =<?php echo $requestData[0]['auth_status'] ?>;
    </script>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/requestsent/bomlist.js">
