...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="cus-sel form-control js-example-basic-single edit mgmt" id="req_type" name="req_type" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="req_date" name="req_date" class="form-control mgmt" value="" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="cutoff_date" name="cutoff_date" class="form-control date edit mgmt" placeholder="Auto Update" value="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea id="merchant_note" name="merchant_note" class="form-control h-90 edit mgmt" placeholder="Auto Update"></textarea>
                ...
                <?php if($requestData['auth_status'] == 2) { ?>
                <div class="row">
                    <div class="col-12 pr-3 pt-3">
                        <label class="cus-label"> Attachment </label>
                        
                            <div id="reqCADImageUpload" class="pdt10"></div>
                ...
                <div class="row">
                    <div class="row">
                        <ul class="upload-list-view ImageViews" style="list-style: none;">
                        </ul>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/requestsent/cadlist.js"></script>
