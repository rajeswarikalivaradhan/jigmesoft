...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="qa_queue_no" name="qa_queue_no" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="qa_assign_dt" name="qa_assign_dt" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="5" id="qa_dept_remarks" name="qa_dept_remarks" class="form-control h-90" placeholder="Free Text"></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-right pr-3 py-3">                
                        <!-- <a class="btn btn-info btn-sm mar-l-5rem" id="qa_req" href="<?php echo base_url(); ?>request/Cadrequest/qarequestCad/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>/cadId/<?php echo urlencode(base64_encode($cadId)) ?>">Q.A STATUS</a> -->
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/cad/qaqueuelist.js"></script>
