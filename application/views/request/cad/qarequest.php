...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="qa_req_date" name="qa_req_date" autocomplete="off" value="<?php echo $requestData['qa_req_date']; ?>" placeholder="Auto Update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control cutoff-date" id="qa_cutoff_date" name="qa_cutoff_date" autocomplete="off" value="<?php echo $requestData['qa_cutoff_date']; ?>" placeholder="Select">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">                                
                                <textarea id="dep_note" name="dep_note" class="form-control h-140" placeholder="Free Text"><?php echo $requestData['dep_note']; ?></textarea>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="qa_req_status" name="qa_req_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="0" <?php if($requestData['qa_req_status']=="0" || $requestData['qa_req_status']=="") echo "selected=\"selected\""; ?>>PENDING</option>
                                    <option value="1" <?php if($requestData['qa_req_status']=="1") echo "selected=\"selected\""; ?>>ACCEPTED</option>
                                    <option value="2" <?php if($requestData['qa_req_status']=="2") echo "selected=\"selected\""; ?>>DECLINED</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="5" id="qa_dept_remarks" name="qa_dept_remarks" class="form-control h-90 mgmt" placeholder="Auto Update"><?php echo $requestData['qa_dept_remarks']; ?></textarea>
                                <div class="herr" id="err_qa_dep_remarks"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <!-- <div class="col-12 pr-3 pt-3">
                        <label class="cus-label"> Mercahnt Attachment </label>
                    </div>
                    ...
                    <div class="row">
                        <div id="cadReqImageUpload" class="pdt10"></div>
                    </div>
    ...
    <script>
        ...
        var checkid = "<?php echo implode(',', $checkboxid); ?>"
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/cad/qarequest.js"></script>
