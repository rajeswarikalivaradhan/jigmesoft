...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">                                
                                <textarea id="dep_note" name="dep_note" class="form-control h-140 mgmt" placeholder="Free Text"><?php echo $requestData['dep_note']; ?></textarea>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/cad/cadsentdetails.js"></script>
