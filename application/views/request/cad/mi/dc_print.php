...
<table width="100%"  class="table">
  ...
  <tbody >
    ...
    <tr >
      ...
      <td align="left"style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px"><?php echo $r['po_no'];?></td>
      <td align="left" style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px"><?php echo $r['combo'];?></td>
      <td align="left" style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px"><?php echo $r['component'];?></td>
      <td align="left" style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px" ><?php echo $r['spec_code'];?></td>
      <td align="left" style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px" ><?php echo $r['cad_ref_no'];?></td>
      <td align="left" style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px" ><?php echo $item[$item_issued];?></td>
      <td align="left" style="padding-left: 4px;padding-bottom: 5px;padding-top: 5px" ><?php echo $r['issued_size'];?></td>
      <td align="right" style="padding-right: 4px;padding-bottom: 5px;padding-top: 5px"><?php echo $r['parts_issued'];?></td>
    </tr>
...
<table width="100%" style="border-collapse: collapse; border: none; border-right: 1px solid black; border-left: 1px solid black;">
  ...
  <tr>
    ...
    <td width="30%" height="30" align="right" style="font-size: 12px; padding-top: 10px; padding-bottom: 10px;padding-right: 5px">
      For<b style="padding-left: 3px"> Azibo Infotech Private Limited</b>
    </td>
  </tr>
</table>
...
<table width="100%" height="50"  style="border-collapse:collapse;border-bottom:1px solid; solid black;border-right:1px solid black;border-left:1px solid black;">
 <tr>
          <td width="100" height="5" align="left" style="font-size:12px;padding-left: 20px;"><?php echo @$ArrCommonHeaderData['merchantName'] ?></td>
          <td width="100" height="5" align="left" style="font-size:12px;"><?php echo @$ArrCommonHeaderData['ArrMgmt']['contactname'] ?></td>
          <td width="100" height="5" align="left" style="font-size:12px;"><?php echo $miDetails['material_received_by']; ?></td>
          <td width="170" height="5" align="right"></td>
        </tr>

        <tr>
          <td width="100" height="5" align="left" style="font-size:12px;padding-left: 20px"><b>M.I. Raised by</b></td>
          <td width="100" height="5" align="left" style="font-size:12px;"><b>M.I. Authorized by</b></td>
          <td width="100" height="5" align="left" style="font-size:12px;"><b>Material Received by</b></td>
          <td width="170" height="5" align="right" style="font-size:12px;padding-right: 5px;">Authorized Signatory</td>
             </tr>
        </table>
