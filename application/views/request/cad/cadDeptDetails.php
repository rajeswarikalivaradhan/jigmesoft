...
<body class="hold-transition layout-top-nav">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="auth_status" name="auth_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="0" <?php if($requestData['mgmt_approval']=="0") echo "selected=\"selected\""; ?>>PENDING</option>
                                    <option value="3" <?php if($requestData['mgmt_approval']=="3") echo "selected=\"selected\""; ?>>PENDING-RR</option>
                                    <option value="1" <?php if($requestData['mgmt_approval']=="1") echo "selected=\"selected\""; ?>>AUTHORIZED</option>
                                    <option value="2" <?php if($requestData['mgmt_approval']=="2") echo "selected=\"selected\""; ?>>DECLINED</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="auth_type" name="auth_type" autocomplete="off" placeholder="Auto Update" value="<?php echo $requestData['auth_type']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control mgmt" id="auth_by" name="auth_by" autocomplete="off" placeholder="Auto Update" value="<?php echo $requestData['auth_name']; ?>">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="cus-sel form-control js-example-basic-single" id="req_status" name="req_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="0" <?php if($requestData['deprt_approval']=="0") echo "selected=\"selected\""; ?>>PENDING</option>
                                    <option value="1" <?php if($requestData['deprt_approval']=="1") echo "selected=\"selected\""; ?>>ACCEPTED</option>
                                </select>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/cad/cadDeptDetails.js"></script>
