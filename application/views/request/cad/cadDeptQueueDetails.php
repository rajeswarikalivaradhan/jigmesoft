...
<!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jspreadsheet-ce@4.10.1/dist/jspreadsheet.css" />
<script src="https://cdn.jsdelivr.net/npm/jspreadsheet-ce@4.10.1/dist/jspreadsheet.js"></script> -->
...
td.jexcel_dropdown select option:disabled {
    color: #999;  /* Gray color for disabled options */
    background-color: #f0f0f0;  /* Optional: change background */
}
</style>
...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="req_status" name="req_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="1" <?php if($requestData['req_status']=="0") echo "selected=\"selected\""; ?>>PENDING</option>
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-right pr-3 py-3">
                        <!-- <?php if(sizeof($qaStatus) > 0 &&  sizeof($jobqaStatus) > 0) { ?>

                            <a class="btn btn-info btn-sm mar-l-5rem" href="<?php echo base_url(); ?>request/Cadrequest/qarequest/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>">CAD Q.A REQUEST</a>
                        <?php } else { ?>
                            <a class="btn btn-info btn-sm mar-l-5rem" disabled>CAD Q.A REQUEST</a>
                            
                        <?php } ?> -->


                          <?php if (sizeof($jobreqstatus) > 0) { ?>
                             <!-- <a class="btn btn-info btn-sm mar-l-5rem" href="<?php echo base_url(); ?>request/Cadrequest/qarequest/<?php echo urlencode(base64_encode($VarEnqId)) ?>/reqId/<?php echo urlencode(base64_encode($reqId)) ?>">CAD Q.A REQUEST</a>
                      -->

                            <a class="btn btn-info btn-sm mar-l-5rem"  id="cad_qa_req" >CAD Q.A REQUEST</a>
                        <?php } else { ?>
                            <a class="btn btn-info btn-sm mar-l-5rem" disabled>CAD Q.A REQUEST</a>
                        ...
                        <?php if(sizeof($qaCompStatus) > 0) { ?>
                            <a class="btn btn-info btn-sm mar-l-5rem" id="qaCompleted">JOB COMPLETED</a>
                        <?php } else { ?>
                            <a class="btn btn-info btn-sm mar-l-5rem" disabled>JOB COMPLETED</a>
                        <?php } ?>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/cad/cadDeptQueueDetails.js"></script>
