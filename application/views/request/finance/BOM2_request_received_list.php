...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top:110px">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM (A2) REQUEST RECEIVED LIST - PAYMENTS</b></span>
                                     ...
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Brand</th>
                                         ...
                                         <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">Request For</th>
                                        <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Requirement</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;" >Vendor Name</th>
                                         <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">P.I Ref. No</th>
                                         <th width="11%" class="theadstyle" style=" padding: 0px 12px!important;">Pay by Date & Time</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 12px!important;">Pay by Date & Time</th>
                            ...
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="4">Item Description</th>
                                        <th id="5">Vendor Name</th>
                                        <th id="6">P.I. Ref. No.</th>
                                        <th id="7">P.I. Date. Time.</th>
                                        <th id="8">Pay by Date</th>
...
<script src="<?php echo base_url();?>assets/custom/request/finance/Bom2_request_received_list.js"></script>
