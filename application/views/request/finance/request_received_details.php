...
<body class="hold-transition layout-top-nav">
            ...
            <section class="content-header" style="padding-top: 0">
                <div class="card-header pb-3 bgc-white border-0 " style="padding-top: 35px;">
                    <div class="card-title f-20">
                        <b style="font-size: 20px !important; padding-left: 5px; margin-left: 3px;color: #333">BOM <?php echo $requesttypedata ?> PURCHASE INDENT - PAYMENT REQUEST RECEIVED - </b> <b style="font-size: 20px !important;" id="mode"></b>
                    </div>
                </div>
           ...
           <?php echo $subcompany_datas['state'];?>, <?php echo $subcompany_datas['country'];?>
            ...
            <div class="card border-0 mar-t-3">
                ...
                <div class="col-12 text-right pr-3 py-3">          
                        <a class="btn btn-info btn-sm mar-l-5rem" id="saveCredit">SAVE</a>
                </div>
            </div>
            ...
            <div class="card border-0 mar-t-3">
                ...
                <div class="col-12 text-right pr-3 py-3">          
                        <a class="btn btn-info btn-sm mar-l-5rem" id="savePayment">SAVE</a>
                </div>
            </div>
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    ...
                    <div class="col-12 text-right pr-3 py-3">                
                        <a class="btn btn-info btn-sm mar-l-5rem" id="billClosed">BILL CLOSED</a>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/finance/request_received_details.js"></script>
