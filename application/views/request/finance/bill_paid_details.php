...
<body class="hold-transition layout-top-nav">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-md-3">
                            <h5 class="text-center">
                                <p><?php echo $ArrCommonHeaderData['companyName']; ?></p>
                            </h5>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/finance/bill_paid_details.js"></script>
