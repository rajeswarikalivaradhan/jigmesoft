...
<body class="hold-transition layout-top-nav">
        ...
        <div class="content px-4">
            ...
            <div class="card border-0">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500"><?php echo $requestDataS; ?> PURCHASE REQUEST <span id="qty_type"></span></div>
                </div>
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                ...
                <div class="row">
                    <div class="col-12 pr-3 py-3">
                        <label class="cus-label"> Merchant Attachment1 </label>
                    </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/dept_approval.js"></script>
