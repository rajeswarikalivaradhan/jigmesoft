...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        <?php $this->load->view(CNFCOMPANY . 'template/templateheader'); ?>
         <?php $reqDate = $requestData["type"];
        
        $requestDataS;
            if ($reqDate == 3) {
                  $requestDataS = "BOM (Art - 1)";
            } elseif ($reqDate == 4) {
                 $requestDataS = "BOM (Art - 2)";
              }
        ...
        <div class="content px-4">
            ...
            <div class="card border-0">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500"><?php echo $requestDataS; ?> PURCHASE REQUEST ( <span id="requirement"></span> )</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500"><?php echo $requestDataS; ?> SOURCING DETAILS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500"><?php echo $requestDataS; ?> P.I. DETAILS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500"><?php echo $requestDataS; ?> IN-HOUSE STATUS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500"><?php echo $requestDataS; ?> ITEM ACCEPTANCE STATUS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500"><?php echo $requestDataS; ?> IN-HOUSE CONSOLIDATED QTY.</div>
                </div>
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="auth_status" name="auth_status">
                                    ...
                                    <option value="3" <?php if($requestData['auth_status']=="3") echo "selected=\"selected\""; ?>>RR-PENDING</option>
                                    <option value="1" <?php if($requestData['auth_status']=="1") echo "selected=\"selected\""; ?>>ACCEPTED</option>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <?php // echo $requestData['req_status']; exit; ?>
                            <div class="col-sm-8">
                                ...
                                <select class="cus-sel form-control js-example-basic-single mgmt" id="req_status" name="req_status">
                                    <option value="" disabled hidden>Select</option>
                                    <option value="0" <?php if($requestData['request_status']=="0" || $requestData['request_status']=="") echo "selected=\"selected\""; ?>>PENDING</option>
                                    <option value="1" <?php if($requestData['request_status']=="1") echo "selected=\"selected\""; ?>>ACCEPTED</option>
                                    <option value="2" <?php if($requestData['request_status']=="2") echo "selected=\"selected\""; ?>>DECLINED</option>
                                </select>
                ...
                <div class="row">
                    ...
                    <?php if($draft_status == 1) { ?>
                        <a class="btn btn-info btn-sm mr-3" href="<?php echo base_url(); ?>request/Bomrequest/draftpi/<?php echo urlencode(base64_encode($VarEnqId)); ?>/reqId/<?php echo urlencode(base64_encode($request_id)); ?>">VIEW DRAFT P.I.</a>
                    <?php }   else { ?>
                        <a class="btn btn-info btn-sm mr-3" href="<?php echo base_url(); ?>request/Bomrequest/draftpi/<?php echo urlencode(base64_encode($VarEnqId)); ?>/reqId/<?php echo urlencode(base64_encode($request_id)); ?>">DRAFT P.I.</a>
                    <?php  }    ?>       
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/purchase_queue_details.js"></script>
