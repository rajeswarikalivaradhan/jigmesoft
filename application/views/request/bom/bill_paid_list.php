...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BILL PAID LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Invoice No.</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Invoice date</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 12px!important;">Invoice date</th>
                                         <th width="10%" class="theadstyle"  style=" padding: 0px 12px!important;">Current status</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="current_status"  id="current_status" placeholder="Free Text">
                                            </td>
...
<script src="<?php echo base_url();?>assets/custom/request/bom/bill_paid_list.js"></script>
