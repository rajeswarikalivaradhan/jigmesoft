...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;padding-top:110px">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM (A1) PURCHASE INDENT - SUPPLY CLOSURE LIST</b></span>
            ...
            <div class="col-sm-12 p-0" >
                <div class=" px-4 w-90" style="margin-left: 2px; width: 99.8%;">
                        <!-- <div class="col-sm-12 px-4" style="border-bottom: 2px solid #022B61;"></div> -->
                </div>
                </div>
                                     ...
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >Vendor Name</th>
                                          ...
                                          <th width="13%" class="theadstyle" style=" padding: 0px 15px!important;">P.I. Date of Time</th>
                                        
                                        <th width="12%" class="theadstyle" style=" padding: 0px 12px!important;">P.I. Date of Time</th>
...
<script src="<?php echo base_url();?>assets/custom/request/bom/store/supply_closure_list_BOM1.js"></script>
