...
<div class="wrapper">
    ...
    <div class="content-wrapper" style="background-color: #ffffff">
        ...
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">D.C. LIST - BOM STORE</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >M.I. Ref No</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 12px!important;">Cutoff Date & Time</th>
                                         <th width="10%" class="theadstyle"  style=" padding: 0px 12px!important;">Cutoff Date & Time</th>
                                         <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">D.C. No</th>
                                         <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">D.C. Date & Time</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">D.C. Date & Time</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="mi_ref_no"  id="mi_ref_no" placeholder="Free Text">
                                            </td>
                                           ...
                                           <td>
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="dcno"  id="dcno" placeholder="Free Text">
                                            </td>
											 <td>
                        ...
                        <div class="box-body no-padding">
                            <table id="mCadQueueList" class="table table-bordered" data-page-length="50">
                                ...
                                <tr>
                                    ...
                                    <th>Requirement </th>
                                    <th>M. I. Ref. No. </th>
                                    <th>Requirement <br />Date & Time</th>
                                    <th>Cutoff <br />Date & Time</th>
                                    <th>D.C. No. </th>
                                    <th>D.C. <br />Date & Time</th>
                                    <th>Material Issued <br /> to Dept. / Vendor </th>
                                    <th>Material Received <br /> Status </th>
...
<script src="<?php echo base_url();?>assets/custom/request/bom/store/dclist.js"></script>
