...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4">
            ...
            <!--            <?php } ?>-->
            <!--            <a class="btn btn-info btn-sm mar-l-5rem" id="status_update">SAVE</a>-->
            <!--        </div>-->
            <!--    </div>-->
            <!--</form>-->
    ...
    <script>
        ...
        var itemCodess = <?php echo $itemCode; ?>;
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/store/supply_closure_details.js"></script>
