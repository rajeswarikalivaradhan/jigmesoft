...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4" style="padding-top: 0px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--    <div class="box-body">-->
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php echo @$itemDetails['mi_ref_no'];?>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label bg-g">Item Recd. Status:</label>
                                                <div class="col-md-3 col-sm-3 pr-2 pt-2">
                                                    <?php 
                                                        if($itemDetails['item_received_status']=="0") echo "PENDING"; 
                                                        else if($itemDetails['item_received_status']=="1") echo "RECEIVED"; 
                                                        else if($itemDetails['item_received_status']=="2") echo "DISCREPANCY"; 
                                                        // else if($itemDetails['item_received_status']=="3") echo "MISSING"; 
                                                    ?>
                                                    <p class="mb-0 no-web"><?php echo @$itemDetails['item_sta_upt_dt']; ?></p>
                                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <br/>
                                    <div class="h-60" id="dcNoHere">
                                        <p class="dc-name" id="material_received_by"><?php echo @$itemDetails['received_name']; ?></p>
                                    </div>
        ...
        <a type="button" class="btn btn-info"
           href="<?php echo base_url(); ?>company/Mstoreuser/dclist">
           Back
        </a>
      </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/store/bomdcdetails.js">
