...
<!-- 
            ...
            <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px; " >          
                       ...
                       <div>
        <form method="post" action="<?php echo base_url();?>request/Bomrequest/storepurchaseindentdetails_print">
      ...
      <!-- 3️⃣ Generate Button -->
      <div>
        <form method="post" action="<?php echo base_url();?>request/Bomrequest/storepurchaseindentdetails_pdf">
           <input type="hidden" name="VarEnqId" value="<?php echo $VarEnqId; ?>">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/store/purchase_indent_details.js"></script>
