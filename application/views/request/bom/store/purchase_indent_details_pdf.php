...
$first_part = array_slice($parts, 0, 6);
            ...
            <table class="table" width="100%"  >
                                        <tbody>
                                          <tr>
                                             ...
                                             <tr>
                                                <td class="process-title" style="width: 28% !important;">Purchase  Type</td>
                                                 <td class="process-valuemid">:</td>
 ...
 <?php if (!empty($newpurchase_data['withinStateDetails'])): ?>
    ...
    <?php foreach ($newpurchase_data['withinStateDetails'] as $row):    
       ...
       <tr width="100%">
            ...
            <td style="text-align:center ;text-align:left !important; padding:4px !important;" ><?php echo htmlspecialchars($row[8]); ?></td>
...
<?php endif; ?>
 ...
 <table width="100%" border="0" align="center" style="table-layout: fixed;border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;table-layout: fixed;">
       <tr >
  <td width="71%"  align="right" style="border-bottom: 1px dotted black;padding-bottom: 5px;padding-top:5px;"><strong> Total:</strong> </td>
          
          
          <td  width="9%" align="right" style="border-bottom: 1px dotted black;padding-right:5px;padding-bottom: 5px;padding-top:5px;"><strong><?php echo number_format($tot_amt,2); ?></strong></td>
          <td width="5%"   style="border-bottom: 1px dotted black;"></td>

          <td  width="6%" style="border-bottom: 1px dotted black;"></td>
          
          <td  width="9%" align="right" style="border-bottom: 1px dotted black;padding-right:4px;padding-bottom: 5px;padding-top:5px;"><strong><?php echo number_format($all_tot,2); ?></strong></td>
