...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="col-md-6">
                <h1 style="margin: 0; font-size: 20px; font-weight: 600">BOM - NEW ITEM LIST</h1>
            </div>
...
<script src="<?php echo base_url();?>assets/custom/request/bom/store/newitemlist.js"></script>
<script>
