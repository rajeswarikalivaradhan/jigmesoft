...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4" id="pi_requirementDetails">
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">BOM (Art - 1) IN-HOUSE DETAILS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">BOM (Art - 1) IN-HOUSE CONSOLIDATED QTY.</div>
                </div>
                <div id="inHouseConsolidatedQty"></div>
            </div>


            <!-- <div class="box-footer boxFooter_pd1025" class="btn btn-default">
                <button type="submit" class="btn btn-info pull-right" id="submitPIDetails">SAVE </button>
                <button type="submit" class="btn btn-primary pull-right">BOM ORDER STOCK LIST </button>
            </div> -->
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/store/pi_ref_details.js">
