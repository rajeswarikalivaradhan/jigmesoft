...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top:110px">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM - SURPLUS STOCK LIST</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >Garment Size</th>
                                        
                                        
                                         <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Item Code</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">Item Colour Code</th>
                                         <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;">P.I. Ref. No.</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="itemdescription"  id="itemdescription" placeholder="Free Text">
                                            </td>
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="GarmentSize"  id="GarmentSize" placeholder="Free Text">
                                            </td>
                                            
                                           
                                            
											<td>
                                                <input class="input-sm form-control  mt-2" name="itemcode"  id="itemcode" placeholder="Free Text">
                                            </td>
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="itemcolourcode"  id="itemcolourcode" placeholder="Free Text">
                                            </td>
                                            <td>
                            ...
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="5">Garment<br> Size</th>
                                        <th id="6">Item Code</th>
                                        <th id="7">Item Colour<br> Code</th>
                                        <th id="8">Size / Dim.<br> (L*W*H)</th>
                                        <th id="10">UOM</th>
                                        <th id="9">Available Qty.</th>
                                        <th id="10">UOM</th>
                                        <th id="11">P.I.Ref.No.</th>
                                        <th id="12">Cuttoff Date & Time</th>
                                        <th id="12">P.I.Status</th>
...
<script src="<?php echo base_url();?>assets/custom/request/bom/store/surplusstocklist.js"></script>
