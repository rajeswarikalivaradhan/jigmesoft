...
<?php endif; ?>
  ...
  <table width="100%" border="0"  height="30" align="center" style="table-layout: fixed; border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;padding-bottom: 1px;">
        <tr >
 <td width="71%"  align="right" style="border-bottom: 1px dotted black;"><strong> Total:</strong> </td>
          
          
          <td  width="10%" align="right" style="border-bottom: 1px dotted black;"><strong><?php echo number_format($tot_amt,2); ?></strong></td>
...
<table width="100%" style="border-collapse: collapse; border: none; border-right: 1px solid black; border-left: 1px solid black;">
  <tr>
    <td width="13%" height="20" style="padding-top: 13px; padding-left:5px ">
      <b>&nbsp;&nbsp;Amount In Words:</b>
    </td>
  ...
  <tr>
    <td width="13%" height="30" style=" padding-top: 1px; padding-bottom: 10px;padding-left:5px">
      <b>&nbsp;&nbsp;Payment Terms:</b>
    </td>
...
<table width="100%" height="50"  style="border-collapse:collapse;border-bottom:1px solid; solid black;border-right:1px solid black;border-left:1px solid black;">
 <tr>
          <td width="50" height="10" align="left" style="padding-left:10px"><?php echo $company_data['merchantName']; ?></td>
          <td width="50" height="10" align="left" style="padding-left:60px;"><?php echo $company_data['ArrMgmt']['contactname']; ?></td>
          
          <td width="50" height="10" align="left" style="padding-right:80px"><?php echo $company_data['merchantName']; ?></td>
        ...
        <tr>
          ...
          <td width="50" height="10" align="left" style="padding-left:60px;"><b>Request Authorized By</b></td>
           <td width="50" height="10" align="left" style="padding-right:80px" ><b>P.I. Approved By</b></td>
