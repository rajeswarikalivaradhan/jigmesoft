...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top:110px">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM (A1) - ORDER STOCK LIST</b></span>
            ...
            <div class="col-sm-12 p-0" >
                <div class=" px-4 w-90" style="margin-left: 3px; width: 99.7%;">
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >Item Description</th>
                                          <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Item Code</th>
                                          <th width="13%" class="theadstyle" style=" padding: 0px 15px!important;">Item Colour Code</th>
                                        
                                        <th width="12%" class="theadstyle" style=" padding: 0px 12px!important;">Available Qty.</th>
                                        
                                          <th width="11%" class="theadstyle" style=" padding: 0px 12px!important;">Available Qty.</th>
                                        
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">M.I Status</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="item_description"  id="item_description" placeholder="Free Text">
                                            </td>
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="item_code"  id="item_code" placeholder="Free Text">
                                            </td>
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="item_colour_code"  id="item_colour_code" placeholder="Free Text">
                                            </td>
                                            
                                            
                                            
                                                 <td>
                                                <input class="input-sm form-control  mt-2" placeholder="Min" name="available_qty_min"  id="available_qty_min" placeholder="Free Text">
                                            </td>
                                            
                                            <td>
                                                <input class="input-sm form-control  mt-2" placeholder="Max" name="available_qty_max"  id="available_qty_max" placeholder="Free Text">
                                            </td>
                                            <td>
                                                <input class="input-sm form-control  mt-2" name="mi_status"  id="mi_status" placeholder="Free Text">
                                            </td>
                        ...
                        <div class="box-body no-padding">
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th id="0"style='width:10%' >WIP Ref. No. </th>
                                        <th id="1" style='width:10%' >Brand</th>
                                        <th id="2" style='width:13%' >Item <br /> Description</th>
                                        <!--<th id="3">Blend (%) / Content <br /> / Material</th>-->
                                        <th id="2" style='width:6%' >Garment <br /> Size</th>
                                        <th id="2" style='width:10%' >Item Code</th>
                                        <th id="5" style='width:10%' >Item Colour <br /> Code</th>
                                       
                                        <th id="3" style='width:8%' >Available<br>Qty.</th>
                                        <th id="3" style='width:6%' >UOM</th>
                                        <!--<th id="3">M.I. Ref. No.</th>-->
                                        <!--<th id="3">Cutoff <br> Date & Time</th>-->
                                        <th id="3" style='width:11%'>M.I. Status</th>
                                        <!--<th id="11">Current <br /> Status</th>-->
                                        <th id="9" style='width:12%'>Recent <br />Update </th>
                                        <th id="10" style='width:6%'>Status</th>    
                                    </tr>
                                </thead>
                            </table>
                        </div><!-- /.box-body -->
...
<script src="<?php echo base_url();?>assets/custom/request/bom/store/itemListBOM1.js"></script>
