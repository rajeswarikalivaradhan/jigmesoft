...
<body class="hold-transition layout-top-nav">
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    <div class="col-12 text-right pr-3 py-3">                
                        <a class="btn btn-info btn-sm mar-l-5rem">BOM New Iitem List</a>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/store/edit_pi_details.js">
