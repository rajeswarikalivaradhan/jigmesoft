...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top:110px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM - MATERIAL INDENT ISSUED LIST</b></span>
                                     ...
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="10%" class="theadstyle" style=" padding: 0px 15px!important;" >Requirement</th>
                                          <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">M.I. Ref. No.</th>
                                          <th width="13%" class="theadstyle" style=" padding: 0px 15px!important;">Req. Date of Time</th>
                                        
                                        <th width="12%" class="theadstyle" style=" padding: 0px 12px!important;">Req. Date of Time</th>
                            ...
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="2">Cutoff <br />Date & Time</th>
                                        <!--<th id="5">M.I. Raised By</th>-->
                                        <th id="3">Authorization <br/>Type</th>
                                        <th id="3">Authorization By</th>
...
<script src="<?php echo base_url();?>assets/custom/request/bom/store/mi_received_list.js"></script>
<script src="<?php echo base_url();?>assets/custom/request/bom/store/mi_pending_list.js"></script>
