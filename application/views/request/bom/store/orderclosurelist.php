...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px;padding-top:110px">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">BOM - ORDER CLOSURE LIST</b></span>
            ...
            <div class="col-sm-12 p-0" >
                <div class=" px-4 w-90" style="margin-left: 3px; width: 99.6%;">
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr >
                                        ...
                                        <th width="12%" class="theadstyle" style=" padding: 0px 15px!important;">Item Description</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;" >Garment Size</th>
                                         <th width="11%" class="theadstyle" style=" padding: 0px 12px!important;">Item Code</th>
                                        <th width="10%" class="theadstyle" style=" padding: 0px 12px!important;">Item Colour Code</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">Balence Qty</th>
                                        <th width="11%" class="theadstyle" style=" padding: 0px 15px!important;">Balence Qty</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="12%">
                                             ...
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="item_desc"  id="item_desc" placeholder="Free Text">
                                            </td>
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="garment_size"  id="garment_size" placeholder="Free Text">
                                            </td>
                                             <td>
                                            ...
                                            <td>
                                              ...
                                              <td>
                                                <input class="input-sm form-control  mt-2" name="balence_qty_min"  id="balence_qty_min" placeholder="Min">
                                            </td>
                                             <td>
                                                <input class="input-sm form-control  mt-2" name="balence_qty_max"  id="balence_qty_max" placeholder="Max">
                                            </td>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="bomPurchaseReceivedListTbl" class="table table-bordered table-responsive table-hover" data-page-length="50">
                                <thead>
                                    <tr>
                                        <th></th>
                                        ...
                                        <th id="4" style='width:6%'>Garment <br /> Size</th>
                                        <th id="5" style='width:10%' >Item Code</th>
                                        <th id="6" style='width:10%' >Item Colour <br /> Code</th>
                                      
                                        <th id="9" style='width:8%'>Balance Qty.</th>
                                        <th id="10" style='width:6%' >UOM</th>
                                        <th id="11"style='width:11%'  >Current  <br /> Status</th>
                                        <th id="12"style='width:12%'  >Recent <br />Update </th>
                                       
                                        <th id="13" style='width:6%' >Status</th>
                                    </tr>
                                </thead>
                            </table>
                        </div><!-- /.box-body -->
...
<script src="<?php echo base_url();?>assets/custom/request/bom/store/orderclosurelist.js"></script>
