...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content px-4">
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">SHIPMENT ORDER CLOSURE DETAILS</div>
                </div>
            ...
            <form class="row no-rad-form add-form-mar mar-t-3" id="reqOrderProcessingForm">
                <div class="row">
                    <div class="col-12 text-right pr-3 py-3">                
                        <a class="btn btn-info btn-sm mar-l-5rem">BOM - SURPLUS STOCK LIST</a>
                        <a class="btn btn-info btn-sm mar-l-5rem">VIEW DRAFT D.C.</a>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/store/newitemdetails.js"></script>
