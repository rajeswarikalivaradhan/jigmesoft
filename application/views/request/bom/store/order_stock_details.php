...
<body class="hold-transition layout-top-nav">
        ...
        <div class="content px-4">
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">ITEM DETAILS</div>
                </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">ITEM IN-HOUSE QTY. DETAILS</div>
                </div>
                <div id="inHouseQty"></div>
            </div>

            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">MATERIAL INDENT RECEIVED DETAILS</div>
                </div>
                <div id="miIndentReceived"></div>
            </div>

            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">MATERIAL ISSUED DETAILS</div>
                </div>
                <div id="matrerialIssuedDetails"></div>
            </div>
            ...
            <div class="card border-0 mar-t-3">
                <div class="card-header p-3 border-0 bgc-white tbl-head mb-1">
                    <div class="card-title text-white f-14 text-500">LOT WISE OPENING & CLOSING STOCK DETAILS</div>
                </div>
                <div id="shipmentOrderClosure"></div>
            </div>
            <input type="hidden" id="draftMINo" name="draftMINo" value="<?php echo $draftMINo; ?>" >
            <form class="row no-rad-form add-form-mar mar-t-3 no-print" id="reqOrderProcessingForm">
                <div class="row">
                    <div class="col-12 text-right pr-3 py-3">    
                        <!--<a class="btn btn-info btn-sm mar-l-5rem" id="orderClose">BOM - ORDER CLOSURE LIST</a>-->
                        <?php if($draft_count > 0) { ?>
                            <!--<a id="draftLink" class="btn btn-info btn-sm mar-l-5rem">View Draft</a>-->
                        <?php } else { ?>
                            <!--<a class="btn btn-info btn-sm mar-l-5rem">DRAFT D.C.</a>-->
                        <?php } ?>
                        <a class="btn btn-info btn-sm mar-l-5rem" id="orderClose">SAVE</a>
                         <?php if($orderclosuredata > 0) { ?>
                        <a class="btn btn-info btn-sm mar-l-5rem" id="moverOrderClosure">MOVE - ORDER CLOSURE LIST</a>
                        <?php } else { ?> 
                        <a class="btn btn-info btn-sm mar-l-5rem" id="" disabled>MOVE - ORDER CLOSURE LIST</a>
                        <?php } ?>
                    </div>
                </div>
            </form>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/custom/request/bom/store/order_stock_details.js"></script>
