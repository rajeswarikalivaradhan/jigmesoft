...
<table width="100%" style="border-collapse: collapse; border: none; border-right: 1px solid black; border-left: 1px solid black;">
  ...
  <tr>
    ...
    <td width="100%" height="30" align="right" style="font-size: 12px; padding-top: 10px; padding-bottom: 10px;px;padding-right: 5px;">
...
<table width="100%" height="50"  style="border-collapse:collapse;border-bottom:1px solid; solid black;border-right:1px solid black;border-left:1px solid black;">
 <tr>
          <td width="50" height="15" align="left" style="padding-left: 20px"><?php echo @$ArrCommonHeaderData['merchantName']; ?></td>
          <td width="50" height="15" align="left" style=""><?php echo @$ArrCommonHeaderData['ArrMgmt']['contactname'] ?></td>
          
          <td width="50" height="15" align="left"><?php echo @$miDetails['received_name']; ?></td>
        <td width="50" height="15" align="right"></td>
        
        </tr>

        <tr>
            <td width="50" height="10" align="left" style="padding-left: 20px;px;padding-bottom: 5px" ><b>M.I. Raised by</b></td>
          <td width="50" height="10" align="left" style="padding-bottom: 5px" ><b>M.I. Authorized by</b></td>
          <td width="50" height="10" align="left" style="padding-bottom: 5px"><b>Material Received by</b></td>
          <td width="50" height="10" align="right" style="padding-right: 5px;px;padding-bottom: 5px">Authorized Signatory</td>
        </tr>
        </table>
