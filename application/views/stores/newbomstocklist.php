                        ...
                        <form class="form-horizontal" name="frmSearch" id="frmSearch" action="#">
                            <div class="box-body">
                                ...
                                <div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    ...
                                    <div class="form-group <?php if($VarUsertype == 3 || $VarUsertype == 15 || $VarUsertype == 8) echo ''; else echo 'hide' ?>">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="mBomNewStockList" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sortable asc" id="4">Garment Size<i class="fa fa-fw fa-sort"></i></th>
