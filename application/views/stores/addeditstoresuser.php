    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            ...
            <section class="content-header">
                <h1 class="firstHeading">Stores Dept. <?php if (empty($Edit) && !empty($VarId)) echo ''; else echo '- Add / Edit' ?></h1>
            </section>
        </div>
        <!-- Main content -->
                    ...
                    <div id="DivContBasicInfo">
                        <div class="box box-info">
                            ...
                            <div class="box-footer boxFooter_pd1025">
                                <a href="<?php echo base_url(CNFCOMPANY . 'mstoreuser/manage') ?>"
...
<script type="text/javascript">
    ...
    function fnSaveUserInfo() {
        try {
            ...
            $.ajax({
                url: base_path + GlbCompanyFdr + 'mstoreuser/updateUser',
    ...
    function fnSaveRes(data) {
        if (data != '') {
            if (data.errcode == '404') {
                ...
                fnRedirectPageTimeOut(base_path + GlbCompanyFdr + 'mstoreuser/addedit/' + data.eid);
            }
        }
    }
</script>
