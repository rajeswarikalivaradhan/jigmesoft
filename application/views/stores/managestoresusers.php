    ...
    <div class="content-wrapper">
        <div class="col-md-12">
            <section class="content-header">
                <h1 class="firstHeading">Stores Dept.<a class="btn btn-default addBtnDetails" href="<?php echo base_url( CNFCOMPANY ."mstoreuser/addedit") ?>"><i class="fa fa-plus" style="margin-right: 10px"></i>
                        ADD</a></h1>
            </section>
        </div>
...
<script src="<?php echo base_url(); ?>assets/js/stores/mstoreusers.js"></script>
