...
<div class="wrapper bgn-white">
    ...
    <div class="content-wrapper" style="background-color: white;">
        <div class="col-sm-12" style="display: block ; padding: 10px 25px">
            <span class="header-title bgn-white"><b style="font-size: 20px !important; font-family: Arial">BOM (A1) REQUEST SENT LIST</b></span>
