...
<div class="wrapper bgn-white">
    ...
    <div class="content-wrapper" style="background-color: white;">
        <div class="col-sm-12" style=" padding: 10px 25px;padding-top: 110px;">
                                     ...
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        ...
                                        <th width="12%" class="theadstyle" style="padding-left: 13px;">Brand</th>
                                         <th width="12%" class="theadstyle" style="padding-left: 13px;">Requirement</th>
                                         <th width="10%" class="theadstyle" style="padding-left: 13px;" >Req. Date  & Time</th>
                                        <th width="10%" class="theadstyle" style="padding-left: 13px;" >Req. Date  &  Time</th>
                                         <th width="10%" class="theadstyle" style="padding-left: 13px;" >Cutoff Date  &  Time</th>
                                        <th width="10%" class="theadstyle" style="padding-left: 13px;" >Cutoff Date  &  Time</th>
                                        <th width="12%" class="theadstyle" style="padding-left: 13px;">Current status</th>
...
<?php if($type == 'ALL') {  ?>
<script src="<?php echo base_url();?>assets/custom/requestsent/manageall.js"></script>
<?php } else if($type == 'CAD') { ?>
<script src="<?php echo base_url();?>assets/custom/requestsent/cad.js"></script>
<?php } else if($type == 'SAMPLE') { ?>
<script src="<?php echo base_url();?>assets/custom/requestsent/sample.js"></script>
<?php } else if($type == 'BOM1') { ?>
<script src="<?php echo base_url();?>assets/custom/requestsent/bom.js"></script>
