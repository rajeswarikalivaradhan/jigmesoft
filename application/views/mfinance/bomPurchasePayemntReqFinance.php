                ...
                <div class="col-md-12" id="divBasicInfo">
                    ...
                    <div class="box box-info">
                                    ...
                                    <td>
                                        <table class="table" id="fromto">
                                            ...
                                            <tr>
                                                <td>NAME</td>
                                                <td><?php
                                                    echo $ArrCompanyInfo[0]['ceoname'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>ADDRESS :</td>
                                            ...
                                            <tr>
                                                <td>GST No :</td>
                                                <td><?php //echo $ArrCompanyInfo[0]['gstno'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>IE CODE :</td>
                                                <td><?php //echo $ArrCompanyInfo[0]['iecode'] ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type='text' class="form-control" placeholder="Agreed Supply Date" id="agreedsupplydate"
                                                           value="<?php if (empty($ArrBasicInfo->agreedsupplydate)) echo '-'; else echo date('d-m-Y', strtotime($ArrBasicInfo->agreedsupplydate)) ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" id="frmBasicPaymentTerms"
                                                           value="<?php if (!empty($ArrBasicInfo->paymentterms)) echo $ArrBasicInfo->paymentterms ?>">
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="box-body">
                            ...
                            <form class="form-horizontal" action="#" name="frmBasicInfo" id="frmBasicInfo"
                                  method="post">
                                <div class="col-md-12">
                                    <?php
                                    if ($ArrBasicInfo->taxtype == 3) {
                                        ...
                                        <input type="text" style="position: relative; left: 784px; width: 100px"
                                               readonly id="frmBasicTotal"
                                               value="<?php if (!empty($ArrBasicInfo->amounttotal)) echo $ArrBasicInfo->amounttotal ?>">
                                        <input type="text" style="position:relative; left: 831px; width: 80px; "
                                               readonly id="frmBasicDutyvalueTotal"
                                               value="<?php if (!empty($ArrBasicInfo->dutytotal)) echo $ArrBasicInfo->dutytotal ?>">
                                        <input type="text" style="position:relative; left: 831px; width: 100px; "
                                               readonly id="frmBasicSubtotalTotal"
                                               value="<?php if (!empty($ArrBasicInfo->subtotal_total)) echo $ArrBasicInfo->subtotal_total ?>">
                                        <?php
                                    } elseif ($ArrBasicInfo->taxtype == 1) {
                                        ?>
                                        <label class="" style="position:relative; left: 670px">Total : </label>
                                        <div class="" style="position:relative; left: 685px; display: inline-block">
                                            &#8377;
                                        </div>
                                        <input type="text" style="position: relative; left: 713px; width: 100px"
                                               readonly id="frmBasicTotal"
                                               value="<?php if (!empty($ArrBasicInfo->amounttotal)) echo $ArrBasicInfo->amounttotal ?>">
                                        <input type="text" style="position:relative; left: 760px; width: 90px; "
                                               readonly id="frmBasicSgstTotal"
                                               value="<?php if (!empty($ArrBasicInfo->sgsttotal)) echo $ArrBasicInfo->sgsttotal ?>">
                                        <input type="text" style="position:relative; left: 808px; width: 90px; "
                                               readonly id="frmBasicCgstTotal"
                                               value="<?php if (!empty($ArrBasicInfo->cgsttotal)) echo $ArrBasicInfo->cgsttotal ?>">
                                        <input type="text" style="position:relative; left: 810px; width: 100px; "
                                               readonly id="frmBasicSubtotalTotal"
                                               value="<?php if (!empty($ArrBasicInfo->subtotal_total)) echo $ArrBasicInfo->subtotal_total ?>">
                                        <?php
                                    } elseif ($ArrBasicInfo->taxtype == 2) {
                                        ...
                                        <div class="" style="position:relative; left: 825px; display: inline-block">
                                            &#8377;
                                        </div>
                                        <input type="text" style="position: relative; left: 835px; width: 100px"
                                               readonly id="frmBasicTotal"
                                               value="<?php if (!empty($ArrBasicInfo->amounttotal)) echo $ArrBasicInfo->amounttotal ?>">
                                        <input type="text" style="position:relative; left: 891px; width: 90px; "
                                               readonly id="frmBasicIgstTotal"
                                               value="<?php if (!empty($ArrBasicInfo->igsttotal)) echo $ArrBasicInfo->igsttotal ?>">
                                        <input type="text" style="position:relative; left: 891px; width: 90px; "
                                               readonly id="frmBasicSubtotalTotal"
                                               value="<?php if (!empty($ArrBasicInfo->subtotal_total)) echo $ArrBasicInfo->subtotal_total ?>">
                                        <?php
                        ...
                        <div class="box-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="frmAmountInWords" class="form-control" readonly
                                               value="<?php echo $ArrBasicInfo->amountinwords ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-2" style="border: 1px solid #f4f4f4">
                                        ...
                                        <p style="font-size: 11px; display: inline">If goods are supplied beyond cutoff
                                            date, it is up to the discretion of the company to accept or reject the
                                            goods. Terms and conditions as agreed upon.</p>
                                    </div>
                                    <label class="col-md-2"><b>Remarks:</b></label>
                                    <div class="col-md-10">
                                        <textarea id="frmRemarks" readonly
                                                  class="form-control"><?php echo $ArrBasicInfo->remarks ?></textarea>
                                    </div>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                            <tr>
                                                <th style="background-color: #f3f3f3" colspan="2">PURCHASER CONTACT
                                                    DETAILS
                                                </th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr>
                                                <th>NAME:</th>
                                                <td><input class="form-control" readonly id="frmBasicPurchaserName"
                                                           type="text"
                                                           value="<?php echo $ArrBasicInfo->purchasername ?>"></td>
                                            </tr>
                                            <tr>
                                                <th>MOBILE:</th>
                                                <td><input class="form-control" readonly id="frmBasicPurchaserMobile"
                                                           type="text"
                                                           value="<?php echo $ArrBasicInfo->purchasermobile ?>"></td>
                                            </tr>
                                            <tr>
                                                <th>EMAIL:</th>
                                                <td><input class="form-control" readonly id="frmBasicPurchaserEmail"
                                                           type="text"
                                                           value="<?php echo $ArrBasicInfo->purchaseremail ?>"></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                            <tr>
                                                <th style="background-color: #f3f3f3" colspan="2">VENDOR CONTACT
                                                    DETAILS
                                                </th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr>
                                                <th>NAME:</th>
                                                <td><input class="form-control" readonly id="frmBasicVendorName"
                                                           type="text" value="<?php echo $ArrBasicInfo->vendorname ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>MOBILE:</th>
                                                <td><input class="form-control" readonly id="frmBasicVendorMobile"
                                                           type="text"
                                                           value="<?php echo $ArrBasicInfo->vendormobile ?>"></td>
                                            </tr>
                                            <tr>
                                                <th>EMAIL:</th>
                                                <td><input class="form-control" readonly id="frmBasicVendorEmail"
                                                           type="text" value="<?php echo $ArrBasicInfo->vendoremail ?>">
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                            ...
                            <a href="<?php echo base_url('purchaseuser/bompurchaseinvoicepdf/' . $VarBomPurIndReqId) ?>">Save
                                as pdf</a>
                        </div>
                    </div>
                    <div class="box box-info">
                        ...
                        <div class="box-body <?php if (!empty($VarId)) {
                            if ($ArrBasicPaymentInfo['advancepayment'] != 1) echo 'hide';
                        } ?>" id="advPaymentDiv">
                            ...
                            <form class="">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="proformaNo" name="proformaNo" style="width: 110px"
                                                   value="<?php if (!empty($ArrBasicPaymentInfo['proformano'])) echo $ArrBasicPaymentInfo['proformano'] ?>">
                                        </td>
                                        <td>
                                            <input type="text" id="proformaDate" name="proformaDate" style="width: 80px"
                                                   placeholder="Choose"
                                        ...
                                        <td>
                                            <input type="text" id="proformaValue" name="proformaValue"
                                                   style="width: 110px"
                                        ...
                                        <td><input type="text" id="advPayable" name="advPayable"
                                                   value="<?php if (!empty($ArrBasicPaymentInfo['advpayable'])) echo $ArrBasicPaymentInfo['advpayable'] ?>">
                                        </td>
                                        <td>
                                            <select id="ReqdModeOfPayment" name="ReqdModeOfPayment">
                                                <option value="1" <?php if (@$ArrBasicPaymentInfo['reqmodeofpayment'] == 1) echo 'selected' ?>>
                                                    Cheque
                                                </option>
                                                <option value="2" <?php if (@$ArrBasicPaymentInfo['reqmodeofpayment'] == 2) echo 'selected' ?>>
                                                    DD
                                                </option>
                                                <option value="3" <?php if (@$ArrBasicPaymentInfo['reqmodeofpayment'] == 3) echo 'selected' ?>>
                                                    RTGS
                                                </option>
                                                <option value="4" <?php if (@$ArrBasicPaymentInfo['reqmodeofpayment'] == 4) echo 'selected' ?>>
                                                    SWIFT
                                                </option>
                                            </select>
                                        </td>
                                        <td>
                                            <input type="text" id="payByDate" name="payByDate" style="width: 80px"
                                                   placeholder="Choose"
                        ...
                        <div class="box-body <?php if (!empty($VarId)) {
                            if ($ArrBasicPaymentInfo['billpayment'] != 1) echo 'hide';
                        } ?>" id="billPaymentDiv">
                            ...
                            <form class="">
                                <table class="table">
                                    <tr>
                                        ...
                                        <th>Reqt. Mode<br/>of<br/>Payment</th>
                                    ...
                                    <tr>
                                        <td><?php echo $ArrBasicInfo->isriorcode; ?></td>
                                        <td><input type="text" id="invoiceNo" name="invoiceNo" style="width: 110px"
                                                   value="<?php echo $ArrBasicPaymentInfo['invoiceno']; ?>"></td>
                                        <td><input type="text" id="invoiceDate" name="invoiceDate" style="width: 82px"
                                                   placeholder="Choose"
                                                   value="<?php if (!empty($ArrBasicPaymentInfo['invoicedate'])) echo date('d-m-Y', strtotime($ArrBasicPaymentInfo['invoicedate'])) ?>">
                                        </td>
                                        <td>
                                            <input type="hidden" id="frmCurrency" name="frmCurrency"
                                                   value="<?php echo $ArrBasicInfo->currencycode ?>">
                                            <?php echo $VarCurrency ?>
                                        </td>
                                        <td><input type="text" id="invoiceValue" name="invoiceValue"
                                                   style="width: 110px"
                                                   value="<?php echo $ArrBasicPaymentInfo['invoicevalue'] ?>"></td>
                                        ...
                                        <td><input type="text" id="debitValue" name="debitValue" style="width: 110px"
                                                   value="<?php echo $ArrBasicPaymentInfo['debitvalue'] ?>"></td>
                                        <td><input type="text" id="amountPayable" name="amountPayable"
                                                   style="width: 110px" value="<?php
                                        ...
                                        <td><input type="text" id="paymentDueDate" name="paymentDueDate"
                                                   style="width: 82px;"
                                                   value="<?php if (!empty($ArrBasicPaymentInfo['paymentduedate'])) echo date('d-m-Y', strtotime($ArrBasicPaymentInfo['paymentduedate'])) ?>">
                                        </td>
                                        <td>
                                            <?php
                                            $ArrApprStatu = unserialize(REQUESTSTATUSARR);
                                            if (!empty($ArrBasicPaymentInfo['billpayapprstatus'])) echo $ArrApprStatu[$ArrBasicPaymentInfo['billpayapprstatus']];
                                            ?>
                                        </td>
                                        <td id="ApprdBy"><?php echo $apprbyname ?></td>
                                    </tr>
                            ...
                            <form name="frmAdvPaymentFinance" id="frmAdvPaymentFinance" class="">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th>Currency</th>
                                        <th>Advance Paid</th>
                                        <th>Paid in Full / Part</th>
                                        <th>Balance to Pay</th>
                                        <th>Bill Details Verified By</th>
                                        <th>Passed By</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    foreach ($ArrBasicFinanceDeptInfo as $item) {
                                        if ($item['advancepayment']) {
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="frmAdvPaid" name="frmAdvPaid"
                                                           onkeyup="fnAdvPaymentCalcBalance(this.value)"
                                                           class="frmAdvPaidCls" style="width: 130px"
                                                           value="<?php echo @$item['advpaid'] ?>"></td>
                                                <td>
                                                    <select id="" name="">
                                                ...
                                                <td>
                                                    <input type="text" id="" name=""
                                                           class="paymentpaiddetailsAdvancebaltopay"
                                                           style="width: 140px"
                                    ...
                                    <tr id="AdvPaymentAddxtra" class="hide">
                                        ...
                                        <td><input type="text" id="frmCheqNo" name="frmCheqNo" style="width: 110px">
                                        </td>
                                        <td>
                                            <input type="text" id="frmCheqDate" name="frmCheqDate" style="width: 80px">
                                        </td>
                                        <td><input type="text" id="frmTransId" name="frmTransId" style="width: 110px">
                                        </td>
                                        <td>
                                            <input type="text" id="frmTransDate" name="frmTransDate"
                                                   style="width: 80px">
                                        </td>
                                        <td>
                                            <input type="hidden" id="frmCurrency" name="frmCurrency"
                                        ...
                                        <td><input type="text" class="frmAdvPaidCls"
                                                   onkeyup="fnAdvPaymentCalcBalance(this.value)" id="frmAdvPaid"
                                                   name="frmAdvPaid" style="width: 130px"></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php
                                            foreach ($ArrBasicFinanceDeptInfo as $itemforbaltopay) if ($itemforbaltopay['advancepayment']) $varlastbaltopay = $itemforbaltopay['baltopay'] ?>
                                            <input type="text" id="frmBaltoPay"
                                                   class="paymentpaiddetailsAdvancebaltopay" name="frmBaltoPay"
                                                   style="width: 140px"
                                                   value="<?php if(!empty($varlastbaltopay)) echo $varlastbaltopay ?>"></td>
                                        <td><?php echo $VarBillVerifiedby ?></td>
                                        <td><?php echo $VarPassedBy ?></td>
                                    </tr>
                                    </tbody>
                                ...
                                <?php
                                if ($ArrBasicPaymentInfo['advancepayment'])
                                    echo '<button type="button" id="addrowBtnNewAdvPayment" onclick="fnShowNewAdvPayment()">Add Row</button>';
                                ?>
                            </form>
                        </div>
                        <?php
                            ...
                            <form id="frmBillPaymentFinance" name="frmBillPaymentFinance" class="">
                                <table class="table">
                                        ...
                                        if ($item['billpayment']) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <input type="text" id="" name="" style="width: 140px" class="BillPaymentfrmBaltoPayCls"
                                                           value="<?php echo $item['baltopay'] ?>"></td>
                                                <td>
                                    ...
                                    <tr id="BillPaymentXtra" class="hide">
                                        <td><?php echo $ArrBasicInfo->accountname ?></td>
                                        <td>
                                            <select id="BillpaymentReqdModeOfPayment"
                                                    name="BillpaymentReqdModeOfPayment">
                                                <option value="1">Cheque</option>
                                                <option value="2" selected="">DD</option>
                                                <option value="3">RTGS</option>
                                                <option value="4">SWIFT</option>
                                        ...
                                        <td><input type="text" id="BillPaymentfrmCheqNo" name="BillPaymentfrmCheqNo"
                                                   style="width: 110px"></td>
                                        <td>
                                            <input type="text" id="BillPaymentfrmCheqDate" name="BillPaymentfrmCheqDate"
                                                   style="width: 80px">
                                        </td>
                                        <td><input type="text" id="BillPaymentfrmTransId" name="BillPaymentfrmTransId"
                                                   style="width: 110px"></td>
                                        <td>
                                            <input type="text" id="BillpaymentfrmTransDate"
                                                   name="BillpaymentfrmTransDate" style="width: 80px">
                                        </td>
                                        <td>
                                            <input type="hidden" id="BillPaymentfrmCurrency" name="BillPaymentfrmCurrency" value="<?php echo $ArrBasicInfo->currencycode ?>">
                                            <?php echo $ArrCurrencyCode[$ArrBasicInfo->currencycode] ?>
                                        </td>
                                        <td><input type="text" id="BillPaymentAmountPaidpaymentpaiddetailsxtra"
                                                   name="BillPaymentfrmAmountPaid" class="BillPaymentAmountPaidCls"
                                        ...
                                        <td>
                                            <?php $varlast = ''; foreach ($ArrBasicFinanceDeptInfo as $item) if ($item['billpayment'] == 1) $varlast = $item['baltopay'] ?>
                                            <input type="text" id="BillPaymentfrmBaltoPay" name="BillPaymentfrmBaltoPay"
                                                   class="BillPaymentfrmBaltoPayCls" style="width: 140px"
                                                   value="<?php echo $varlast; ?>"></td>
                                        <td>
                                            <?php echo $VarBillVerifiedby ?>
                                        </td>
                                        <td>
                                ...
                                <?php
                                if ($ArrBasicPaymentInfo['billpayment'])
                                    echo '<button type="button" onclick="fnNewBillPaymentXtraPaymentpaidetails()" id="fnNewBillPaymentXtraPaymentpaidetailsBtn">Add Row</button>';
                                ?>
                            </form>
                        </div>
                        <?php
...
<script>
    ...
    var GlbBomPurchaseInvoiceId = '<?php echo $VarBomPurchaseInvoiceId ?>';
    var GlbBomPurIndReqId = '<?php echo $VarBomPurIndReqId ?>';
    var SavedInvoiceGrid = '<?php echo @$SavedInvoiceGrid ?>';
    var GlbTaxType = '<?php echo @$ArrBasicInfo->taxtype ?>';
    var GlbPaymentType = '<?php echo $ArrBasicPaymentInfo['advancepayment'] ?>';
    ...
    var GlbBalValAcceptSave = 0;
    function fnShowNewAdvPayment() {
        GlbPaymentType = 1;
        $("#AdvPaymentAddxtra").removeClass('hide');
    }
    function fnNewBillPaymentXtraPaymentpaidetails() {
        GlbPaymentType = 2;
        $("#BillPaymentXtra").removeClass('hide');
    }
    function fnSavePaymentReq() {
        if (GlbBalValAcceptSave) {
            if (GlbPaymentType == 1) {
                var advformdatas = $("#frmAdvPaymentFinance").serialize();
                //console.log(advformdatas,'advformdatas');
                var Param = "id=" + GlbId + "&bompurchaseinvoiceid=" + GlbBomPurchaseInvoiceId + "&bompurchaseindreqid=" + GlbBomPurIndReqId + "&advancepayment=1&" + advformdatas;
                ...
                var Param = "id=" + GlbId + "&bompurchaseinvoiceid=" + GlbBomPurchaseInvoiceId + "&bompurchaseindreqid=" + GlbBomPurIndReqId + "&billpayment=1&" + billformdatas;
                MakeAsynPostRequest(base_path + 'mfinance/updateBomPaymentReq', Param, 'json', fnSavePaymentReqRes);
            }
        }
        else {
    ...
    function fnAdvPaymentCalcBalance(advpaid) {
        ...
        console.log(GlbAdvancePayable,'GlbAdvancePayable');
        console.log(GlbBalValAcceptSave,'GlbBalValAcceptSave first');
        if (GlbAdvancePayable < totalamount) {
            //$(".frmAdvPaidCls").css("border", "1px solid red");
            //$("#frmBaltoPay").css("border", "1px solid red");
            alert('You have entered excess value');
            GlbBalValAcceptSave = 0;
        }
        else {
            GlbBalValAcceptSave = 1;
        }
        console.log(GlbBalValAcceptSave,'GlbBalValAcceptSave');
    }
    //BillPaymentAmountPaidpaymentpaiddetailsxtra
    //BillPaymentAmountPaidpaymentpaiddetailsxtra
    $("#BillPaymentAmountPaidpaymentpaiddetailsxtra").keyup(function () {
    ...
    $(".paymentpaiddetailsAdvancebaltopay").each(function () {
        var bal = $(this).val();
        if (bal == '0.00') {
            $("#addrowBtnNewAdvPayment").hide();
        }
        if(bal >= 0) {
            GlbBalValAcceptSave = 1;
        }
    ...
    $(".BillPaymentfrmBaltoPayCls").each(function () {
        var bal = $(this).val();
        if (bal == '0.00') {
            $("#fnNewBillPaymentXtraPaymentpaidetailsBtn").hide();
        }
        if(bal >= 0) {
            GlbBalValAcceptSave = 1;
        }
