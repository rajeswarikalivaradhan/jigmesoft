                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer nopadding">
                            ...
                            <button class="btn btn-info pull-right" type="button" onclick="return fnSavePaymentPaidJxl()"> Save Changes </button>
                        </div>
                        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    var GlbForSavingIssuePIDynamicTbl = 0; var GlbBomPurchaseGrid = 0;
    ...
    function fnSavePaymentPaidJxl() {
        try {
            //correct
            var paymentStatus = 0;
            let finPayPaidJxl = $("#financeDeptPayPaidJxl").jexcel('getData');
            ...
            MakePostRequest(base_path + 'mfinance/updateBomPIPayAdvDetails',"rfrom=1&bomPurIndentId="+GlbBomPurIndentId+
                "&bompurrequestid="+GlbRequestId+"&paymentstatus="+paymentStatus+"&financeDeptPayPaidJxl="+JSON.stringify(finPayPaidJxl),
                "json",fnSavePurchaseIndentRes);
            //correct ends


            /*var PiNo = $("#PurchaseIndentNo").text();
            var paymentPaidJxl = $("#financeDeptPayPaidJxl").jexcel('getData');
            MakePostRequest(base_path + 'mfinance/updateBomPIPayAdvDetails',"rfrom=1&bomPurIndentId="+GlbBomPurIndentId+"&bompurrequestid="++
    ...
    /*if(GlbFinDeptAdvPaymentPaidGrid == 0) {
    ...
    var PAYMENTTBLSUMCOL = function (instance, columnId) {
        ...
        return GlbTotal.toFixed(2);
    }
    jexcel(document.getElementById('financeDeptPayPaidJxl'), {
        columns:[
            { type:'text',title:'Paid in Favour of', width:300 },
            { type:'dropdown',title:'Mode of Payment', width:150, source: GlbAdvPayModeOfPayment },
            { type:'text',title:'Transaction ID / Code', width:150 },
            { type:'text',title:'Cheque No.', width:150 },
            { type:'calendar', title:'Transaction / Cheque Date', width:150 },
            { type:'dropdown',title:'Currency', width:150, source: JSON.parse(GlbCurrencynCode) },
            { type:'text',title:'Advance Paid Amount', width:150 },
            { type:'dropdown',title:'Advance Paid in Full / Part', width:100, source : ["Full","Part"] },
        ],
