            ...
            <section class="invoice form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="cus-sel form-control js-example-basic-single" id="package_id">
                                                ...
                                                <?php
                                                print_r($ArrPackage);
                                                file_put_contents("error_log", print_r($ArrPackage, true));
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="cus-sel form-control js-example-basic-single" id="purchasetype">
                                                <option value="" selected disabled hidden>Select</option>
                                                <?php
                                                $purchase_type = unserialize(ARRPURCHASETYPEENQUIRY);
                                                $exclude_keys = array(4, 5, 6);
                ...
                <div class="row">
                    <div class="col-xs-12 py-4" style="padding-right:30px">
                        ...
                        <div id="savereq"><button class="btn btn-royal-blue pull-right mx-2" id="savereqbtn" >Proforma Request</button></div>
