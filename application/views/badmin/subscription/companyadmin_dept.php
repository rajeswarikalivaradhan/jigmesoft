                    ...
                    <div class="col-md-12">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <input type="checkbox" name="title" value="Manage Master Data" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Manage Master Data',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <input type="checkbox" name="title" value="Manage Department & User" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Manage Department & User',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                    </div>
