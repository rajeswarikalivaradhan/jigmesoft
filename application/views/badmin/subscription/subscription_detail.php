...
$usertype=$ArrProfileInfo['usertype'];
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content">
            <section class="invoice form-horizontal">
                    ...
                    <div id="menu1" class="tab-pane fade in active">
                        ...
                        <div class="row no-rad-form add-form-mar" id="custom_form" style="padding:15px!important; margin:0px!important;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                         <input type="text" id="iecode_no" name="iecode_no" onkeyup="CaseConvert(this.id,'all','upper')" class="form-control" placeholder="Free Text" value="<?php if (!empty($BasicSubInfo->ie_code)) echo $BasicSubInfo->ie_code; ?>">
                    ...
                    <div class="col-xs-12">
                        <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px">Payment Received Details
                          <div class="pull-right">
                                            <div class="ml-auto pr-3">
                                            <?php 
                                                if (@$BasicSubInfo1->save_status == 1 && $BasicSubInfo1==0) { 
                                            ?>
                                            <a id="editEnable" class="btn custbtn btn-royal-blue btn-sm px-3 <?php if (@$BasicSubInfo1->paymentstatus == 3) { echo "hide";} ?>" >Edit</a>
                                            <?php } ?> 
                                            </div>
                                        </div>
                ...
                <div class="row no-rad-form add-form-mar my-4" id="custom_forms" style="background: #F7F7F7">
                    <div class="col-md-4">
                        <div class="">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-5 control-label">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="invoice_no" disabled value="<?php  if (!empty($BasicSubInfo->invoice_refno)) echo $BasicSubInfo->invoice_refno; ?>" placeholder="Auto Update">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="invoice_date" name="invoice_date" class="form-control" disabled placeholder="Auto Update" value="<?php  if (!empty($BasicSubInfo->invoice_datetime)) echo $BasicSubInfo->invoice_datetime; ?>">
                                    <div class="herr" id="Errcontactperson"></div>
                                </div>
                            </div>
                        </div>
                		<div class="">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="invoice_value" id="invoice_value" disabled class="form-control" placeholder="Free Text" value="<?php if (!empty($BasicSubInfo->subtotal)) echo $BasicSubInfo->subtotal; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                         <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="payment_from"  name="payment_from" disabled class="form-control" placeholder="Free Text" value="<?php  if (!empty($BasicSubInfo->payment_from)) echo $BasicSubInfo->payment_from; ?>">
                         ...
                         <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="transaction_no"  name="transaction_no" disabled class="form-control" placeholder="Free Text" value="<?php  if (!empty($BasicSubInfo->transaction_no)) echo $BasicSubInfo->transaction_no; ?>">
                            ...
                            <div class="">
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="transaction_date"  name="transaction_date" disabled class="form-control date" autocomplete="off" placeholder="Select" value="<?php  if (!empty($BasicSubInfo->transaction_date)) echo $BasicSubInfo->transaction_date; ?>">
                    ...
                    <div class="col-md-4">
                            <div class="">
                                <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-7 control-label">
                                        Mode of Payments <span class="mandatory">*</span> 
                                    </label>
                                    <div class="col-sm-5">
                                       <select class="cus-sel form-control js-example-basic-single" id="payment_mode" disabled>
                                                <option value="" selected disabled hidden>Select</option>
                                                <?php
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $key ?>" <?php if (@$BasicSubInfo->payment_mode == $key) { echo "selected";} ?>>
                                                        <?php echo $item ?>
                                                    </option>
                                                    <?php
                                                }
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" disabled class="form-control" id="transaction_value"  onblur="validateTransaction()" onkeypress="return isNumber_or_isDecimal_Key(event);"  placeholder="Free Text" value="<?php  if (!empty($BasicSubInfo->transaction_value)) echo $BasicSubInfo->transaction_value; ?>">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <?php if($usertype==16) { ?>
                                        <input type="hidden" id="payment_status" name="payment_status" disabled class="form-control" placeholder="Auto Update" value="<?php  if (!empty($BasicSubInfo->paymentstatus)) echo $BasicSubInfo->paymentstatus; ?>">
                                        <input type="text" id="paymentstatus" name="paymentstatus" disabled class="form-control" placeholder="Auto Update" value="<?php  if (!empty($BasicSubInfo->paymentstatus)) echo $BasicSubInfo1->paymentstatus; ?>">
                                        <?php } else { ?>
                                        <select class="cus-sel form-control js-example-basic-single" id="payment_status" disabled>
                                                <option value="" selected disabled hidden>Select</option>
                                                <?php
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $key ?>" <?php if (@$BasicSubInfo->paymentstatus == $key) { echo "selected";} ?>>
                                                        <?php echo $item ?>
                                                    </option>
                                                    <?php
                                                }
                ...
                <div class="col-sm-12" style="padding:10px 0; border-bottom:1px solid #022B61;"></div>
 
                
 <div class="col-sm-12 text-right " style="padding:10px 0; margin-top:10px; ">
                    ...
                    <div id="menu2" class="tab-pane fade" >
                        ...
                        <div class="p-0 w-100 package_details" id="package_details" >
                            
                        </div>
                        <div class="col-sm-12" style="padding:5px 0; border-bottom:1px solid #022B61;"></div>
 
 <div class="col-sm-12 text-right " style="padding:5px 0; margin-top:10px; ">
                    ...
                    <div id="menu3" class="tab-pane fade">
                            ...
                            <div class="p-0 w-100 userwise_package_details" id="userwise_package_details">
                        ...
                        <div class="p-0 w-100 deptwise_role_detail" id="deptwise_role_detail" style="border-top: 1px solid #022B61!important;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box-body no-padding">
                                        <table id="tableId" class="table table-bordered table-hover" data-page-length="50" >
                                            <thead>
                                            <tr>
                                                <th  class="no-sort"></th>
                    ...
                    <div id="menu6" class="tab-pane fade">
                        ...
                        <div class="p-0 w-100 subscriber_user_list" id="subscriber_user_list" style="border-top: 1px solid #022B61!important;">
                                ...
                                <div class="col-md-12">
                                    <div class="box box-info">
                                    <div class="box-body no-padding">
                                        <table id="tableIds" class="table table-bordered table-hover" data-page-length="50" >
                                            <thead>
                                            <tr>
                                                <th  class="no-sort"></th>
 ...
 <div class="col-sm-12 text-right " style="padding:5px 0; margin-top:10px; ">
                    ...
                    <div id="menu5" class="tab-pane fade">
                        ...
                        <div class="row">
                        <div class="col-xs-12" style="padding-right:10px; margin: 10px 0px 0px 0px;">
   
    <div class="col-xs-6" style="display: flex; gap: 10px; padding-bottom: 20px;">
       
        <div style="background-color: #ebecec;  padding: 0px; height: 201px;  flex: 2;">
        <table id="tabledraft" class="table f-13 ">
        <thead  >
        <tr >
            <th class="theadstyletable">S.No</th>
            <th class="theadstyletable">Data Storage Details</th>
            <th class="theadstyletable">Qty</th>
            <th class="theadstyletable">UOM</th>
        </tr>
    </thead>
        <tbody>  
        <?php  
                        $subscriber_id=$BasicInfo->id;$proforma_id=$BasicSubInfo->pid;
                        $data = $this->subscriptionmodal->getPackagedetailsData_usage_limit($subscriber_id,$proforma_id);
                        $d_s_l=$data[0]["data_limit"];
                        $d_s_l_n = intval($d_s_l);
                        $d_s_c=$data[0]["data_storage_limit"];
                        $t_d_s=$d_s_l_n+$d_s_c;
                        $f_s_l=$data[0]["file_limit"];
                        $f_s_l_n = intval($f_s_l);
                        $f_s_c=$data[0]["file_storage_limit"];
                        $t_f_s=$f_s_l_n+$f_s_c;
                        


                        ?>  
        <tr><td >1</td><td >Data Storage Limit (Package)</td><td ><?php echo($d_s_l_n)?></td><td >GB</td></tr>
        <tr ><td>2</td><td>Add.Data Storage Limit(Chargeable)</s></td><td><?php echo($d_s_c)?></td><td >GB</td></tr>
        <tr><td>3</td><td>Total Data Storage Limit</s></td><td><?php echo($t_d_s)?></td><td >GB</td></tr>
        <tr><td >4</td><td>Current Data Storage Usage Level</s></td><td>0</td><td >%</td><tr>
        <tr><td>5</td><td>Availalbe Data Storage</s></td><td>0</td><td >%</td></tr>
                                        </tbody>
                                        </table>
        </div>
       
        <div style="border: 1px solid black; padding: 0px;  height: 215px;  width: 215px; flex: 1;">
            <?php  $filepath = './uploads/homepage/free&avi.jpg';?>
        <img src=<?php echo(base_url().$filepath) ?> alt="Description" width="100%" height="100%">
        </div>
    </div>

    <!-- Second main div (Outer Div 2) -->
    <div class="col-xs-6" style="display: flex; gap: 10px;">
        <!-- Inner div 1 (bigger) -->
        <div style="background-color: #ebecec;  padding: 0px; height: 201px;  flex: 2;">
        <table id="tabledraft" class="table">
        <thead class="">
        <tr class="extra-height  mx-1" >
            <th class="theadstyletable" >S.No</th>
            <th class="theadstyletable" >File Storage Details</th>
            <th class="theadstyletable" >Qty</th>
            <th class="theadstyletable" >UOM</th>
        </tr>
    </thead>
        <tbody>    
        <tr><td>1</td><td>File Storage Limit (Package)</s></td><td ><?php echo($f_s_l_n)?></td><td >GB</td></tr>
        <tr ><td>2</td><td>Add.File Storage Limit(Chargeable)</s></td><td><?php echo($f_s_c)?></td><td >GB</td></tr>
        <tr><td>3</td><td>Total File Storage Limit</s></td><td><?php echo($t_f_s)?></td><td >GB</td></tr>
        <tr ><td >4</td><td>Current File Storage Usage Level</s></td><td>0</td><td >%</td><tr>
        <tr><td>5</td><td>Availalbe File Storage</s></td><td>0</td><td >%</td></tr>
                                        </tbody>
                                        </table>
        </div>
        <!-- Inner div 2 (smaller) -->
...
<div class="col-sm-12" style="padding:5px 0; border-bottom:1px solid #022B61;">
...
<div class="col-sm-12 text-right " style="padding:5px 0; margin-top:10px; ">
                            ...
                            <button role="tab"
                                    ...
                                    <span class="mar-lr-10 bf-af-pg">...</span>
                                    <button role="tab" aria-controls="menu4"
                                            onclick='$("#menu1_id").trigger("click")'
                                            href="#menu5" class="btn btn-sm btn-royal-blue btn-text-slide-x">
                                        Next <i class="btn-text-2 move-right fa fa-arrow-right text-120 align-text-bottom mr-2"></i>
                                    </button>
...
// Storage Data from PHP
var usedStorage = <?php echo $usedStorage; ?>;
var availableStorage = <?php echo $availableStorage; ?>;

var ctx = document.getElementById('storageChart').getContext('2d');
var storageChart = new Chart(ctx, {
    type: 'doughnut', // Circular shape
    data: {
         labels: ['\n\n\n\n\nUsage\n60%', '\n\nAvailable\n40%'],
        datasets: [{
            data: [usedStorage, availableStorage],
            backgroundColor: [,'#008bfe','#ebecec'], // Dark gray & light gray
            borderColor: ['#ffffff', '#ffffff'], // White border for cleaner look
            borderWidth: 2
        }]
    },
    options: {
        responsive: true,
        maintainAspectRatio: true, // Keeps it round
        cutout: '80%', // Ensures a donut effect
        plugins: {
            legend: { display: true, position: 'bottom',labels: {
                ...
                padding: 10 // Correct way to add padding
            } },
        }
    }
});

var ctx1 = document.getElementById('storageChart1').getContext('2d');
var storageChart = new Chart(ctx1, {
    type: 'doughnut', // Circular shape
    data: {
        labels: ['\n\n\n\n\nUsage\n60%', '\n\nAvailable\n40%'],
        datasets: [{
            data: [usedStorage, availableStorage],
            backgroundColor: ['#008bfe','#ebecec'],
           // backgroundColor: ['#ebecec','#008bfe',],  // Dark gray & light gray
            borderColor: ['#ffffff', '#ffffff'], // White border for cleaner look
            borderWidth: 2
        }]
    },
    options: {
        ...
        cutout: '80%', // Ensures a donut effect
        plugins: {
            legend: { display: true,  font: { size: 14, weight: 'bold' },position: 'bottom' },
        }
    }
});
</script>
        ...
        let options = {
            ...
            $('#userwise_packagebtn').click(function (){
                    //alert($('#no_of_users').val());
                        ...
                        let adnl_of_users=($('#additional_users_chargeable').val()?.toLowerCase() === 'nil') ? 0 : $('#additional_users_chargeable').val();
                        //let adnl_of_users=($('#additional_users_chargeable').val()=='0' || $('#additional_users_chargeable').val()=='0')?0:$('#additional_users_chargeable').val();
                       
                        // alert("total o user"total_no_of_users);
                        // alert("no user"no_of_users);
 ...
 {    
       //alert(subscriber_id);
        ...
        let options = {
                ...
                allowInsertColumn: false,
                //footers:[['', '', '','','','', 'Total : ','=SUMCOL(TABLE(), COLUMN())','=SUMCOL(TABLE(), COLUMN())','=SUMCOL(TABLE(), COLUMN())']],
                package_details: function (instance, cell, col, row, val, label, cellName) { 
