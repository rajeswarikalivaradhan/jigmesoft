        ...
        <section class="content">
            <section class="invoice form-horizontal">
                ...
                <div class="row" style="padding:10px 27px;">
                    <div class="fabric_details" id="fabric_details"></div>
                </div>
                <div class="row">
...
showfabricdetail(subscriber_id);
function showfabricdetail(subscriber_id)
 {    
       //alert("showfabricdetail");
        $("#fabric_details").html("");
        const datasend = {
        ...
        MakeAsynPostRequest(base_path + "badmin/msubscription/showfabricdepartment", datasend , "json", function(data) {
