        ...
        <section class="content">
            <section class="invoice form-horizontal">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <input type="checkbox" name="title"  value="Garment Issued List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Garment Issued List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="row" style="padding:10px 27px;">
                    <div class="smpl_details" id="smpl_details"></div>
                </div>
                <div class="row">
...
showsampledetail(subscriber_id);
function showsampledetail(subscriber_id)
 {    
        ...
        MakeAsynPostRequest(base_path + "badmin/msubscription/showsampledepartment", datasend , "json", function(data) {
