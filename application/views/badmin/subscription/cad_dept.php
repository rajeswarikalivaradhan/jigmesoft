...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content" id="mydiv">
            <section class="invoice form-horizontal">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <input type="checkbox" name="title" value="M.I. Received List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('M.I. Received List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="row" style="padding: 10px 27px;">
                    <div class="cad_details" id="cad_details"></div>
                </div>
                <div class="row">
...
function showcaddetail(subscriber_id)
 {    
        ...
        MakeAsynPostRequest(base_path + "badmin/msubscription/showdepartment", datasend, "json", function(data) {
