    ...
    <div class="content-wrapper">
        <section class="content">
            <section class="invoice form-horizontal">
                ...
                <div class="row no-rad-form add-form-mar p-0" id="custom_form">
                    ...
                    <div class="col-md-12">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="Enquiry Authorization List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Enquiry Authorization List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="WIP List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('WIP List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="Work Authorization List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Work Authorization List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input type="checkbox" name="title" value="P.I. Approval List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('P.I. Approval List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                ...
                <div class="row" style="padding:10px 27px;">
                    <div class="mngmt_details" id="mngmt_details"></div>
                </div>
                <div class="row">
...
showmngmtdetail(subscriber_id);
function showmngmtdetail(subscriber_id)
 {    
        $("#mngmt_details").html("");
        const datasend = {
        ...
        MakeAsynPostRequest(base_path + "badmin/msubscription/showmngdepartment", datasend , "json", function(data) {
