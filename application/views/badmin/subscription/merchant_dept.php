        ...
        <section class="content">
            <section class="invoice form-horizontal">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Enquiry List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Enquiry List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Stationery List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Stationery List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-md-7 control-label labelclr">
                                    Sample Received List
                                    </label>
                                <div class="col-md-5">
                                   <input type="checkbox" name="title" value="Sample Received List" <?php if(isset($ArrRoleInfo) && count($ArrRoleInfo)>0 && in_array('Sample Received List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="padding:10px 27px;">
                    <div class="merchant_details" id="merch_details"></div>
                </div>
                <div class="row">
...
showmerchantdetail(subscriber_id);
function showmerchantdetail(subscriber_id)
 {    
        ...
        MakeAsynPostRequest(base_path + "badmin/msubscription/showmerchdepartment", datasend , "json", function(data) {
