            ...
            <section class="invoice form-horizontal">
                <div class="row hidden-print"> 
                    <div class="col-xs-12">
                        <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> Proforma Invoice
                          <div class="pull-right">
                                            ...
                                            <input type="hidden" id="profroma_type" value="<?php if (!empty($BasicInfo->proforma_type)) echo $BasicInfo->proforma_type; ?>">
                 ...
                 <div class="row no-rad-form add-form-mar" id="custom_form">
                    <div class="col-md-12" id="cus-radio-btnblk">
                        <div style="border:1px solid #ddd;padding: 16px 0px 40px 0px;" class="hide">
                            <div class="col-md-2">
                                    ...
                                    <td class="ord-procs-cell">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="process-value"><?php if (!empty($BasicInfo)) echo $BasicInfo->invoice_validity; ?>
                                                    <input type="hidden" disabled class="form-control" id="invoice_validity" value="<?php if (!empty($BasicInfo)) echo $BasicInfo->invoice_validity; ?>"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                ?>
                                                <!-- <select class="cus-sel form-control js-example-basic-single" id="subscription_period" disabled>
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $key ?>" <?php if (@$BasicInfo->subscription_period == $key) { echo "selected";} ?>>
                                                        <?php echo $item ?>
                                                    </option>
                                                    <?php
                                                }
                    ...
                    <div class="col-md-12">
                        <div class="card border-0">
                            <div class="card-header p-2 border-0 bgc-white">
                ...
                <!-- <div class="col-xs-12">
                        <h2 class="page-header text-royal-black" style="border-bottom:0px"> 
                           <div class="pull-right">
                                <div class="mx-3">
                                <a  href="<?php echo base_url('invoice/csgstpdf/'.$VarId); ?>"  target="_blank" class="btn custbtn btn-royal-blue btn-sm mx-3">Generate PDF</a>
                                </div>
                            </div>
        ...
        <div class="col-xs-12">
                        <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px">Payment Received Details
                          <div class="pull-right">
                                            <div class="ml-auto pr-3">
                                            <?php 
                                                if (@$BasicInfo->save_status == 1) { 
                                            ?>
                                            <a id="editEnable" class="btn custbtn btn-royal-blue btn-sm px-3 <?php if (@$BasicInfo->paymentstatus == 2) { echo "hide";} ?>" >Edit</a>
                                            <?php } ?> 
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-4">
                         <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="payment_from"  name="payment_from" disabled class="form-control" placeholder="Free Text" value="<?php  if (!empty($BasicInfo->payment_from)) echo $BasicInfo->payment_from; ?>">
                         ...
                         <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="transaction_no"  name="transaction_no" disabled class="form-control" placeholder="Free Text" value="<?php  if (!empty($BasicInfo->transaction_no)) echo $BasicInfo->transaction_no; ?>">
                            ...
                            <div class="">
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="transaction_date"  name="transaction_date" disabled class="form-control date" autocomplete="off" placeholder="Select" value="<?php  if (!empty($BasicInfo->transaction_date)) echo $BasicInfo->transaction_date; ?>">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" disabled class="form-control" id="transaction_value"  onblur="validateTransaction()" onkeypress="return isNumber_or_isDecimal_Key(event);"  placeholder="Free Text" value="<?php  if (!empty($BasicInfo->transaction_value)) echo $BasicInfo->transaction_value; ?>">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <?php if($usertype==16) { ?>
                                        <input type="hidden" id="payment_status" name="payment_status" disabled class="form-control" placeholder="Auto Update" value="<?php  if (!empty($BasicInfo->paymentstatus)) echo $BasicInfo->paymentstatus; ?>">
                                        <input type="text" id="paymentstatus" name="paymentstatus" disabled class="form-control" placeholder="Auto Update" value="<?php  if (!empty($BasicInfo->paymentstatus)) echo $BasicInfo->paymentstatus; ?>">
                                        <?php } else { ?>
...
<script type="text/javascript">
 ...
 var SUMCOL = function(instance, columnId) {
    ...
    {    var checkboxval = '';
        ...
        var prformatype=$('#profroma_type').val();
        //alert(checkboxval);
        if(checkboxval=='within'){
        $("#cgst_sgst_proforma_grid").html("");
        MakeAsynPostRequest(base_path + "badmin/mreqrcved/getquotedetails_cgst_sgst", "enquiry_id=" + enquiry_id +  "&proforma_id=" + GlbId + "&proformatype=" + prformatype + "&invotype=" + checkboxval, "json", function(data) {
        ...
        let options = {
         ...
         MakeAsynPostRequest(base_path + "badmin/mreqrcved/getquotedetails_igst", "enquiry_id=" + enquiry_id +  "&proforma_id=" + GlbId + "&proformatype=" + prformatype+ "&invotype=" + checkboxval, "json", function(data) {
        let min_dimensions = data.column.length;
        let options = {
                data: data.data,
                editable:false,
    ...
    let redirectpath = base_path + GlbBAdminFdr + 'msubscription/detview/' + encodeURIComponent(base64_encode(GlbsubscriberId));
    window.location.href = redirectpath;
    });
</script>
