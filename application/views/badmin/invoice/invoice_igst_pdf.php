...
<table cellspacing="0" cellpadding="3" border="0" width="100%">
        <tr>
         <td align="center" style="border-bottom:1px solid #151515;font-size:18px"><b> Invoice</b></td>
         </tr>
       </table>
<table style="padding:1px;" border="0">
        <tr>
         <td width="333" style="padding-left :5px"> <b>To</b>  </td>
        <td width="340" align="center">  <b>Invoice Reference </b> </td>
        </tr>
</table>
...
<table  class="details" cellspacing="0" cellpadding="4" border="1">
      ...
      <tr style="font-weight:bold;">
        ...
        <td></td>
        <td class='text-right'><?php if (!empty($BasicInfo)) echo number_format ($BasicInfo->igst_amount,2); //$BasicInfo->igst_amount; ?></td>
...
<table cellspacing="0"  border="0" style="align:right;padding-left:5px"   width="100%" >
    ...
    <tr>
        ...
        <td width="16%"  align="right" style="padding-top:50px;" >Authorized Signatory</td>
    </tr>
</table>
</body>
</html>