...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Proforma Invoice List</b></span>
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        ...
                                        <th class="theadstyle">Req. Date & Time</th>
                                        <th class="theadstyle">Profor. Invoice Ref. No.</th>
                                        <th class="theadstyle">Profor. Invoice Date</th>
                                        <th class="theadstyle">Profor. Invoice Date</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="10%">
                                             ...
                                             <td width="10%">
                                                ...
                                                <input type="text" name="RequestFrom" id="RequestFrom" placeholder="From" style="width:100%!important" class="date form-control start search-date">
                                            ...
                                            <td width="10%">
                                                <p id="enquirySearch" class="input-group search-div">
                                                <input type="text" name="todate" id="RequestTo" placeholder="RequestTo"  style="width:100%!important" class="date form-control end search-date">
                                                <span class="glyphicon glyphicon-calendar form-control-feedback" style="line-height: 27px ! important"></span>
                                                </p>
                                            </td>
                                            <td width="10%">
                                            ...
                                            <td width="10%">
                                                <p id="enquirySearch" class="input-group search-div">
                                                <input type="text" name="CutoffFrom" id="CutoffFrom" placeholder="From" style="width:100%!important" class="date form-control start search-date">
                                                <span class="glyphicon glyphicon-calendar form-control-feedback" style="line-height: 27px ! important"></span>
                                                </p>
                                            </td>
                                            ...
                                            <td width="10%">
                                                <p id="enquirySearch" class="input-group search-div">
                                                <input type="text" name="CutoffTo" id="CutoffTo" placeholder="To"  style="width:100%!important" class="date form-control end search-date">
                                                <span class="glyphicon glyphicon-calendar form-control-feedback" style="line-height: 27px ! important"></span>
                                                </p>
                                            </td>
                                        </tr>
                        ...
                        <div class="box-body no-padding">
                            <table id="tableId" class="table table-bordered table-hover" data-page-length="50" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                ...
                                <tr>
                                    ...
                                    <th id="1">Package Detail</th>
                                    <th id="2">Purchase Type</th>
                                    <th id="3">Request <br> Raised By</th>
                                    <th id="4">Request <br> Date & Time</th>
                                    <th id="5">Proforma Invoice <br>Reference No.</th>
                                    <th id="6">Proforma Invoice <br> Date & Time</th>
                                    <th id="7">Payment  Confir- <br>mation Status</th>
