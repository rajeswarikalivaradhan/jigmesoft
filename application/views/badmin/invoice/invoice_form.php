...
<div class="wrapper">
        ...
        <section class="content">
            <section class="invoice form-horizontal">
                <div class="row hidden-print"> 
                    <div class="col-xs-12">
                        <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px">  Invoice
                 ...
                 <div class="row no-rad-form add-form-mar" id="custom_form">
                    ...
                    <div class="col-md-12 text-center"><h4 style="font-weight:600">Invoice</h4><hr class="my-0"></div>
                     <div class="col-md-12">
                         <div class="col-md-6 py-2 px-4"><b>To
                         </b>
                         </div>
                         <div class="col-md-6 py-2 text-center"><b>Invoice Reference</b></div>
                     </div>
                     <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="ord-procs-cell">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="process-title">Invoice No.</td>
                                                <td class="process-value"><?php if (!empty($BasicInfo)) echo $BasicInfo->invoiceno; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <?php $subscription_period = unserialize(ARRSUBSCRIPTIONPERIOD);if (@$BasicInfo->subscription_period) { echo $subscription_period[$BasicInfo->subscription_period];} ?>    
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="process-title">Subscription Validity</td>
                                                <td class="process-value"><?php if (!empty($BasicInfo->subscrpstartdate) && $BasicInfo->proforma_type=='NPI') { echo '['.$BasicInfo->subscrpstartdate.']';}else { echo '['.$BasicInfo->invoicegen_date.']';} ?><?php if (!empty($BasicInfo->subscrpenddate)) echo ' - '.'['.$BasicInfo->subscrpenddate.']'; ?></td>
                                            </tr>
                                        </tbody>
                                        </table>
                                    </td>
                    ...
                    <div class="col-md-12">
                        <div class="card border-0">
                            <div class="card-header p-3 border-0 bgc-white mb-1 hide">
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        <div class="col-md-12 p-1">
                            <div class="form-group mb-0">
                                ...
                                <div class="col-sm-9" style="padding:0px"><?php if (!empty($BasicInfo)) echo $BasicInfo->terms_and_condition; ?></div>
                            </div>
                        </div>
                        </div>
                ...
                <div class="row hidden-print">
                    <!-- <div class="col-xs-12">
                        <h2 class="page-header text-royal-black" style="border-bottom:0px"> 
                           <div class="pull-right">
                                <div class="mx-3">
                                <a  href="<?php echo base_url('invoice/pdfs/'.$VarId); ?>"  target="_blank" class="btn custbtn btn-royal-blue btn-sm mx-3">Generate PDF</a>
                                </div>
                            </div>
    ...
    <h2 class="page-header text-royal-black" style="border-bottom:0px">
        ...
        <div class="pull-right d-flex" style="gap:10px;">
             <a href="<?php echo base_url('invoice/printpdfs/'.$VarId); ?>" 
               target="_blank" 
               class="btn custbtn btn-royal-blue btn-sm">
               Print
            </a>
            <a href="<?php echo base_url('invoice/pdfs/'.$VarId); ?>" 
               target="_blank" 
               class="btn custbtn btn-royal-blue btn-sm">
               Generate PDF
            </a>
