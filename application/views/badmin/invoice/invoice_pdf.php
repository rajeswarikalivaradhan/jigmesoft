...
foreach($ArrDetResults as $k=>$v){
     ...
     $trows .="<tr><td class='text-center'>$j</td>"
               ...
               . "<td class='text-right'>$v[igst_percent]</td>" 
                
                . "<td class='text-right'>$v[igst_amount]</td>"
          ...
          <table class="" width="100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php $subscription_period = unserialize(ARRSUBSCRIPTIONPERIOD);
                                                if (!empty($BasicInfo)) echo $subscription_period[$BasicInfo->subscription_period]; ?>
                                                </td>
                                            </tr>
                                            <tr>
...
<table  class="details" cellspacing="0" cellpadding="4" border="1">
       ...
       <td width="18%" align="center">Description</td>
       <td width="18%" align="center">Details</td>
       <td width="8%" align="center">Unit Rate (Rs)</td>
       <td width="8%" align="center">Qty. (Nos)</td>
       <td width="10%" align="center">Amt. (Rs)</td>
       <td width="10%" align="center">IGST (%)</td>
       <td width="10%" align="center">IGST Value (Rs)</td>
       <td width="10%" align="center">Sub Total (Rs)</td>
       </tr>
       <?php echo $trows ?>
       <?php // echo $trowss ?>
       <tr style="font-weight:bold;">
        ...
        <td class='text-right'><?php if (!empty($BasicInfo)) echo number_format ($BasicInfo->total,2);  ?></td>
        <td></td>
        <td class='text-right'><?php if (!empty($BasicInfo)) echo number_format ($BasicInfo->igst_amount,2);  ?></td>
        <td class='text-right'><?php if (!empty($BasicInfo)) echo number_format($BasicInfo->subtotal,2);  ?></td>
        </tr>
</table>
...
<table cellspacing="0" cellpadding="4" border="0">
   <tr>
        ...
        <td align="left" style="padding-left:15px;" > <?php echo ucwords($amount);?></td>
        <td align="left"></td>
    </tr>
    <tr >
        <td align="left" style="padding-top:20px;" ><b> Terms & Conditions : </b></td>
        <td align="left" style="padding-top:20px; padding-left:15px;" > <?php if (!empty($BasicInfo)) echo $BasicInfo->terms_and_condition; ?></td>
...
<table cellspacing="0" cellpadding="4" border="0">
    ...
    <tr>
        <td width="115"></td> 
        <td width="450"></td> 
        <td align="400"  align="right">For <b>Azibo Infotech Private Limited</b></td>
    </tr>
    <tr>
        <td width="115"></td> 
        <td width="450"></td> 
        <td align="400"  style="padding:30px!mportant" align="right"></td>
    </tr>
    
    <tr>
        <td width="115"></td>
        <td width="450" ></td>
        <td align="400" align="right">Authorized Signatory</td>
    </tr>
</table>
</body>
</html>