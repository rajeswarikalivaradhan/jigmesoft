                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                    ...
                                    Subscriber Enquiry List
                                    </label>
                                <div class="col-sm-2">
                                   <input type="checkbox" name="title" value="Subscriber Enquiry List" <?php if(count($ArrRoleInfo)>0 && in_array('Subscriber Enquiry List',$ArrRoleInfo)) { echo 'checked';}?>>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
