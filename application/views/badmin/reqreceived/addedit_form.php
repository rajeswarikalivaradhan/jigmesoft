            ...
            <section class="invoice form-horizontal">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                         <input type="text" id="iecode_no" name="iecode_no" onkeyup="CaseConvert(this.id,'all','upper')" class="form-control" placeholder="Free Text" value="<?php if (!empty($BasicInfo->IECODE)) echo $BasicInfo->IECODE; ?>">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="cus-sel form-control js-example-basic-single" id="purchasetype">
                                                ...
                                                $exclude_keys = array(2,3,4,5,6);

                                                foreach ($exclude_keys as $key) {
                                                    if (isset($purchase_type[$key])) {
                                                        unset($purchase_type[$key]);
                                                    }
                                                }
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="additional_users" onkeypress="return onlyNumbernodecimal(event);"  placeholder="Free Text" value="<?php if (!empty($BasicInfo->additional_users)) echo $BasicInfo->additional_users; ?>">
                ...
                <div class="row">
                    <div class="col-xs-12 py-4" style="padding-right:30px">
                        ...
                        <?php if($proformaDraftorNot > 0) { ?>
                        <div id="savereq"><a href="<?php echo base_url(CNFBADMIN.'mreqrcved/raiseproforma/'.base64_encode($BasicInfo->id)); ?>"><button class="btn btn-royal-blue pull-right mx-2" id="savereqbtn">View Draft</button></a></div>
                        <?php } else { ?>
                        <div id="savereq"><a href="<?php echo base_url(CNFBADMIN.'mreqrcved/raiseproforma/'.base64_encode($BasicInfo->id)); ?>"><button class="btn btn-royal-blue pull-right mx-2" id="savereqbtn">Raise Proforma</button></a></div>
                        <?php } ?>
...
<script type="text/javascript">
    ...
    } else if(lasturi=='edit' && draftstatus==1){ 
       $('#enqsvbtn').show();
       $('#cleardraft').show();
       $('#savedraft').show();
