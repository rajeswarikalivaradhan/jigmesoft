...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Unit Rate (Rs) List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFBADMIN ?>munitrate/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle" style="padding-left: 15px">Unit Rate (Rs)</th>
                                          <th class="theadstyle" style="padding-left: 15px">Unit Rate (Rs)</th>
                                        <th class="theadstyle" style="padding-left: 15px">Status</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td width="10%">
                                                <input type="text" name="frmSrchmin" class="form-control" id="frmSrchmin" placeholder="Min">
                                                <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                            </td>
                                             <td width="10%">
                                                <input type="text" name="frmSrchmax" class="form-control" id="frmSrchmax" placeholder="Max">
                                                <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                            </td>
                                            <td width="10%">
...
<script src="<?php echo base_url(); ?>assets/js/<?php echo CNFBADMIN ?>unitrate.js"></script>
