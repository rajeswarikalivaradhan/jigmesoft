    ...
    <aside class="main-sidebar hide">
     ...
     <div class="content-wrapper">
        ...
        <section class="invoice form-horizontal">
                <div class="row"> 
            <div class="col-xs-12">
                <h2 class="page-header text-royal-black mx-4" style="border-bottom:0px"> <?php echo (empty($Edit) && empty($VarId)) ? 'Add New Unit Rate (Rs)':'View / Edit Unit Rate (Rs)' ?>
                  <div class="pull-right">
                                    <div class="ml-auto pr-3">
                                    <a href="<?php echo base_url(CNFBADMIN . 'munitrate/manage') ?>" id="backbtn" class="btn custbtn btn-sm mx-3 btn-royal-blue btn-text-slide-x">Back</a>
                                    <?php 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                    <label for="id-form-field-focus-1" class="col-sm-5 control-label">
                                     Unit Rate (Rs) <span class="mandatory">*</span>
                                    </label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="frmDescp" onkeypress="return isNumber_or_isDecimal_Key(event)"  onchange="validateFloatKeyPress(this);" value="<?php if (!empty($BasicInfo->description)) echo $BasicInfo->description; ?>" placeholder="Free Text">
