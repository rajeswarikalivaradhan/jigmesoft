...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Package Details List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFBADMIN ?>mpackage/addedit">
                                 ...
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        ...
                                        <th class="theadstyle">No. of Users (Package)</th>
                                        <th class="theadstyle">Data Storage Limit (Package)</th>
                                        <th class="theadstyle">File Storage Limit (Package)</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="10%">
                                                <input type="text" name="frmSrchDescp" class="form-control" id="frmSrchDescp" placeholder="Free Text">
                                                <input type="hidden" name="hidddenColumnId" id="hidddenColumnId">
                                            </td>
                                            <td width="10%">
                                                <input type="text" name="frmSrchnoofusers" class="form-control" id="frmSrchnoofusers" placeholder="Free Text">
                                            </td>
                                            <td width="10%">
                                                <input type="text" name="frmSrchdata_limit" class="form-control" id="frmSrchdata_limit" placeholder="Free Text">
                                            </td>
                                            <td width="10%">
                                                <input type="text" name="frmSrchfile_limit" class="form-control" id="frmSrchfile_limit" placeholder="Free Text">
                                            </td>
                                            <td width="10%">
                    ...
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="tableId" class="table table-bordered table-hover" data-page-length="50" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                ...
                                <tr>
                                    <th  class="no-sort"></th>
                                    <th id="0">Package Details</th>
                                    <th id="1">No. of Users (Package)</th>
                                    <th id="2">Data Storage Limit (Package)</th>
                                    <th id="3">File Storage Limit (Package)</th>
                                     <th id="5">Updated By</th>
                                    <th id="6">Recent Update</th>
                                     <th id="4">Status</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
