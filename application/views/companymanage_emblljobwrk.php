...
<div class="wrapper">
    ...
    <div class="content-wrapper bgn-white">
        <div class="col-sm-12" style="display: block; padding: 10px 25px;margin-top: 100px;">
            <span class="header-title"><b style="font-size: 20px !important; font-family: Arial">Dyeing Job Work List</b></span>
            
            <a class="btn btn-sm btn-royal-blue add_btn" href="<?php echo base_url() . CNFCOMPANY ?>mjobwrk/addedit">
                                ...
                                <table class="table tables table-bordered">
                                 <!--<thead style="background-color:#E0E0E0!important;color:#022B61!important;font-size:13px!important">-->
                                     <thead style="background-color:unset!important;font-size:13px!important">
                                      <tr>
                                        <th class="theadstyle">Dyeing Job Work Name</th>
										<th class="theadstyle">Contact Person</th>		
                                        <th class="theadstyle">Email ID</th>
                                        <th class="theadstyle">Mobile No</th>				
										<th class="theadstyle">Job Work Category</th>
										<th class="theadstyle">Primary Job Work Line</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="text" name="frmSrchjobwrkname" class="form-control" id="frmSrchjobwrkname" placeholder="Free Text">
											...
											<td>
                                                <select name="frmSrchjobwrk_category" id="frmSrchjobwrk_category" class="form-control">
                                                <option value="">Select</option>
											...
											<td>
                                               <input type="text" name="frmSrch_primaryjobwrkline" class="form-control" id="frmSrch_primaryjobwrkline" placeholder="Free Text">
                                            </td>
											<td>
                    ...
                    <div class="col-sm-12 " style="padding:13px 0">
                        <div class="btn-toolbar pull-right py-0" role="toolbar" aria-label="Toolbar with button groups">
                            ...
                            <div class="btn-group" role="group" aria-label="Third group">
                                <button class="btn btn-sm btn-royal-blue" id="refreshBtn" onclick="refreshPage('frmNameSearch');">
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body no-padding">
                            <table id="tableId" class="table table-bordered table-hover" style="padding: 0 2px; border-bottom: 1px solid #022B61!important;">
                                <thead>
                                <tr>
                                    <th  class="no-sort"></th>
                                    <th id="0">Dyeing Job Work Name</th> 
									<th id="1">Contact Person</th>
                                    <th id="2">Email ID</th>
                                    <th id="3">Phone No</th>
                                    <th id="4">Mobile No</th>
									<th id="5">Job Work Category</th>
									<th id="6">Primary Job Work Line</th>
									<th id="7">Status</th>
