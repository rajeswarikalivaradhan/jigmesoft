...
class Mmanagementuser extends CI_Controller {
    ...
    public function addedit() {
        ...
        $this->load->view('management/addedituser', $ArrData);
    }
    ...
    public function manage() {
        ...
        if ($VarFrom == 1) {
            ...
            $config['base_url']    = base_url().CNFCOMPANY.'mmanagementuser/manage/';
            ...
            $data['pagination'] = $this->pagination->create_linkswithajax('MgmtUser');
            $i                  = 0;
            $ArrFnlList         = array();
            $ArrStatus          = unserialize(ARRSTATUS);
            ...
            $this->load->view('management/managemgmtuser',array('ArrDesignation' => $ArrDesignation,
                'ArrStatus' => unserialize(ARRSTATUS)));
        }
    }
