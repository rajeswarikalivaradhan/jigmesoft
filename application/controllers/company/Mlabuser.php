...
class mlabuser extends CI_Controller {
    ...
    public function addedit() {
        ...
        $this->load->view('lab/addeditlabuser',$ArrData);
    }
    ...
    public function manage() {
        ...
        if ($VarFrom == 1) {
            ...
            $config['base_url']    = base_url().CNFCOMPANY.'mlabuser/manage/';
            ...
            $data['pagination'] = $this->pagination->create_linkswithajax('LabUser');
            $i                  = 0;
            $ArrFnlList         = array();
            ...
            $this->load->view('lab/managelabusers',array('ArrDesignation' => $ArrDesignation,
                'ArrStatus' => unserialize(ARRSTATUS)));
        }
    }
