...
class Mdocandlocuser extends CI_Controller {
    ...
    public function addedit() {
        ...
        $this->load->view('mdocandloc/addeditdocandlocuser',$ArrData);
    }
    ...
    public function manage() {
        ...
        if ($VarFrom == 1) {
            ...
            $config['base_url']    = base_url().CNFCOMPANY.'mdocandlocuser/manage/';
            ...
            $data['pagination'] = $this->pagination->create_linkswithajax('Doc_LogisticsUser');
            $i                  = 0;
            $ArrFnlList         = array();
            ...
            $this->load->view('mdocandloc/managedocandlocusers',array('ArrDesignation' => $ArrDesignation,
                'ArrStatus' => unserialize(ARRSTATUS)));
        }
    }
