function fnSaveQueries() {
    ...
    $.ajax({
        url 		: base_path+'seller/queries/sendRequestQueries',
...
function fnSearchTicketInfo() {
    ...
    MakePostRequest(base_path+'ws/queries/manageticket',GlbSearchParam,'json',fnListAllTicketRes);
}
                ...
                if(data.cn>0) {
                    ...
                    if(data.ct>0) {
                        $.each(data.re,function(index,value){
                            ...
                            PageContent=PageContent+'<a href="'+base_path+'ws/queries/ticketdetails/'+value.id+'/"><i class="fa fa-file-text-o"></i> View Status</a>&nbsp;&nbsp;';
...
function fnShowProfileCont(VarDivShow) {
    var ArrProfileContList = ["DivContTicketInfo","DivContTicketReplies","DivContTicketRepliesForm"];
    //Remove Class
...
function fnSaveTicketRepliedMsg() {
    ...
    $.ajax({
        url 		: base_path+'ws/queries/sendRepliedQueries',
        data        : ProfileFormData ? ProfileFormData : ObjForm.serialize(),
        cache       : false,
        contentType : false,
        processData : false,
...
function fnShowTicketRepliedInfo(RepliedId,UserId) {
    ...
    MakePostRequest(base_path+"ws/queries/GetQueriesRepliedDetails/",Parameters,'json',fnShowTicketRepliedInfoRes);
}
