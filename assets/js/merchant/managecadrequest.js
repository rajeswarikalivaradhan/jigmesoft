...
function fnListCadRequest() {
    ...
    MakeAsynPostRequest(base_path+'merchant/managecadrequest',GlbSearchParam,'json',fnListCadRequestRes);
}
...
function fnSearchCadReq() {
    ...
    GlbSearchParam				= "rfrom=1&wip="+WipRefNo+"&cutfrom="+CutOffFrom+"&cutto="+CutOffTo+"&req="+Requirement+"&cs="+CStatus+"&afilter="+
        GlbFilterAlpha+"&columnId="+GlbColumnId+"&sortorder="+GlbSortOrder+"&reqtype="+ReqType+"&mer="+Merchant+"&bb="+BB;
    $("#DivTotalCntResult").html('');
    MakePostRequest(base_path+'merchant/managecadrequest',GlbSearchParam,'json',fnListCadRequestRes);
}
