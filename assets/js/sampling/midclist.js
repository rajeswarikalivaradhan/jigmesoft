...
$(document).ready(function() {
	...
	{
		return $.ajax({
			url: base_path+'company/msamplinguser/getMIDCList',
			type:'POST',
                ...
                "aoColumns": [		
                    { 
                        ...
                        "mDataProp": function(data, type, full, meta) {
                            ...
                            if (data.mi_ref_no !== "" && data.mi_ref_no !== null && data.mi_ref_no !== undefined) {
   return '<input type="checkbox" class="allcbox" id="'+data.mi_issue_id+'">'
}else{
    return '<input type="checkbox" class="allcbox" id="'+data.mat_ind_cad_id+'">'
}
						;
                        }
                    },
     ...
     return "M.I."+data.cad_ref_no;
                    ...
                    },
                    {
                        "mDataProp": function ( data, type, full, meta) {
                            ...
                            if (data.dc_no !== "" && data.dc_no !== null && data.dc_no !== undefined) {
                ...
                if (checkBoxLength >= 1) {
                    ...
                    swalWithBootstrapButtons.fire(
                         ...
                         if (result.value) {
                           //alert(idJson);
                            MakeAsynPostRequest(base_path + 'dashboard/changeReqStatus', 'id=' + idJson + '&cs=' + dropdownOpt +
                            '&tblname=tbl_mi_cad_details'+'&idName=mat_ind_cad_id ', 'json', function (data) {
                                $.when(getQueueList()).done(function(){
                                    dispDetails(reqRequestJSON)
