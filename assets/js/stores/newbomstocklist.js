...
function fnList() {
    ...
    GlbSearchParam = 'rfrom=1&rid='+lasturlpart;
    MakeAsynPostRequest(base_path+'storesuser/newbomstocklist',GlbSearchParam,'json',fnListRes);
}
                ...
                if(data.cn>0) {
                    ...
                    if(data.ct>0) {
                        $.each(data.re,function(index,value) {
                            ...
                            '<td>'+value.garmentsize+'</td>'+
                            '<td>'+value.itemcode+'</td>'+
                            '<td>'+value.indrefno+'</td>'+
                            '<td>'+value.indcutoffdt+'</td>'+
