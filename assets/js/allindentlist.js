...
function fnListIndent() {
    $("#DivTotalCntResult").html('');
    GlbSearchParam = 'rfrom=1';
    MakeAsynPostRequest(base_path+'dashboard/indentlist',GlbSearchParam,'json',fnListIndentRes);
}
...
function fnSearchIndent() {
    ...
    if(GlbUserType == 3 || GlbUserType == 15 || GlbUserType == 4) { // Note GlbUserType == 15 included in this files at GlbUserType == 3 places
    ...
    $("#DivTotalCntResult").html('');
    MakePostRequest(base_path+'dashboard/indentlist',GlbSearchParam,'json',fnListIndentRes);
}
            ...
            if(data.errcode == '404') {
                ...
                if(data.cn>0) {
                    ...
                    if(data.ct>0) {
                        ...
                        if(GlbUserType == 3 || GlbUserType == 15 || GlbUserType == 4) {
                            $.each(data.re,function(index,value) {
                                PageContent = PageContent + '<tr><td><input type="checkbox" class="allcbox" id="' + value.id + '"></td>' +
                                    ...
                                    '<td><a href="' + base_path + 'dashboard/allqueuelistdetail/' + encodeURIComponent(base64_encode(value.id)) + '">' + value.wip + '</a></td>' +
                                    '<td>' + value.bb + '</td>' +
                                    '<td><a href="' + base_path + 'caduser/cadindentdetails/' + encodeURIComponent(base64_encode(value.id)) + '"> ' + value.qno + '</a></td>' +
                                    '<td>' + value.indto + '</td>' +
                ...
                $('tbody').empty();
                //mIndentList
                $('#mIndentList').append(PageContent);
            }
        }
    }
}
...
$('#mIndentList').on('click', 'th.sortable', function () {
