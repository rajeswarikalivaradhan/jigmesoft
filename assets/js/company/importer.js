...
function fnSave() {
    ...
    if (jsTrim(AgentCategory) == "") {
        $('#Erragent_categoryid').text("Select Importer Category");
        ...
        return false;
            ...
            swalWithBootstrapButtons.fire(
            {
               ...
               // text: "If you save You won't be able to revert this!",
				...
				if (result.value) {
                    MakeAsynPostRequest(base_path + GlbCompanyFdr + "Magent/updateImporterInfo",
                        ...
                        if (data.errcode == '404') {
                            ...
                            swalWithBootstrapButtons.fire({
                                            ...
                                            customClass: {'confirmButton': 'btn btn-info'}
                                                ...
                                                let redirectpath = base_path + GlbCompanyFdr + 'Magent/importer';
...
function fnList() {
    ...
    MakeAsynPostRequest(base_path + GlbCompanyFdr + 'Magent/importer', GlbSearchParam, 'json', fnListAgentRes);
}
                    ...
                    if (data.ct > 0) {
                        $.each(data.re, function (index, value) {
                            PageContent = PageContent + '<tr>' +
                                ...
                                '<td>' + value.ub + '</td>' +
                                '<td>' + value.du + '</td>' +
                                '<td><a href="' + base_path + GlbCompanyFdr + 'Magent/importaddedit/' + encodeURIComponent(base64_encode(value.id)) + '/edit' + '">View</a></td>';
                            ;
                            PageContent = PageContent + '</tr>';
                        });
                    }
