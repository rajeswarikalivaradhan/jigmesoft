...
function fnListCadIndent() {
    $("#DivTotalCntResult").html('');
    GlbSearchParam = 'rfrom=1';
    MakeAsynPostRequest(base_path+'merchant/manageindent/',GlbSearchParam,'json',fnListCadIndentRes);
}
...
function fnSearchCadIndent() {
    ...
    $("#DivTotalCntResult").html('');
    MakePostRequest(base_path+'merchant/manageindent',GlbSearchParam,'json',fnListCadIndentRes);
}
