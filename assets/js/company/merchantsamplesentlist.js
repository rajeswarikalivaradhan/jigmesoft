...
if(lasturlpart == 'managecadrequest') {
    ...
    function fnListCadRequest() {
        ...
        MakeAsynPostRequest(base_path+GlbCompanyFdr+'mcadrequest/managemgmtcadrequest',GlbSearchParam,'json',fnListCadMgmtRequestRes);
    }
...
function fnSearchCadReq() {
    ...
    $("#DivTotalCntResult").html('');
    MakePostRequest(base_path+GlbCompanyFdr+'mcadrequest/managecadrequest',GlbSearchParam,'json',fnListCadRequestRes);
}

function fnListMerchantSampleSentList() {
    $("#DivTotalCntResult").html('');
    GlbSearchParam = 'rfrom=1';
    MakeAsynPostRequest(base_path+GlbCompanyFdr+'msamplerequest/merchantsamplesentlist',GlbSearchParam,'json',fnListMerchantSampleSentListRes);
}

function fnListMerchantSampleSentListRes(data) {
    if(data!=''){
