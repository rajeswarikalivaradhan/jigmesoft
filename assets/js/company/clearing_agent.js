...
function fnSave() {
    ...
    if (jsTrim(AgentCategory) == "") {
        $('#Erragent_categoryid').text("Select Clearing Agent Category");
        ...
        return false;
            ...
            swalWithBootstrapButtons.fire(
            {
               ...
               // text: "If you save You won't be able to revert this!",
				...
				if (result.value) {
                    MakeAsynPostRequest(base_path + GlbCompanyFdr + "Magent/updateClearingAgentInfo",
                        ...
                        if (data.errcode == '404') {
                            ...
                            swalWithBootstrapButtons.fire({
                                            ...
                                            customClass: {'confirmButton': 'btn btn-info'}
                                                ...
                                                let redirectpath = base_path + GlbCompanyFdr + 'Magent/manage';
...
function fnList() {
    ...
    MakeAsynPostRequest(base_path + GlbCompanyFdr + 'Magent/manage', GlbSearchParam, 'json', fnListAgentRes);
}
                    ...
                    if (data.ct > 0) {
                        $.each(data.re, function (index, value) {
                            PageContent = PageContent + '<tr>' +
                                ...
                                '<td>' + value.ub + '</td>' +
                                '<td>' + value.du + '</td>' +
                                '<td><a href="' + base_path + GlbCompanyFdr + 'Magent/addedit/' + encodeURIComponent(base64_encode(value.id)) + '/edit' + '">View</a></td>';
                            ;
                            PageContent = PageContent + '</tr>';
                        });
                    }
