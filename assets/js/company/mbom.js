                    ...
                    if (data.ct > 0) {
                        $.each(data.re, function (index, value) {
                            PageContent = PageContent + '<tr><td><input type="checkbox" class="allcbox" id="' + value.id + '"></td>' +
                                ...
                                '<td>' + value.du + '</td>' +
                                '<td><a href="' + base_path + GlbCompanyFdr + 'mbom/addedit/' + encodeURIComponent(base64_encode(value.id)) + '/edit' + '">View</a></td>';
        ...
        if (data.errcode == '404') {
           ...
           swalWithBootstrapButtons.fire({
            ...
            swalWithBootstrapButtons.fire({
                ...
                let redirectpath = base_path + GlbCompanyFdr + 'mbom/manage';
