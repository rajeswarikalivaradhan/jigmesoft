...
function fnSearchSamReceivedList() {
    ...
    MakePostRequest(base_path+'productionuser/productionreceivedlist',GlbSearchParam,'json',fnRecdListRes);
}

function fnRecdList() {
    $("#DivTotalCntResult").html('');
    GlbSearchParam = 'rfrom=1';
    MakeAsynPostRequest(base_path+'productionuser/productionreceivedlist',GlbSearchParam,'json',fnRecdListRes);
}
...
function fnChangeStatusRes(data) {
    ...
    $('#SamReceivedListTbl').on('click', 'th.sortable', function () {
        ...
        MakePostRequest(base_path+'productionuser/productionreceivedlist',Param,'json',fnRecdListRes);
    });
