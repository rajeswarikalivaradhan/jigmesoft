$(document).ready(function () {
    ...
    function getCadMIDetails() {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Bomrequest/getDCList',
            data: data,
            processData: false,
            contentType: false,
            cache: false,
        ...
        let list = {
            ...
            columns: [
                ...
                { type: 'checkbox', title: 'Mark', width: '8%', align: 'left' },
                 { type: 'text', title: 'Sample Ref. No.', width: '8%', align: 'center', readOnly: true },
                ...
                { type: 'text', title: 'Qty.', width: '6%', align: 'center', readOnly: true },
                { type: 'text', title: 'UOM', width: '6%', align: 'center', readOnly: true },
                // { type: 'button', title: 'Clear', width: '6%', align: 'center' },
            ],
            // columns: data.column,
            minDimensions: [4, 1],
    ...
    function clearDraftFunction()
    {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Bomrequest/clearDraftFunction',
            data: dataform,
            processData: false,
            contentType: false,
            cache: false,
    ...
    function updateFunction() {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Bomrequest/updateDCList',
            data: dataform,
            processData: false,
            contentType: false,
            cache: false,
