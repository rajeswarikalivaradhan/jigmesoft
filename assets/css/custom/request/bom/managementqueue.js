    ...
    function append_item_accept_status(data) {
        ...
        let list = {
            ...
            columns: [
                ...
                { title: 'Merchant Status \n Update Date & Time', width: '8%', align: 'center', type: 'text', options: { format: 'DD/MM/YYYY h:s A' }, readOnly: true },
                { title: 'Q.A. Status', width: '8%', align: 'center', type: 'dropdown', source: approvalStatusData, readOnly: true },
                { title: 'Q.A. Status Update\n Date & Time', width: '8%', align: 'center', type: 'text', options: { format: 'DD/MM/YYYY h:s A' }, readOnly: true },
