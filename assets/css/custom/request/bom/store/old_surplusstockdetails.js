$(document).ready(function () {
    ...
    function append_in_house_details(data) {
        ...
        let list = {
            ...
            columns: [
                ...
                { title: 'Total P.I. Qty', width: '8%', align: 'right', readOnly: true },
                { title: 'Total Received\n Qty.', width: '8%', align: 'right', readOnly: true },
                { title: 'Surplus Stock\n Qty.', width: '8%', align: 'center', readOnly: true },
                { title: 'UOM', width: '6%', align: 'center', type: 'calendar', readOnly: true },
                { title: 'Surplus\n Stock (%)', width: '8%', align: 'right' },
                { title: 'Surplus Stock\n Received Date', width: '8%', align: 'right', type: 'calendar', readOnly: true },
    ...
    function append_shipment_order_closure_details(data) {
        ...
        let list = {
            ...
            columns: [
                { title:'id', width:'0%',align:'center',type:'hidden'},
                { title: 'Received Surplus\n Stock Qty.', width: '8%', align: 'left', readOnly: true },
                { title: 'Total Issued Qty.', width: '6%', align: 'left', readOnly: true },
                { title: 'Total\n Defective Qty.', width: '5%', align: 'center', readOnly: true },
                { title: 'Total Defective\n Qty.Replaced', width: '6%', align: 'left', readOnly: true },
                { title: 'Total Excess Qty.\n Returned ', width: '6%', align: 'left', readOnly: true },
                { title: 'Total\n Available Qty.', width: '5%', align: 'center', readOnly: true },
                { title: 'UOM', width: '5%', align: 'right', readOnly: true },
                { title: 'Surplus Stock\n Closure Status', width: '5%', align: 'center', type: 'dropdown', source: finalShipmentData },
                { title: 'Stock Closure\n Date & Time', width: '5%', align: 'right', type: 'calendar' },
                { title: 'Stock Closure\n Reason', width: '5%', align: 'center', type: 'dropdown', source: availableStockData },
            ],
            minDimensions: [4, 1],
            allowDeleteColumn: false,
            allowInsertRow: false,
