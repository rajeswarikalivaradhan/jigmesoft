    ...
    function append_item_accept_status(data) {
        ...
        let list = {
            ...
            columns: [
                ...
                { type: 'text', title: 'Sample No.', width: '6%', align: 'left', readOnly: true },
    ...
    function append_in_house_consolidated_qty(data) {
        ...
        let list = {
            ...
            columns: [
                ...
                { type: 'dropdown', title: 'Sample No.', width: '8%', align: 'left', source: data.MINo, filter:miNoFilter },
