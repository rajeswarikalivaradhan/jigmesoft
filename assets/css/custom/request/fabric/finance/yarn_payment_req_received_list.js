	...
	function dispDetails(reqRequestJSON)
	{
		...
		$("#bomPurchaseReceivedListTbl").dataTable({
			...
			"aoColumns": [	
				...
				{ 
					"mDataProp": function ( data, type, full, meta) {
						return '<a class="bold" href="' + base_path +'request/Fabricrequest/yarnpaymentreqreceiveddetails' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqYarnId/' + encodeURIComponent(btoa(data.request_yarn_id)) + '"> P.I. No. </a>';
					}
				},	
