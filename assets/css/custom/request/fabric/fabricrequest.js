$(document).ready(function () {
    ...
    // **************************************** //
    var fabricRequest_vm = '';
    var fabricReference_vm = '';
    var mode = 'add';
    var req_id = '';
    ...
    $('#getValues').click(function () {
        if($('#req_type').val() == '')
        {
            $('#err_req_type').html('Please select request type');
        }
        else {
    ...
    function updateFunction() {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Fabricrequest/createFabricRequest',
            data: dataform,
            processData: false,
            contentType: false,
            cache: false,
            success: function (data) {
                ...
                setTimeout(() => {
                    window.location.href = base_path + 'MerchantRequestSent';
                }, 1000);
            },
            error: function () {
                console.log("Error");
