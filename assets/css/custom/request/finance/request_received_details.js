$(document).ready(function () {
    ...
    function alertMessageFunction(mode) {
        ...
        if(mode == "amounterror") {
            return {
                title: 'Warning',
                text: "Please check amount not equal",
                icon: 'warning',
                confirmButtonText: 'OK',
                customClass: {
                    'confirmButton': 'btn btn-secondary px-5'
    ...
    function append_payment_request_bill(data) {
        ...
        let list = {
            ...
            columns: [
                { title:'id', width:'0%',align:'center',type:'hidden'},
                { title: "Req. Count", width: '3%', align: 'center', readOnly: true},
                { type: 'text', title: 'Vendor Name', width: '6%', align: 'left', readOnly: true },
                ...
                { type: 'text', title: 'Invoice No.', width: '6%', align: 'center', readOnly: true},
                ...
                { type: 'text', title: 'Debit Value If Any', width: '6%', align: 'right', readOnly: true},
                { type: 'text', title: 'Credits / W.O\n Value If Any', width: '6%', align: 'right'},
                { title: 'Amount\n Payable', width: '6%', align: 'right', readOnly: true},
                { type: 'text', title: 'Currency', width: '6%', align: 'center',  readOnly: true},
                { type: 'text', title: 'Acc. Mode\n of Payment', width: '7%', align: 'center',  readOnly: true},
    ...
    function append_credit_note_request(data) {
        ...
        let list = {
            ...
            columns: [
                { title:'mode', width:'0%',align:'center',type:'hidden'},
                { title:'id', width:'0%',align:'center',type:'hidden'},
                { title: 'Description', width: '7%', align: 'left', type: 'dropdown', source: description },
                { title: 'Towards \nInvoice No.', width: '6%', align: 'left', type: 'dropdown',source: data.pi_invno},
                { title: 'Credit Into - Account \nName', width: '8%', align: 'center', type: 'text' },
                { title: 'Credit Into - \nAccount Number', width: '8%', align: 'center', type: 'text' },
    ...
    function append_payment_paid_request(data) {
        ...
        let list = {
            ...
            columns: [
                { title:'mode', width:'0%',align:'center',type:'hidden'},
                { title:'id', width:'0%',align:'center',type:'hidden'},
                { title:'Req. Count', width:'5%',align:'center',type:'dropdown',source:data.rc_no,filter: dropdownFilter},
                { title: 'Paid in Favour of', width: '7%', align: 'left', type: 'text', readOnly: true },
                { title: 'Bank Name', width: '12%', align: 'left', readOnly: true },
                { title: 'Account Number', width: '10%', align: 'center', readOnly: true },
                { title: 'Mode of\n Payment', width: '6%', align: 'center', type: 'dropdown', source: [ 'IMPS', 'NEFT', 'RTGS', 'SWIFT', 'CHEQUE', 'CASH' ] },
                { title: 'Transaction ID /\nCheque / Voucher No.', width: '6%', align: 'left' },
                { title: 'Transaction\nCheque / Voucher Date', width: '6%', align: 'center', type:'calendar', options: {format: 'DD/MM/YYYY'} },
    ...
    function append_purchase_request_others(data, tblData = []) {
        ...
        let list = {
            ...
            columns: [
                ...
                { type: 'text',title: 'IFSC Code /\nSWIFT Code', width: '7%', align: 'center', readOnly: true},
                { type: 'text',title: 'Expenses Incured Towards', width: '7%', align: 'center', readOnly: true},
                ...
                { type: 'text',title: 'Amount Payable', width: '7%', align: 'right', readOnly: true},
