$(document).ready(function () {
    ...
    $("#oe_submitPOSize").click(function () {
      ...
      if (validate == 0) {
        ...
        for (let i = 0; i < oe_po_sizewise_data.data.length; i++) {
          poSizeTotal += parseFloat(
            oe_po_sizewise_data.data[i][oe_po_sizewise_data.data[i].length - 2]
          );
        }
                  ...
                  if (result.isConfirmed) {
                    ...
                    setTimeout(function () {
                      $("html, body").animate(
                        {
                          scrollTop:
                            $(".nav-tabs.order-entry").offset().top - 130, // adjust offset for sticky header
                        },
                        500
                      );
                    }, 300);
  ...
  function colorFilter(instance, cell, c, r, source) {
    ...
    if (component_id !== "") {
      return source.filter(function (item) {
        if (item.component_id == component_id && item.combo_id == combo_id)
          return true;
      });
    } else {
      return [];
  ...
  function append_oe_complete_process(data) {
    ...
    let oe_complete_process = {
      ...
      columns: [
        ...
        {
          type: "dropdown",
          title: "Size Spec Code / Fit",
          width: "10%",
          source: data.specCode,
          filter: orderspecFilter,
          multiple: true,
          align: "left",
        },
        {
  ...
  function append_cad_requirement(data) {
    ...
    let cad_requirement = {
      ...
      columns: [
        ...
        { title: "id", width: "10%", align: "center", type: "hidden" },
        {
          ...
          align: "left",
          source: data.poEnqRefNo,
          placeholder: jexcelPlaceHolders.dropdown,
        },
        {
          type: "dropdown",
          title: "Combo / Colour",
        ...
        {
          type: "dropdown",
          title: "Required Size(s)",
          width: "7%",
          align: "center",
          source: data.sizeData,
        },
        {
          type: "calendar",
          title: "Planned\n Date",
    ...
    $("#oe_submitCADRequirement").click(function () {
      ...
      let pendingField = "";
      let statusCheck = "no";
      let validatedErrorCount = validateForm(
        validate_filed,
        validate_data,
        statusCheck,
        optional_validation_field,
  ...
  function update_oe_cad_requirement(data) {
    ...
    let request = $.ajax({
      ...
      success: function (data) {
        ...
        // *** SAVED MESSAGE *** //
        swalWithBootstrapButtons
          .fire(alertMessageFunction("saved"))
          .then(function (result) {
            if (result.isConfirmed) {
    ...
    let sample_requirement_wise = {
      ...
      columns: [
        ...
        },
        {
          ...
          width: "7%",
          align: "left",
          source: ["Mon", "Tue", "Wed", "Thur", "Fri", "Sat", "Sun", "All"],
          multiple: true,
        },
        {
          title: "Planned \nDate",
      ...
      updateTable: function (
        ...
        if (col == 5) {
          ...
          if (component != "" && combo != "") {
            ...
            let obj = poColor.find(
              (o) => o.component_id === component && o.combo_id === combo
            );
            $(cell).text(obj.name);
  ...
  function append_embellishment_details(data) {
    ...
    let embellishment_wise = {
      ...
      columns: [
        ...
        {
          title: "Medium / Material",
          width: "7%",
          align: "left",
          type: "dropdown",
          source: data.type_medium,
          multiple: true,
        },
    ...
    let embellishment_vendor_wise = {
      ...
      columns: [
        ...
        },
        {
          ...
          align: "left",
          type: "dropdown",
          source: data.embellishmentVendor,
        },
        {
    ...
    let bom_sampling_details_wise = {
      ...
      columns: [
        ...
        },
        {
          ...
          type: "calendar",
          type: "dropdown",
          source: ["Buyer", "Liason Office", "Buying Office", "Others"],
        },
  ...
  function contentFilter(instance, cell, c, r, source) {
    ...
    if (blend_name !== "") {
      return source.filter(function (item) {
        if (item.blend_name == blend_name && item.item_name == item_name)
          return true;
      });
    } else {
      return [];
    ...
    if (garment_size_name !== "") {
      return source.filter(function (item) {
        if (
          ...
          item.content_name == content_name &&
          item.material_name == material_name &&
          item.garment_size_name == garment_size_name
        )
          return true;
      });
    } else {
    ...
    if (appr_item_code !== "") {
      return source.filter(function (item) {
        if (
          ...
          item.material_name == material_name &&
          item.garment_size_name == garment_size_name &&
          item.appr_item_code == appr_item_code
        )
          return true;
      });
    } else {
  ...
  function append_bom_requirement_details(data) {
    ...
    let dd = data.appendData.calculatedAmmount,
      updatedRow = "",
      inupdatedRow = "",
      filterValue = "",
      filterValue1 = "",
    ...
    let bom1_requirement_details = {
      ...
      columns: [
        ...
        { title: "id", width: 130, type: "hidden", align: "center" },
        {
          ...
          width: 130,
          align: "left",
          source: data.appendData.poEnqRefNo,
        },
        {
          type: "dropdown",
          title: "Combo",
          width: 130,
          align: "left",
          source: data.appendData.poCombo,
          filter: comboFilter_bom1,
        },
        {
          type: "dropdown",
          title: "Component",
          width: 130,
          align: "left",
          source: data.appendData.poComponent,
          filter: componentFilter,
        },
        {
          type: "dropdown",
          ...
          width: 130,
          align: "left",
          source: data.appendData.poColor,
          filter: colorFilter,
          readOnly: true,
        },
        // { type: 'dropdown', title: 'Size Spec \n Code / Fit', width: 130, align: 'left', source: data.appendData.specCode, filter: specFilter,readOnly: true },
        {
          ...
          title: "Size Spec \n Code / Fit",
          width: "10%",
          source: data.appendData.specCode,
          filter: orderspecFilter_sample,
          multiple: true,
          align: "left",
        },
        ...
        },
        {
          ...
          align: "left",
          type: "dropdown",
          source: data.apprItemCodeSource,
          filter: appr_item_Filter,
          readOnly: true,
        },
        {
          title: "Approved Item\n Colour Code",
          ...
          align: "left",
          type: "dropdown",
          source: data.apprItemColourCodeSource,
          filter: appr_item_color_Filter,
          readOnly: true,
        },
        {
          title: "Size / Dim.\n (L*W*H)",
          ...
          align: "center",
          type: "dropdown",
          source: data.sizeDimSource,
          filter: size_dim_Filter,
          readOnly: true,
        },
        {
          title: "UOM",
      ...
      updateTable: function (instance, cell, col, row, val, label, cellName) {
        ...
        if (col == 5) {
          if (component != "" && combo != "") {
            ...
            filterValue = dd.findIndex(function (item) {
              if (item.combo == combo && item.component == component)
                return true;
            });
        ...
        if (col == 12) {
          ...
          if (component != "" && garment_size_name != "") {
            ...
            let garment_size_code_source =
              bom1_requirement_details.columns[12].source;
            let item_name = bom1_requirement_details.data[row][7];

            let match = garment_size_code_source.find(
              (obj) =>
                obj.garment_size_name === garment_size &&
        ...
        if (col == 13) {
          ...
          if (component != "" && garment_size_name != "") {
            let garment_size = bom1_requirement_details.data[row][11]; // this is the selected item_name
            let item_name = bom1_requirement_details.data[row][7];
            let colour_code_source =
              bom1_requirement_details.columns[13].source;
            let match = colour_code_source.find(
              (obj) =>
                obj.garment_size_name === garment_size &&
                obj.item_name === item_name
            );
        ...
        if (col == 14) {
          ...
          if (component != "" && garment_size_name != "") {
            ...
            let item_name = bom1_requirement_details.data[row][7];
            let match = size_dimen_source.find(
              (obj) =>
                obj.garment_size_name === garment_size &&
                obj.item_name === item_name
            );
          ...
          if (component != "" && garment_size_name != "") {
            ...
            if (po_ref == "All") {
              ...
              let filterValue1 = dd.findIndex(function (item) {
                return (
                  item.po_ref.trim().toLowerCase() ==
                    po_ref.trim().toLowerCase() &&
                  item.combo.trim().toLowerCase() ==
  ...
  function append_bom_requirement_consolidated_details(data) {
    ...
    let bom1_requirement_qty_consolidated_wise = {
      ...
      updateTable: function (
        ...
        if (col == 14) {
          ...
          plan_bom =
            (parseFloat(bom_intake) * parseFloat(excess_qty)) / 100 +
            parseFloat(bom_intake);
    ...
    var bom1_requirement_consld_vm = new Vue({
      ...
      mounted: function () {
        let spreadsheet = jexcel(
          this.$el,
          bom1_requirement_qty_consolidated_wise
        );
        //spreadsheet.setOverflowDrag(true);
        Object.assign(this, spreadsheet);
      },
    ...
    let bom1_sourcing_details_wise = {
      ...
      columns: [
        ...
        },
        {
          ...
          width: "6%",
          align: "left",
          source: ["Local", "Within State", "Within Country", "Overseas"],
        },
        {
          type: "dropdown",
          title: "Vendor Name & \n Address",
          width: "9%",
          align: "left",
          source: data.bomVendor,
        },
        {
          title: "Contact Person / e-mail ID / Phone / Mobile",
          width: "9%",
          align: "left",
          readOnly: true,
        },
        {
          title: "GST / IE Code Details",
          width: "7%",
          align: "left",
          readOnly: true,
        },
        {
          title: "If On-line Ordering System\n Website / User ID / Password",
          width: "10%",
          align: "left",
        },
        {
    ...
    let bom_sampling_details_wise = {
      ...
      updateTable: function (
        ...
        if (col == 10) {
          prevCol = col - 1;
          if (
            instance.jexcel.options.data[row][prevCol] == "PENDING" ||
            instance.jexcel.options.data[row][prevCol] == "1"
          ) {
            cell.classList.add("readonly");
            $(cell).text("");
            instance.jexcel.options.data[row][col] = "";
      ...
      updateTable: function (instance, cell, col, row, val, label, cellName) {
        ...
        if (col == 12) {
          ...
          if (component != "" && garment_size_name != "") {
            ...
            let garment_size_code_source =
              bom2_requirement_details.columns[12].source;
        ...
        if (col == 13) {
          ...
          if (component != "" && garment_size_name != "") {
            ...
            let item_name = bom2_requirement_details.data[row][7];
            let colour_code_source =
              bom2_requirement_details.columns[13].source;
            let match = colour_code_source.find(
              (obj) =>
                obj.garment_size_name === garment_size &&
                obj.item_name === item_name
      ...
      if (
        ...
        for (let j = 0; j < dataUniqueTable.length; j++) {
          ...
          let assort_idd =
            "aa" +
            data.details.pck_id +
            data.details.enquiry_id +
            data.details.pck_combo_color_id;
          ...
          let options = {
            ...
            allowInsertColumn: false,
            footers: footer(
              "packing_assort_" + assortment_type,
              data.column.length
            ),
            updateTable: function (
              instance,
    ...
    let final_inspection_standard = {
      ...
      updateTable: function (instance, cell, col, row, val, label, cellName) {
        ...
        if (col == 9) {
          ...
          instance.jexcel.options.data[row][col] =
            SampleSizeCl_SampleSizeGrp[sampleSizeCodeLetter];
        }
      },
    };
  ...
  function append_details_of_consignee_logistics(data) {
    ...
    let consignee_details_list = {
      ...
      columns: [
        ...
        {
          title: "Consignor / Shipper / Exporter",
          width: "8%",
          align: "left",
          type: "dropdown",
          source: data.consignorAgent,
        },
        {
          title:
            "Clearing Agent: Name / Address /\n Contact Person  / Mobile No.",
          width: "8%",
          align: "left",
          type: "dropdown",
          source: data.clearingAgent,
        },
        {
          title:
            "Forwarding Agent: Name / Address /\n Contact Person  / Mobile No.",
          width: "8%",
          align: "left",
          type: "dropdown",
          source: data.forwadingAgent,
        },
        {
          title:
            "Importer - If other than Consignee: Name /\n Address / Contact Person  / Mobile No.",
          width: "8%",
          align: "left",
          type: "dropdown",
          source: data.importerAgent,
        },
        {
    ...
    let bom1_item_accept_status = {
      ...
      columns: [
        ...
        },
        {
          ...
          type: "text",
          readOnly: true,
          options: { format: "DD/MM/YYYY HH12:MI AM/PM", time: 1 },
        },
        {
          title: "Q.A. Status",
          width: "8%",
  ...
  function append_bom_1_in_house_consolidated_qty_details(data) {
    ...
    var bom1PIDetails = new Vue({
      ...
      mounted: function () {
        let spreadsheet = jexcel(
          this.$el,
          bom1_in_house_consolidated_qty_details
        );
        Object.assign(this, spreadsheet);
      },
      methods: {
  ...
  function append_bom_2_in_house_consolidated_qty_details(data) {
    ...
    var bom1PIDetails = new Vue({
      ...
      mounted: function () {
        let spreadsheet = jexcel(
          this.$el,
          bom2_in_house_consolidated_qty_details
        );
        Object.assign(this, spreadsheet);
      },
      methods: {
  ...
  function append_sam_despatch_details(data) {
    ...
    let sam_despatch_details = {
      ...
      updateTable: function (instance, cell, col, row, val, label, cellName) {
        if (col == 7) {
          if (
            (data.despatchdetails[row][14] == "4" ||
              data.despatchdetails[row][14] == 4) &&
            (data.despatchdetails[row][15] != "1" ||
              data.despatchdetails[row][15] != 1)
          ) {
            $(cell).removeClass("readonly");
          } else {
        ...
        if (col == 11) {
          if (
            (data.despatchdetails[row][16] == "Yes" ||
              data.despatchdetails[row][16] == "0") &&
            (data.despatchdetails[row][15] == "1" ||
              data.despatchdetails[row][15] == 1)
          ) {
            $(cell).removeClass("readonly");
        ...
        if (col == 12) {
          if (
            data.despatchdetails[row][17] == "Yes" &&
            (data.despatchdetails[row][15] == "1" ||
              data.despatchdetails[row][15] == 1)
          ) {
            $(cell).removeClass("readonly");
        ...
        if (col == 13) {
          if (
            data.despatchdetails[row][18] == "Yes" &&
            (data.despatchdetails[row][15] == "1" ||
              data.despatchdetails[row][15] == 1)
          ) {
            $(cell).removeClass("readonly");
  ...
  $("#sample_req").click(function () {
    swalWithBootstrapButtons.fire(alertMessageFunction("empty"));
  });
  ...
  function placeCalendarAtCell(cell, force) {
    const cal =
      document.querySelector(".jcalendar-container") ||
      document.querySelector(".jcalendar");
    if (!cal || !cell) return;
    ...
    if (force === "above") {
      ...
      top =
        spaceBelow >= calH || spaceBelow >= spaceAbove
