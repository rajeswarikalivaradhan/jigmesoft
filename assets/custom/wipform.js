        ...
        return $.ajax({
            ...
            success:function(data){
                ...
                if(remarkNimageJSON.remarksData.length > 0) {
                    ...
                    $('.emb_remarks').val(remarkNimageJSON.remarksData[0].remarks);
                    $('.bom_remarks').val(remarkNimageJSON.remarksData[0].remarks);
                    $('.bom2_remarks').val(remarkNimageJSON.remarksData[0].remarks);
                    $('.packing_remarks').val(remarkNimageJSON.remarksData[0].remarks);
                    $('.final_remarks').val(remarkNimageJSON.remarksData[0].remarks);
                    $('.documentation_remarks').val(remarkNimageJSON.remarksData[0].remarks);
...
//  if(remarks == ''){ 
//     swalWithBootstrapButtons.fire({
//         title: 'Please enter remarks', icon: 'error', customClass: { confirmButton: 'btn btn-secondary px-5' }
//     });
// }else{
//     if (hasFilename == 0) {
//     swalWithBootstrapButtons.fire({
...
//     text: 'Your Order Entry details have been saved.',
//     confirmButtonText: 'OK',
//     customClass: {
 ...
 if(remarks == ''){ 
    ...
    swalWithBootstrapButtons.fire({
            ...
            success: function (res) {
                ...
                swalWithBootstrapButtons.fire({
                    title: 'Saved Successfully!',
                    text: 'Your remarks have been saved.',
                    icon: 'success',
...
if (container && container.querySelector('.ajax-file-upload-filename')) {
   ...
   let remarks = $('.documentation_remarks').val();
 ...
 if(remarks == ''){ 
    ...
    swalWithBootstrapButtons.fire({
            ...
            data: {
                enquiry_id: enquiry_id,
                type: 'documentation',
                remarks: $('.documentation_remarks').val()
            },
            beforeSend: function () {
                Swal.showLoading(); // Optional loading indicator
            },
