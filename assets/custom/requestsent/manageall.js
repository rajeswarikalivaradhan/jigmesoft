...
const inactiveBtn = document.getElementById('btn-inactive');  
	...
	{
		return $.ajax({
			url: base_path+'MerchantRequestSent/getManageAllList',
			type:'POST',
			...
			"aoColumns": [			
			    ...
			    },
				{
                    "mDataProp": function ( data, type, full, meta) {
                        ...
                        if(data.type == 1) {
                            if(userType == 2) {
                                return '<a class="bold" href="' + base_path +'management/cadrequestlist' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id))+ '">'+data.isriorcode+'</a>';
                            ...
                            if(userType == 2) {
                                return '<a class="bold" href="' + base_path +'request/Samplerequest/managament' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id))+ '">'+data.isriorcode+'</a>';
                              }else{  
                            ...
                            return '<a class="bold" href="' + base_path +'management/fabricrequestlist' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id))+ '">'+data.isriorcode+'</a>';
                        }
                        else {
  ...
  if(cutfromDate!=='' && cuttoDate!==''){
    ...
    var table = $('#MerAllReqSentAllList').DataTable();
