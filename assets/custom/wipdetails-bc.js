    ...
    function append_cad_requirement(data) {
        ...
        let cad_requirement = {
            ...
            columns: [
                ...
                { type: 'calendar', title: 'Planned Date & Time', width: '7%', align: 'center', options: { format:'DD/MM/YYYY HH12:MI AM/PM', time:1 } },
    ...
    function append_bom_sampling_approval_details(data) {
        ...
        let bom_sampling_details_wise = {
            ...
            columns: [
                ...
                { title: 'Blend (%)', 'width': '5%', align: 'center', type: 'dropdown', source: data.blendSource },
                { title: 'Content', 'width': '7%', align: 'center', type: 'dropdown', source: data.contentSource},
                { title: 'Material', 'width': '6%', align: 'center', type: 'dropdown', source: data.materialSource},
                ...
                { title: 'Approved\n Item Code', 'width': '7%', align: 'center' },
                { title: 'Approved Item\n Colour Code', 'width': '7%', align: 'center'},
                { title: 'Size / Dim.\n (L*W*H)', 'width': '6%',align: 'center' },
                { title: 'UOM', 'width': '5%', align: 'center', type: 'calendar', type: 'dropdown', source: data.UOMDetails },
    ...
    function append_bom_requirement_details(data) {
        ...
        let bom1_requirement_details = {
            ...
            columns: [
                { title:'mode', width:'0%',align:'center',type:'hidden'},
                { title:'id', width:'0%',align:'center',type:'hidden'},
                { type: 'dropdown',title: 'P.O. No. /\nEnq. Ref. No.',width: 130,align: 'center',source: data.appendData.poEnqRefNo,},
                { type: 'dropdown', title: 'Combo', width: 130, align: 'center',source: data.appendData.poCombo, filter: comboFilter,},
                { type: 'dropdown', title: 'Component',width: 130,align: 'center',source: data.appendData.poComponent, filter: componentFilter,},
                { type: 'dropdown', title: 'Colour', width: 130, align: 'center', source: data.appendData.poColor, filter: colorFilter, },
                { type: 'dropdown', title: 'Size Spec \n Code / Fit', width: 130, align: 'center', source: data.appendData.specCode, filter: specFilter, },
                { title: 'Item Description', width: 140, align: 'center', type: 'dropdown', source: data.itemSource},
                ...
                { title: 'Content', width: 130, align: 'center', type: 'dropdown', source: data.contentSource, filter: contentFilter},
                { title: 'Material', width: 120, align: 'center', type: 'dropdown', source: data.materialSource, filter: materialFilter},
                { title: 'Garment\n Size', width: 110, align: 'center', type: 'dropdown', source: data.garmentsizeSource, filter: sizeFilter },
                { title: 'Approved\n Item Code', width: 130, align: 'center', type: 'dropdown', source: data.apprItemCodeSource, filter: appr_item_Filter },
                { title: 'Approved Item\n Colour Code', width: 130, align: 'center', type: 'dropdown', source: data.apprItemColourCodeSource, filter: appr_item_color_Filter },
                { title: 'Size / Dim.\n (L*W*H)', width: 120, align: 'center', type: 'dropdown', source: data.sizeDimSource, filter: size_dim_Filter },
                { title: 'UOM', width: 110, align: 'center', type: 'dropdown', source: data.uomSource, filter: uom_Filter },
                { title: 'Itemized Qty.\n (Pcs.)', width: 120, align: 'center', readOnly:true },
                { title: 'BOM\n Intake', width: '4%', align: 'center' },
                { title: 'Reqd.\n BOM Qty.', width: 120, align: 'center' },
                { type: 'dropdown', title: 'UOM', width: 110, align: 'center', source: data.UOMDetails }
            ],
            minDimensions: [4, 1],
            allowDeleteColumn: false,
            allowInsertRow: true,
    ...
    function append_bom_requirement_consolidated_details(data) {
        ...
        let bom1_requirement_qty_consolidated_wise = {
            ...
            columns: [
                ...
                { title: 'Blend (%)', width: '6%', align: 'center', readOnly: true},
                { title: 'Content', width: '7%', align: 'center', readOnly: true},
                { title: 'Material', width: '6%', align: 'center', readOnly: true},
                { title: 'Garment\n Size', width: '5%', align: 'center', readOnly: true },
    ...
    function append_get_bom1_sampling_despatch(data) {
        ...
        let bom1_sampling_despatch = {
            ...
            columns: [
                ...
                { title: 'Airway Bill\n Date & Time', align: 'center', type: 'calendar', options: { format:'DD/MM/YYYY HH12:MI AM/PM', time:1 }},
                { title: 'Delivery Status', align: 'center', type: 'text'},
                { title: 'Delivery Date & Time\n(Tracker ID).', align: 'center', type: 'calendar', options: { format:'DD/MM/YYYY HH12:MI AM/PM', time:1 }},
            ],
            minDimensions: [4, 1],
            allowDeleteColumn: false,
            allowInsertRow: true,
