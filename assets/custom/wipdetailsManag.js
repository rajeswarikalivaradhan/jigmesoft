        ...
        let cad_requirement = {
            ...
            onchange: function(instance, cell, col, row, val, label, cellName) {
                if(col == 4) 
                {
                    ...
                    // {
                    //     index = dd.findIndex(function (val) {
                    //         if (val.combo_id == comboColor && val.component_id == txt ) return true;
                    //     });
                    //     cad_requirement.data[row][5] = dd[index]['name'];
        ...
        columns: [
           ...
           // { type: 'dropdown', title: 'Size Spec \n Code / Fit', width: '8%', align: 'left', source: data.specCode,  filter: orderspecFilter_sample, multiple: true,readOnly: true },
            ...
            onchange: function(instance, cell, col, row, val, label, cellName) {
                if(col == 4) 
                {
                   //instance.setValue([row, 6], '');
                   // table.setValue(row, col + 2, '');
                           //table.setValue(row, col + 2, '');
                    // updatedRow = row;
                    // txt = $(cell).text();
                    // dd = sample_requirement_wise.columns[5]['source'];
                    ...
                    // {
                    //     index = dd.findIndex(function (val) {
                    //         if (val.combo_id == combo &&  val.component_id == component && val.colour_id == txt ) return true;
                    //     });
                    //     sample_requirement_wise.data[row][5] = dd[index]['name'];
...
onopeneditor: function (el, cell, x, y) {
    setTimeout(() => {
        const dropdown = document.querySelector('.jexcel_dropdown_list, .jdropdown');
        ...
        // Scroll container if needed (optional)
        const container = document.querySelector('.tab-content'); // or use your specific container
        if (spaceBelow < dropdownHeight && spaceAbove > dropdownHeight) {
            // Position dropdown above the cell
            dropdown.style.top = (cell.offsetTop - dropdownHeight) + 'px';
        } else {
            // Default - position dropdown below the cell
    ...
    }, 100); // wait for dropdown to render
},
        ...
        let bom1_requirement_details = {
           ...
           // freezeColumns: 3,
            ...
            onchange: function(instance, cell, col, row, val, label, cellName) {
                ...
                //     //updatedRow = row;
                //     txt = $(cell).text();
                //     dd = bom1_requirement_details.columns[4]['source'];
                //     let po_no = bom1_requirement_details.data[row][2];
                //     let combo = bom1_requirement_details.data[row][3];
                //     let component = bom1_requirement_details.data[row][4]; 
                //      //console.log(dd) ;
                //     if(txt != '')
                //     {
                //         //let color=bom1_requirement_details.data[row][5];
                //         alert(JSON.stringify(dd));
                //         //alert(dd);
                //         index = dd.findIndex(function (val) {
                //             if (val.combo_id == combo &&  val.id == component ) return true;
                //         });
                        
                //         bom1_requirement_details.data[row][5] = "red";
                //         //bom1_requirement_details.data[row][6] = dd[index]['name'];
                //     }
                //     else
                //     {
                //         alert('else');
                //         bom1_requirement_details.data[row][7] = '';
                //         bom1_requirement_details.data[row][8] = '';
                //     }
                // }
                // if(col == 15) 
                // {
            ...
            updateTable: function(instance, cell, col, row, val, label, cellName) {
                ...
                if(col == 4)
                {
                    component = val;   
                     ...
                     //instance.jexcel.setValueFromCoords(6, row, "");
