$(document).ready(function () {
    ...
    if (i === nonSumCols - 1) {
        empar.push('Total:'); // Insert the label before sum columns start
       ...
       // let 
        let bom1_sourcing_details_wise = {
            ...
            columns: [
                ...
                { title: 'Item Description111', width: '8%', align: 'left', readOnly: true },
                // { title: 'Approved \n Item Code', width: '8%', align: 'left', readOnly: true },
                // { title: 'Approved \n Item Colour Code', width: '8%', align: 'left', readOnly: true },
                { type: 'dropdown', title: 'Sourcing Advice', width: '10%', align: 'left', source: data.sourceData, },
                { type: 'dropdown', title: 'Vendor Location', width: '10%', align: 'left', source: ['Local', 'Within State', 'Within Country', 'Overseas'], },
                { type: 'dropdown', title: 'Vendor Name & \n Address', width: '13%', align: 'left', source:data.bomVendor },
                { title: 'Contact Person / e-mail ID / Phone / Mobile', width: '10%', align: 'left', readOnly: true },
                { title: 'GST / IE Code Details', width: '8%', align: 'left', readOnly: true },
