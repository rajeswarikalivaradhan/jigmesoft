$(document).ready(function () {
    ...
    function getDraftPIRequest() {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Bomrequest/getAdvancePaidDetails',
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    function append_amount_paid_request(data) {
        ...
        let list = {
            ...
            columns: [
                ...
                { title: 'Transaction\n Date', width: '6%', align: 'left', type: 'calendar', readOnly: true},
                { title: 'Cheque No.', width: '8%', align: 'left', readOnly: true},
                { title: 'Cheque Date', width: '6%', align: 'left', type: 'calendar',readOnly: true},
                { title: "Amount Paid", width: '6%', align: 'left',readOnly: true},
                { title: "Currency", width: '5%', align: 'left', type:"dropdown",readOnly: true},
                { title: "Advance Paid in\n Full / Part", width: '6%', align: 'left', type:"dropdown", source: ["PART", "FULL"],readOnly: true},
            ],
            minDimensions: [4, 1],
            allowDeleteColumn: false,
            allowInsertRow: false,
