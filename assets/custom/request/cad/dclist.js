$(document).ready(function () {
    ...
    function getCadMIDetails() {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Cadrequest/getDCList',
            data: data,
            processData: false,
            contentType: false,
            cache: false,
            success: function (data) {
                ...
                $('#dc_type').html(sample_requirement_data.mi_type);
                append_sample_request(sample_requirement_data);

                if(sample_requirement_data.mi_type == 'INTERNAL')
                {
                    $('#internalForm').show();
                    $('#externalForm').hide();
                }
        ...
        let request = $.ajax({
            ...
            success: function (data) {
                ...
                swalWithBootstrapButtons.fire(
                    ...
                    if (okay) {
                        window.location.href = base_path + 'company/mcaduser/caddclist';
                    }
                 });
            },
            error: function () {
