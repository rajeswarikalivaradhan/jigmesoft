$(document).ready(function () {
    ...
    function append_getFabricDyeingProgramme_finish(data) {
        ...
        let FabricDyeingProgramme_finish_list = {
            ...
            columns: [
                ...
                { title: 'Pantone No./\n Swatch Ref.', width: '8%', align: 'left', readOnly: true},
                { title: 'Dyeing Special \nRequest If Any', width: '12%', align: 'center', type: 'dropdown', source: data.dsr_data, multiple: true, readOnly: true},
                { title: 'Reqd. Fabric \nFinishing Process', width: '8%', align: 'center', type: 'dropdown', source: data.fabric_finish_data, multiple: true, readOnly: true},
                { title: 'Blended Fabric - \nColour Matching\nContent', width: '8%', align: 'center', type: 'dropdown', source: data.colourContent, filter: colourMatchingFilter, multiple: true, readOnly: true},
                { title: 'Colour Matching\n Standards', width: '8%', align: 'center', type: 'dropdown', source: data.colourStandard, readOnly: true},
                { title: 'Approved Lab Dip\n Ref. No', width: '8%', align: 'left', readOnly: true},
                { title: 'Dyeing Vendor Name', width: '8%', align: 'center', type: 'dropdown', source: data.dyeingVendor, readOnly: true},
            ],
            minDimensions: [4, 1],
            allowDeleteColumn: false,
            allowInsertRow: true,
    ...
    function append_getYarnDyeingProgramme_finish(data) {
        ...
        let YarnDyeingProgramme_finish_list = {
            ...
            columns: [
                ...
                { title: 'Dyeing Special \nRequest If Any', width: '12%', align: 'center', type: 'dropdown', source: data.dsr_data, multiple: true, readOnly: true},
                { title: 'Reqd. Fabric \nFinishing Process', width: '8%', align: 'center', type: 'dropdown', source: data.fabric_finish_data, multiple: true, readOnly: true},
                { title: 'Blended Fabric - \nColour Matching Content', width: '8%', align: 'center', type: 'dropdown', source: data.colourContent, filter: yarnColourMatchingFilter, multiple: true, readOnly: true},
                { title: 'Colour Matching\n Standards', width: '8%', align: 'center', type: 'dropdown', source: data.colourStandard, readOnly: true},
                { title: 'Approved Lab Dip\n Ref. No', width: '8%', align: 'left', readOnly: true},
                { title: 'Dyeing Vendor Name', width: '8%', align: 'center', type: 'dropdown', source: data.dyeingVendor, readOnly: true},
            ],
    ...
    $('#getValues').click(function () {
        if($('#auth_status').val() == '') {
            $('#err_auth_status').html('Please select auth status');
        }
        else if($('#auth_type').val() == '') {
            $('#err_auth_type').html('Please select auth type');
        }
        else {
    ...
    function updateFunction() {
        ...
        let request = $.ajax({
            ...
            success: function (data) {
                ...
                setTimeout(() => {
                    window.location.href = base_path + 'management/manageAuthorizationRequest';
                }, 1000);
            },
            error: function () {
                console.log("Error");
