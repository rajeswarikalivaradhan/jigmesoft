...
$(document).ready(function() {
	...
	{
		return $.ajax({
			url: base_path+'company/mqausers/getRequestList',
			type:'POST',
					...
					"mDataProp": function ( data, type, full, meta) {
						if(data.type == 1)
						{
							//return '<a class="bold" href="' + base_path +'request/Cadrequest/qareceiveddetails' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id)) + '/cadId/' + encodeURIComponent(btoa(data.cad_requirement_id)) + '">' + data.isriorcode + '</a>';
						        return '<a class="bold" href="' + base_path +'request/Cadrequest/qareceiveddetails' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id)) + '/cadId/' + encodeURIComponent(btoa(data.qa_req_id)) + '">' + data.isriorcode + '</a>';
						}
						else if(data.type == 2)
						{
							return '<a class="bold" href="' + base_path +'request/Samplerequest/qareceiveddetails' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id)) + '/samId/' + encodeURIComponent(btoa(data.qa_req_id)) + '">' + data.isriorcode + '</a>';
...
if(cutfromDate!==''){
  ...
  if(cutfromDate!=='' && cuttoDate!==''){
    ...
    var table = $('#QaReceivedListTbl').DataTable();
    ...
    table
      ...
      .column(4).search(item_description)
