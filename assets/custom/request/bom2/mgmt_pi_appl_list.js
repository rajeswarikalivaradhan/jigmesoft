...
$(document).ready(function() {
	...
	{
		return $.ajax({
			url: base_path+'request/bom2request/getManagementPIApprovalList',
			type:'POST',
			...
			"aoColumns": [	
				...
				{ 
					"mDataProp": function ( data, type, full, meta) {
						...
						// return '<a class="bold" href="' + base_path +'request/Bomrequest/managementpurchaseindentapprovaldetails' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id)) + '/type/' + encodeURIComponent(btoa(0)) + '">' + data.isriorcode + '</a>';
						// else
