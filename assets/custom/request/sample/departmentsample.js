   ...
   // var itemDescription = bcm = garmentSize = itemCode = itemColor = sizeDimension = uom = [];
    ...
    $('#getValues').click(function () {
        ...
        if($('#req_status').val() == "" || $('#req_status').val() == null ) {
            $('#err_req_status').html("Select request status");
            $('#err_req_status').show();
        }
        else if($('#dep_remarks').val() == "" || $('#dep_remarks').val() == null ) {
            $('#err_dep_remarks').html("Fill  The Remarks ");
    ...
    function updateFunction() {
        ...
        let tbl_data = sampleReference_vm.getData();
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Samplerequest/updateDepartmentSampleRequest',
            data: dataform,
            processData: false,
            contentType: false,
            cache: false,
