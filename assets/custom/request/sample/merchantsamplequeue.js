...
$(document).ready(function() {
	...
	{
		return $.ajax({
			url: base_path+'company/mqausers/getQueueList',
			type:'POST',
			...
			"aoColumns": [		
				...
				{ 
					"mDataProp": function ( data, type, full, meta) {
						...
						// return '<a class="bold" href="' + base_path +'request/Samplerequest/merchantqueue' + '/' + encodeURIComponent(btoa(data.enquiry_id)) + '/reqId/' + encodeURIComponent(btoa(data.request_id)) + '/samId/' + encodeURIComponent(btoa(data.sample_requirement_id)) + '">' + data.isriorcode + '</a>';
					}
				},		
				{ "mDataProp": "brandname" },
				{ 
...
//     }
//   }
//     // 3️⃣ Proceed with AJAX if all validations pass
//     var url = base_path + "company/mqausers/searchsampleqaList";
