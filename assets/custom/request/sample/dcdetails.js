$(document).ready(function () {
    ...
    function getBOMMIDetails() {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Samplerequest/getSamDCDetails',
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    function append_sample_request(data) {
        ...
        let list = {
            ...
            columns: [
                ...
                { title:'id', align:'left',type:'hidden'},
                { type: 'text', title: 'Sample Ref. No.', width: '8%', align: 'left', readOnly: true },
                { type: 'text', title: 'Item Description', width: '8%', align: 'left', readOnly: true },
                { type: 'text', title: 'Blend (%) / Content \n / Material ', width: '10%', align: 'left', readOnly: true },
                { type: 'text', title: 'Garment Size', width: '7%', align: 'left', readOnly: true },
                ...
                { type: 'text', title: 'UOM', width: '5%', align: 'left', readOnly: true },
                { type: 'text', title: 'Qty.', width: '7%', align: 'right', readOnly: true },
                { type: 'text', title: 'UOM', width: '5%', align: 'left', readOnly: true },
            ],
            // columns: data.column,
            minDimensions: [4, 1],
    ...
    function updateFunction() {
        ...
        let request = $.ajax({
            type: "POST",
            url: base_path + 'request/Samplerequest/updateMIDCList',
            data: dataform,
            processData: false,
            contentType: false,
            cache: false,
            success: function (data) {
                ...
                swalWithBootstrapButtons.fire(
                    ...
                    if (okay) {
                        window.location.href = base_path + 'company/msamplinguser/midclist';
                    }
                 });
            },
            error: function () {
