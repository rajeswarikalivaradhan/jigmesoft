			...
			"aoColumns": [			
				...
				{ 
					"mDataProp": function ( data, type, full, meta) {
                        ...
                        if(data.show == 1) {
                            var Budget = '<a href="' + base_path + 'budgetCosting/index/' + urlIdPart + '" >' + 'Budget</a>';
                            var orderEntryLink = '<a href="' + base_path + 'orderentryvtwo/entry/' + urlIdPart + '" >' + 'Order Entry</a>';
                            var CAD = '<a href="javascript:void(0)" target="_blank">CAD Requirement</a>';
                            var bomLink = '<a href="' + base_path + 'billofmaterials/article_1/' + urlIdPart + '" >' + 'BOM Program</a>';
                            var fabricProgramLink = '<a href="' + base_path + 'fabricprogram/home/' + urlIdPart + '" >' + 'Fabric Programme</a>';
                            var sampleReqLink = '<a href="' + base_path + 'msamplerequest/addeditsamplerequest/' + urlIdPart + '" >' + 'Sample Requirement</a>';
                            var bomPurchaseRequestLink = '<a href="' + base_path + 'mpurchase/addeditbompurchase/' + urlIdPart + '" >' + 'BOM (A1) Programme</a>';
                            var bomA2 = '<a href="javascript:void(0)" >BOM (A2) Programme</a>';
                            var establishment = '<a href="javascript:void(0)" >Establishment Programme</a>';
                            ...
                            var documentLogistics = '<a href="javascript:void(0)" >Documentation & Logistics</a>';
                            var checklist = '<a href="javascript:void(0)" >Check List</a>';
                            var precosting = '<a href="javascript:void(0)" >Pre-costing</a>';
                            var cadRequestLink = '<a href="javascript:void(0)" >' + 'CAD Request</a>';
                            var sampleRequestLink = '<a href="javascript:void(0)" >' + 'Sample Request</a>';
                            var bomRequestLink = '<a href="javascript:void(0)" >' + 'BOM Request</a>';
                        }
                        else {
                            var Budget = '<a href="javascript:void(0)" >Budget</a>';
                            // var orderEntryLink = '<a href="javascript:void(0)" target="_blank">Order Entry</a>';
                            var orderEntryLink = '<a href="'+base_path+'WorkInProcess/index/' + urlIdPart + '" >' + 'Order Entry</a>';
                            var CAD = '<a href="javascript:void(0)" >CAD Requirement</a>';
                            var bomLink = '<a href="javascript:void(0)" >BOM Program</a>';
                            var fabricProgramLink = '<a href="'+base_path+'WorkInProcess/fabric_program/' + urlIdPart + '" >Fabric Program</a>';
                            var cadRequestLink = '<a href="javascript:void(0)" >CAD Request</a>';
                            var sampleReqLink = '<a href="javascript:void(0)" >Sample Requirement</a>';
                            var bomPurchaseRequestLink = '<a href="javascript:void(0)" >BOM (A1) Request</a>';
                            var bomA2 = '<a href="javascript:void(0)" >BOM (A2) Programme</a>';
                            var establishment = '<a href="javascript:void(0)" >Establishment Programme</a>';
                            var packing = '<a href="javascript:void(0)" >Packing Details</a>';
                            var lab = '<a href="javascript:void(0)" >Lab Requirement</a>';
...
//   }
    ...
    table
      ...
      .column(4).search(style_ref_no)
      .column(5).search(brandId)
      .column(6).search(po_sam_ref_no)
       .column(7).search(po_sam_qty)
      .column(8).search(pcs_set)
